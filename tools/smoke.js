// smoke.js DIR — boots the app in jsdom: all scripts eval'd in index order,
...
if (order.length !== 28) { console.error("expected 28 scripts, got", order.length); process.exit(1); }   // + planlink, planner-flow and retro (v4.6.93), ota (v4.6.110), reminders (v4.6.118), heat-replay (v4.6.128), health (v4.6.132)
