// smoke.js DIR — boots the app in jsdom: 13 scripts eval'd in index order,
...
if (order.length !== 15) { console.error("expected 15 scripts, got", order.length); process.exit(1); }   // progression.js + planner.js + mascot.js
