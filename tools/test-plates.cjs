...
assert(await page.evaluate(()=>getComputedStyle(document.querySelectorAll('.plate-legend i')[1]).backgroundColor==='rgb(65, 105, 200)'&&getComputedStyle(document.documentElement).getPropertyValue('--p-shoulder').trim()==='#4169C8'),'Shoulder uses the shared Normal royal blue');
