...
ok("Monthly pace is absent from Stats while its Report Card keeps numeric months",
   dbmSvg.length===0&&expectedMonths.every(m=>dbmCard.includes(m)),
   "Stats retired; numeric Report Card preserved");
