...
w.localStorage.setItem('showup:planning-interface','previous'); // Legacy paste/read-back presentation; focus card tested separately.
...
/* v3.3.534 RESTATES: SUGGESTED is gone -- the exercise screen states the PLAN
