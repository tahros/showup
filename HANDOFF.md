# ShowUp — handoff (2026-08-14, v3.3.228)
...
**Current release version: v3.3.228** (Session Build uses the approved minimal
4+3 chart legend; capsule buttons and the permanent instruction are gone)
