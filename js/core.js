...
/* v3.3.344: WHERE YOU LEFT THE TRAIN TAB. Mid-workout the tab is somewhere
   you step away from and come back to -- to read the plan on Today, to check
   the clock -- and coming back should return you to the screen you left, not
   to a guess about where you probably are.
   Only consulted while a session is LIVE. Outside one, arriving at Train is
   starting something, and the tab's own fresh entry state is right; that is
   the v3.3.xx decision this does not disturb. */
let liftWhere = null;
