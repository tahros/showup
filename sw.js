const CACHE = 'showup-v3.3.72';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.72',
  './js/core.js?v=3.3.72',
  './js/derive.js?v=3.3.72',
  './js/util.js?v=3.3.72',
  './js/header.js?v=3.3.72',
  './js/report.js?v=3.3.72',
  './js/today.js?v=3.3.72',
  './js/lift.js?v=3.3.72',
  './js/stats.js?v=3.3.72',
  './js/history.js?v=3.3.72',
  './js/settings.js?v=3.3.72',
  './js/app.js?v=3.3.72',
  './icon-192.png',
  './icon-512.png',
