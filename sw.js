const CACHE = 'showup-v3.3.157';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.157',
  './js/core.js?v=3.3.157',
  './js/derive.js?v=3.3.157',
  './js/util.js?v=3.3.157',
  './js/header.js?v=3.3.157',
  './js/report.js?v=3.3.157',
  './js/today.js?v=3.3.157',
  './js/lift.js?v=3.3.157',
  './js/stats.js?v=3.3.157',
  './js/history.js?v=3.3.157',
  './js/settings.js?v=3.3.157',
  './js/app.js?v=3.3.157',
  './icon-192.png',
  './icon-512.png',
