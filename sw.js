const CACHE = 'showup-v4.6.28';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.28',
  './css/planner.css?v=4.6.28',
  './css/mascot.css?v=4.6.28',
  './js/mascot.js?v=4.6.28',
  './js/plates.js?v=4.6.28',
  './js/plate-canvas.js?v=4.6.28',
  './css/plates.css?v=4.6.28',
  ...
  './js/core.js?v=4.6.28',
  './js/derive.js?v=4.6.28',
  './js/util.js?v=4.6.28',
  './js/planlink.js?v=4.6.28',
  './js/realset.js?v=4.6.28',
  './js/reprange.js?v=4.6.28',
  './js/verdict.js?v=4.6.28',
  './js/header.js?v=4.6.28',
  './js/report.js?v=4.6.28',
  './js/today.js?v=4.6.28',
  './js/progression.js?v=4.6.28',
  './js/lift.js?v=4.6.28',
  './js/writer.js?v=4.6.28',
  './js/planner.js?v=4.6.28',
  './js/planner-flow.js?v=4.6.28',
  './css/planner-flow.css?v=4.6.28',
  './js/stats.js?v=4.6.28',
  './js/history.js?v=4.6.28',
  './js/settings.js?v=4.6.28',
  './js/stats-story.js?v=4.6.28',
  './js/app.js?v=4.6.28',
