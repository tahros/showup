const CACHE = 'showup-v3.3.163';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.163',
  './js/core.js?v=3.3.163',
  './js/derive.js?v=3.3.163',
  './js/util.js?v=3.3.163',
  './js/header.js?v=3.3.163',
  './js/report.js?v=3.3.163',
  './js/today.js?v=3.3.163',
  './js/lift.js?v=3.3.163',
  './js/stats.js?v=3.3.163',
  './js/history.js?v=3.3.163',
  './js/settings.js?v=3.3.163',
  './js/app.js?v=3.3.163',
  './icon-192.png',
  './icon-512.png',
