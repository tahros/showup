const CACHE = 'showup-v3.3.11';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.11',
  './js/core.js?v=3.3.11',
  './js/derive.js?v=3.3.11',
  './js/util.js?v=3.3.11',
  './js/header.js?v=3.3.11',
  './js/report.js?v=3.3.11',
  './js/today.js?v=3.3.11',
  './js/lift.js?v=3.3.11',
  './js/stats.js?v=3.3.11',
  './js/history.js?v=3.3.11',
  './js/settings.js?v=3.3.11',
  './js/app.js?v=3.3.11',
  './icon-192.png',
  './icon-512.png',
