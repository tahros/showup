const CACHE = 'showup-v3.3.145';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.145',
  './js/core.js?v=3.3.145',
  './js/derive.js?v=3.3.145',
  './js/util.js?v=3.3.145',
  './js/header.js?v=3.3.145',
  './js/report.js?v=3.3.145',
  './js/today.js?v=3.3.145',
  './js/lift.js?v=3.3.145',
  './js/stats.js?v=3.3.145',
  './js/history.js?v=3.3.145',
  './js/settings.js?v=3.3.145',
  './js/app.js?v=3.3.145',
  './icon-192.png',
  './icon-512.png',
