const CACHE = 'showup-v3.3.399';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.399',
  './js/core.js?v=3.3.399',
  './js/derive.js?v=3.3.399',
  './js/util.js?v=3.3.399',
  './js/header.js?v=3.3.399',
  './js/report.js?v=3.3.399',
  './js/today.js?v=3.3.399',
  './js/lift.js?v=3.3.399',
  './js/stats.js?v=3.3.399',
  './js/history.js?v=3.3.399',
  './js/settings.js?v=3.3.399',
  './js/app.js?v=3.3.399',
