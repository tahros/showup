const CACHE = 'showup-v3.3.40';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.40',
  './js/core.js?v=3.3.40',
  './js/derive.js?v=3.3.40',
  './js/util.js?v=3.3.40',
  './js/header.js?v=3.3.40',
  './js/report.js?v=3.3.40',
  './js/today.js?v=3.3.40',
  './js/lift.js?v=3.3.40',
  './js/stats.js?v=3.3.40',
  './js/history.js?v=3.3.40',
  './js/settings.js?v=3.3.40',
  './js/app.js?v=3.3.40',
  './icon-192.png',
  './icon-512.png',
