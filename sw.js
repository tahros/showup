const CACHE = 'showup-v3.3.119';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.119',
  './js/core.js?v=3.3.119',
  './js/derive.js?v=3.3.119',
  './js/util.js?v=3.3.119',
  './js/header.js?v=3.3.119',
  './js/report.js?v=3.3.119',
  './js/today.js?v=3.3.119',
  './js/lift.js?v=3.3.119',
  './js/stats.js?v=3.3.119',
  './js/history.js?v=3.3.119',
  './js/settings.js?v=3.3.119',
  './js/app.js?v=3.3.119',
  './icon-192.png',
  './icon-512.png',
