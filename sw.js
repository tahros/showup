const CACHE = 'showup-v3.3.232';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.232',
  './js/core.js?v=3.3.232',
  './js/derive.js?v=3.3.232',
  './js/util.js?v=3.3.232',
  './js/header.js?v=3.3.232',
  './js/report.js?v=3.3.232',
  './js/today.js?v=3.3.232',
  './js/lift.js?v=3.3.232',
  './js/stats.js?v=3.3.232',
  './js/history.js?v=3.3.232',
  './js/settings.js?v=3.3.232',
  './js/app.js?v=3.3.232',
