const CACHE = 'showup-v3.3.379';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.379',
  './js/core.js?v=3.3.379',
  './js/derive.js?v=3.3.379',
  './js/util.js?v=3.3.379',
  './js/header.js?v=3.3.379',
  './js/report.js?v=3.3.379',
  './js/today.js?v=3.3.379',
  './js/lift.js?v=3.3.379',
  './js/stats.js?v=3.3.379',
  './js/history.js?v=3.3.379',
  './js/settings.js?v=3.3.379',
  './js/app.js?v=3.3.379',
