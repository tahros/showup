const CACHE = 'showup-v3.3.22';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.22',
  './js/core.js?v=3.3.22',
  './js/derive.js?v=3.3.22',
  './js/util.js?v=3.3.22',
  './js/header.js?v=3.3.22',
  './js/report.js?v=3.3.22',
  './js/today.js?v=3.3.22',
  './js/lift.js?v=3.3.22',
  './js/stats.js?v=3.3.22',
  './js/history.js?v=3.3.22',
  './js/settings.js?v=3.3.22',
  './js/app.js?v=3.3.22',
  './icon-192.png',
  './icon-512.png',
