const CACHE = 'showup-v3.3.93';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.93',
  './js/core.js?v=3.3.93',
  './js/derive.js?v=3.3.93',
  './js/util.js?v=3.3.93',
  './js/header.js?v=3.3.93',
  './js/report.js?v=3.3.93',
  './js/today.js?v=3.3.93',
  './js/lift.js?v=3.3.93',
  './js/stats.js?v=3.3.93',
  './js/history.js?v=3.3.93',
  './js/settings.js?v=3.3.93',
  './js/app.js?v=3.3.93',
  './icon-192.png',
  './icon-512.png',
