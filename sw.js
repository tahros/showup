const CACHE = 'showup-v3.3.192';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.192',
  './js/core.js?v=3.3.192',
  './js/derive.js?v=3.3.192',
  './js/util.js?v=3.3.192',
  './js/header.js?v=3.3.192',
  './js/report.js?v=3.3.192',
  './js/today.js?v=3.3.192',
  './js/lift.js?v=3.3.192',
  './js/stats.js?v=3.3.192',
  './js/history.js?v=3.3.192',
  './js/settings.js?v=3.3.192',
  './js/app.js?v=3.3.192',
  './icon-192.png',
  './icon-512.png',
