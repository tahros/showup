...
const SHELL = [
  ...
  './js/core.js?v=3.3.25',
  './js/derive.js?v=3.3.25',
  './js/util.js?v=3.3.25',
  './js/header.js?v=3.3.25',
  './js/report.js?v=3.3.25',
  './js/today.js?v=3.3.25',
  './js/lift.js?v=3.3.25',
  './js/stats.js?v=3.3.25',
  './js/history.js?v=3.3.25',
  './js/settings.js?v=3.3.25',
  './js/app.js?v=3.3.25',
  './icon-192.png',
  './icon-512.png',
