const CACHE = 'showup-v4.6.50';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.50',
  './css/planner.css?v=4.6.50',
  './css/mascot.css?v=4.6.50',
  './js/mascot.js?v=4.6.50',
  './js/plates.js?v=4.6.50',
  './js/plate-canvas.js?v=4.6.50',
  './css/plates.css?v=4.6.50',
  ...
  './js/core.js?v=4.6.50',
  './js/derive.js?v=4.6.50',
  './js/util.js?v=4.6.50',
  './js/planlink.js?v=4.6.50',
  './js/realset.js?v=4.6.50',
  './js/reprange.js?v=4.6.50',
  './js/verdict.js?v=4.6.50',
  './js/header.js?v=4.6.50',
  './js/report.js?v=4.6.50',
  './js/today.js?v=4.6.50',
  './js/progression.js?v=4.6.50',
  './js/lift.js?v=4.6.50',
  './js/writer.js?v=4.6.50',
  './js/planner.js?v=4.6.50',
  './js/planner-flow.js?v=4.6.50',
  './css/planner-flow.css?v=4.6.50',
  './js/stats.js?v=4.6.50',
  './js/history.js?v=4.6.50',
  './js/settings.js?v=4.6.50',
  './js/stats-story.js?v=4.6.50',
  './js/app.js?v=4.6.50',
