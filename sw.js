const CACHE = 'showup-v3.3.293';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.293',
  './js/core.js?v=3.3.293',
  './js/derive.js?v=3.3.293',
  './js/util.js?v=3.3.293',
  './js/header.js?v=3.3.293',
  './js/report.js?v=3.3.293',
  './js/today.js?v=3.3.293',
  './js/lift.js?v=3.3.293',
  './js/stats.js?v=3.3.293',
  './js/history.js?v=3.3.293',
  './js/settings.js?v=3.3.293',
  './js/app.js?v=3.3.293',
