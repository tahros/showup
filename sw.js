const CACHE = 'showup-v3.3.284';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.284',
  './js/core.js?v=3.3.284',
  './js/derive.js?v=3.3.284',
  './js/util.js?v=3.3.284',
  './js/header.js?v=3.3.284',
  './js/report.js?v=3.3.284',
  './js/today.js?v=3.3.284',
  './js/lift.js?v=3.3.284',
  './js/stats.js?v=3.3.284',
  './js/history.js?v=3.3.284',
  './js/settings.js?v=3.3.284',
  './js/app.js?v=3.3.284',
