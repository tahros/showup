const CACHE = 'showup-v3.3.128';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.128',
  './js/core.js?v=3.3.128',
  './js/derive.js?v=3.3.128',
  './js/util.js?v=3.3.128',
  './js/header.js?v=3.3.128',
  './js/report.js?v=3.3.128',
  './js/today.js?v=3.3.128',
  './js/lift.js?v=3.3.128',
  './js/stats.js?v=3.3.128',
  './js/history.js?v=3.3.128',
  './js/settings.js?v=3.3.128',
  './js/app.js?v=3.3.128',
  './icon-192.png',
  './icon-512.png',
