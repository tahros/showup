const CACHE = 'showup-v4.6.71';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.71',
  './css/planner.css?v=4.6.71',
  './css/mascot.css?v=4.6.71',
  './js/mascot.js?v=4.6.71',
  './js/plates.js?v=4.6.71',
  './js/plate-canvas.js?v=4.6.71',
  './css/plates.css?v=4.6.71',
  ...
  './js/core.js?v=4.6.71',
  './js/derive.js?v=4.6.71',
  './js/util.js?v=4.6.71',
  './js/planlink.js?v=4.6.71',
  './js/realset.js?v=4.6.71',
  './js/reprange.js?v=4.6.71',
  './js/verdict.js?v=4.6.71',
  './js/header.js?v=4.6.71',
  './js/report.js?v=4.6.71',
  './js/today.js?v=4.6.71',
  './js/progression.js?v=4.6.71',
  './js/lift.js?v=4.6.71',
  './js/writer.js?v=4.6.71',
  './js/planner.js?v=4.6.71',
  './js/planner-flow.js?v=4.6.71',
  './css/planner-flow.css?v=4.6.71',
  './js/stats.js?v=4.6.71',
  './js/history.js?v=4.6.71',
  './js/settings.js?v=4.6.71',
  './js/stats-story.js?v=4.6.71',
  './js/app.js?v=4.6.71',
