const CACHE = 'showup-v3.3.165';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.165',
  './js/core.js?v=3.3.165',
  './js/derive.js?v=3.3.165',
  './js/util.js?v=3.3.165',
  './js/header.js?v=3.3.165',
  './js/report.js?v=3.3.165',
  './js/today.js?v=3.3.165',
  './js/lift.js?v=3.3.165',
  './js/stats.js?v=3.3.165',
  './js/history.js?v=3.3.165',
  './js/settings.js?v=3.3.165',
  './js/app.js?v=3.3.165',
  './icon-192.png',
  './icon-512.png',
