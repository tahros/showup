const CACHE = 'showup-v3.3.286';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.286',
  './js/core.js?v=3.3.286',
  './js/derive.js?v=3.3.286',
  './js/util.js?v=3.3.286',
  './js/header.js?v=3.3.286',
  './js/report.js?v=3.3.286',
  './js/today.js?v=3.3.286',
  './js/lift.js?v=3.3.286',
  './js/stats.js?v=3.3.286',
  './js/history.js?v=3.3.286',
  './js/settings.js?v=3.3.286',
  './js/app.js?v=3.3.286',
