const CACHE = 'showup-v3.3.218';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.218',
  './js/core.js?v=3.3.218',
  './js/derive.js?v=3.3.218',
  './js/util.js?v=3.3.218',
  './js/header.js?v=3.3.218',
  './js/report.js?v=3.3.218',
  './js/today.js?v=3.3.218',
  './js/lift.js?v=3.3.218',
  './js/stats.js?v=3.3.218',
  './js/history.js?v=3.3.218',
  './js/settings.js?v=3.3.218',
  './js/app.js?v=3.3.218',
