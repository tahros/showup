const CACHE = 'showup-v4.6.85';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.85',
  './css/planner.css?v=4.6.85',
  './css/mascot.css?v=4.6.85',
  './js/mascot.js?v=4.6.85',
  './js/plates.js?v=4.6.85',
  './js/plate-canvas.js?v=4.6.85',
  './css/plates.css?v=4.6.85',
  ...
  './js/core.js?v=4.6.85',
  './js/derive.js?v=4.6.85',
  './js/util.js?v=4.6.85',
  './js/planlink.js?v=4.6.85',
  './js/realset.js?v=4.6.85',
  './js/reprange.js?v=4.6.85',
  './js/verdict.js?v=4.6.85',
  './js/header.js?v=4.6.85',
  './js/report.js?v=4.6.85',
  './js/today.js?v=4.6.85',
  './js/progression.js?v=4.6.85',
  './js/lift.js?v=4.6.85',
  './js/writer.js?v=4.6.85',
  './js/planner.js?v=4.6.85',
  './js/planner-flow.js?v=4.6.85',
  './css/planner-flow.css?v=4.6.85',
  './js/stats.js?v=4.6.85',
  './js/history.js?v=4.6.85',
  './js/settings.js?v=4.6.85',
  './js/stats-story.js?v=4.6.85',
  './js/app.js?v=4.6.85',
