const CACHE = 'showup-v3.3.76';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.76',
  './js/core.js?v=3.3.76',
  './js/derive.js?v=3.3.76',
  './js/util.js?v=3.3.76',
  './js/header.js?v=3.3.76',
  './js/report.js?v=3.3.76',
  './js/today.js?v=3.3.76',
  './js/lift.js?v=3.3.76',
  './js/stats.js?v=3.3.76',
  './js/history.js?v=3.3.76',
  './js/settings.js?v=3.3.76',
  './js/app.js?v=3.3.76',
  './icon-192.png',
  './icon-512.png',
