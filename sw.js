const CACHE = 'showup-v3.3.176';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.176',
  './js/core.js?v=3.3.176',
  './js/derive.js?v=3.3.176',
  './js/util.js?v=3.3.176',
  './js/header.js?v=3.3.176',
  './js/report.js?v=3.3.176',
  './js/today.js?v=3.3.176',
  './js/lift.js?v=3.3.176',
  './js/stats.js?v=3.3.176',
  './js/history.js?v=3.3.176',
  './js/settings.js?v=3.3.176',
  './js/app.js?v=3.3.176',
  './icon-192.png',
  './icon-512.png',
