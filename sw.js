const CACHE = 'showup-v3.3.298';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.298',
  './js/core.js?v=3.3.298',
  './js/derive.js?v=3.3.298',
  './js/util.js?v=3.3.298',
  './js/header.js?v=3.3.298',
  './js/report.js?v=3.3.298',
  './js/today.js?v=3.3.298',
  './js/lift.js?v=3.3.298',
  './js/stats.js?v=3.3.298',
  './js/history.js?v=3.3.298',
  './js/settings.js?v=3.3.298',
  './js/app.js?v=3.3.298',
