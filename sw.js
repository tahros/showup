const CACHE = 'showup-v3.3.70';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.70',
  './js/core.js?v=3.3.70',
  './js/derive.js?v=3.3.70',
  './js/util.js?v=3.3.70',
  './js/header.js?v=3.3.70',
  './js/report.js?v=3.3.70',
  './js/today.js?v=3.3.70',
  './js/lift.js?v=3.3.70',
  './js/stats.js?v=3.3.70',
  './js/history.js?v=3.3.70',
  './js/settings.js?v=3.3.70',
  './js/app.js?v=3.3.70',
  './icon-192.png',
  './icon-512.png',
