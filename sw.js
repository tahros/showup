const CACHE = 'showup-v3.3.64';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.64',
  './js/core.js?v=3.3.64',
  './js/derive.js?v=3.3.64',
  './js/util.js?v=3.3.64',
  './js/header.js?v=3.3.64',
  './js/report.js?v=3.3.64',
  './js/today.js?v=3.3.64',
  './js/lift.js?v=3.3.64',
  './js/stats.js?v=3.3.64',
  './js/history.js?v=3.3.64',
  './js/settings.js?v=3.3.64',
  './js/app.js?v=3.3.64',
  './icon-192.png',
  './icon-512.png',
