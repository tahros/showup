const CACHE = 'showup-v3.3.175';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.175',
  './js/core.js?v=3.3.175',
  './js/derive.js?v=3.3.175',
  './js/util.js?v=3.3.175',
  './js/header.js?v=3.3.175',
  './js/report.js?v=3.3.175',
  './js/today.js?v=3.3.175',
  './js/lift.js?v=3.3.175',
  './js/stats.js?v=3.3.175',
  './js/history.js?v=3.3.175',
  './js/settings.js?v=3.3.175',
  './js/app.js?v=3.3.175',
  './icon-192.png',
  './icon-512.png',
