const CACHE = 'showup-v3.3.82';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.82',
  './js/core.js?v=3.3.82',
  './js/derive.js?v=3.3.82',
  './js/util.js?v=3.3.82',
  './js/header.js?v=3.3.82',
  './js/report.js?v=3.3.82',
  './js/today.js?v=3.3.82',
  './js/lift.js?v=3.3.82',
  './js/stats.js?v=3.3.82',
  './js/history.js?v=3.3.82',
  './js/settings.js?v=3.3.82',
  './js/app.js?v=3.3.82',
  './icon-192.png',
  './icon-512.png',
