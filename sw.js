const CACHE = 'showup-v3.3.535';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.535',
  './js/core.js?v=3.3.535',
  './js/derive.js?v=3.3.535',
  './js/util.js?v=3.3.535',
  './js/header.js?v=3.3.535',
  './js/report.js?v=3.3.535',
  './js/today.js?v=3.3.535',
  './js/progression.js?v=3.3.535',
  './js/lift.js?v=3.3.535',
  './js/writer.js?v=3.3.535',
  './js/stats.js?v=3.3.535',
  './js/history.js?v=3.3.535',
  './js/settings.js?v=3.3.535',
  './js/app.js?v=3.3.535',
