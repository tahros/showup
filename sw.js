const CACHE = 'showup-v3.3.226';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.226',
  './js/core.js?v=3.3.226',
  './js/derive.js?v=3.3.226',
  './js/util.js?v=3.3.226',
  './js/header.js?v=3.3.226',
  './js/report.js?v=3.3.226',
  './js/today.js?v=3.3.226',
  './js/lift.js?v=3.3.226',
  './js/stats.js?v=3.3.226',
  './js/history.js?v=3.3.226',
  './js/settings.js?v=3.3.226',
  './js/app.js?v=3.3.226',
