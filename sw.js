const CACHE = 'showup-v3.3.533';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.533',
  './js/core.js?v=3.3.533',
  './js/derive.js?v=3.3.533',
  './js/util.js?v=3.3.533',
  './js/header.js?v=3.3.533',
  './js/report.js?v=3.3.533',
  './js/today.js?v=3.3.533',
  './js/progression.js?v=3.3.533',
  './js/lift.js?v=3.3.533',
  './js/writer.js?v=3.3.533',
  './js/stats.js?v=3.3.533',
  './js/history.js?v=3.3.533',
  './js/settings.js?v=3.3.533',
  './js/app.js?v=3.3.533',
