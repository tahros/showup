const CACHE = 'showup-v4.6.79';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.79',
  './css/planner.css?v=4.6.79',
  './css/mascot.css?v=4.6.79',
  './js/mascot.js?v=4.6.79',
  './js/plates.js?v=4.6.79',
  './js/plate-canvas.js?v=4.6.79',
  './css/plates.css?v=4.6.79',
  ...
  './js/core.js?v=4.6.79',
  './js/derive.js?v=4.6.79',
  './js/util.js?v=4.6.79',
  './js/planlink.js?v=4.6.79',
  './js/realset.js?v=4.6.79',
  './js/reprange.js?v=4.6.79',
  './js/verdict.js?v=4.6.79',
  './js/header.js?v=4.6.79',
  './js/report.js?v=4.6.79',
  './js/today.js?v=4.6.79',
  './js/progression.js?v=4.6.79',
  './js/lift.js?v=4.6.79',
  './js/writer.js?v=4.6.79',
  './js/planner.js?v=4.6.79',
  './js/planner-flow.js?v=4.6.79',
  './css/planner-flow.css?v=4.6.79',
  './js/stats.js?v=4.6.79',
  './js/history.js?v=4.6.79',
  './js/settings.js?v=4.6.79',
  './js/stats-story.js?v=4.6.79',
  './js/app.js?v=4.6.79',
