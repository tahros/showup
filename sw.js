const CACHE = 'showup-v4.6.0';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.0',
  './css/planner.css?v=4.6.0',
  './css/mascot.css?v=4.6.0',
  './js/mascot.js?v=4.6.0',
  './js/plates.js?v=4.6.0',
  './js/plate-canvas.js?v=4.6.0',
  './css/plates.css?v=4.6.0',
  ...
  './js/core.js?v=4.6.0',
  './js/derive.js?v=4.6.0',
  './js/util.js?v=4.6.0',
  './js/planlink.js?v=4.6.0',
  './js/realset.js?v=4.6.0',
  './js/reprange.js?v=4.6.0',
  './js/verdict.js?v=4.6.0',
  './js/header.js?v=4.6.0',
  './js/report.js?v=4.6.0',
  './js/today.js?v=4.6.0',
  './js/progression.js?v=4.6.0',
  './js/lift.js?v=4.6.0',
  './js/writer.js?v=4.6.0',
  './js/planner.js?v=4.6.0',
  './js/planner-flow.js?v=4.6.0',
  './css/planner-flow.css?v=4.6.0',
  './js/stats.js?v=4.6.0',
  './js/history.js?v=4.6.0',
  './js/settings.js?v=4.6.0',
  './js/stats-story.js?v=4.6.0',
  './js/app.js?v=4.6.0',
