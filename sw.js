const CACHE = 'showup-v3.3.235';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.235',
  './js/core.js?v=3.3.235',
  './js/derive.js?v=3.3.235',
  './js/util.js?v=3.3.235',
  './js/header.js?v=3.3.235',
  './js/report.js?v=3.3.235',
  './js/today.js?v=3.3.235',
  './js/lift.js?v=3.3.235',
  './js/stats.js?v=3.3.235',
  './js/history.js?v=3.3.235',
  './js/settings.js?v=3.3.235',
  './js/app.js?v=3.3.235',
