const CACHE = 'showup-v3.3.84';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.84',
  './js/core.js?v=3.3.84',
  './js/derive.js?v=3.3.84',
  './js/util.js?v=3.3.84',
  './js/header.js?v=3.3.84',
  './js/report.js?v=3.3.84',
  './js/today.js?v=3.3.84',
  './js/lift.js?v=3.3.84',
  './js/stats.js?v=3.3.84',
  './js/history.js?v=3.3.84',
  './js/settings.js?v=3.3.84',
  './js/app.js?v=3.3.84',
  './icon-192.png',
  './icon-512.png',
