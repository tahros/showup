const CACHE = 'showup-v3.3.398';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.398',
  './js/core.js?v=3.3.398',
  './js/derive.js?v=3.3.398',
  './js/util.js?v=3.3.398',
  './js/header.js?v=3.3.398',
  './js/report.js?v=3.3.398',
  './js/today.js?v=3.3.398',
  './js/lift.js?v=3.3.398',
  './js/stats.js?v=3.3.398',
  './js/history.js?v=3.3.398',
  './js/settings.js?v=3.3.398',
  './js/app.js?v=3.3.398',
