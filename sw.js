const CACHE = 'showup-v3.3.248';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.248',
  './js/core.js?v=3.3.248',
  './js/derive.js?v=3.3.248',
  './js/util.js?v=3.3.248',
  './js/header.js?v=3.3.248',
  './js/report.js?v=3.3.248',
  './js/today.js?v=3.3.248',
  './js/lift.js?v=3.3.248',
  './js/stats.js?v=3.3.248',
  './js/history.js?v=3.3.248',
  './js/settings.js?v=3.3.248',
  './js/app.js?v=3.3.248',
