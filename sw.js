const CACHE = 'showup-v3.3.123';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.123',
  './js/core.js?v=3.3.123',
  './js/derive.js?v=3.3.123',
  './js/util.js?v=3.3.123',
  './js/header.js?v=3.3.123',
  './js/report.js?v=3.3.123',
  './js/today.js?v=3.3.123',
  './js/lift.js?v=3.3.123',
  './js/stats.js?v=3.3.123',
  './js/history.js?v=3.3.123',
  './js/settings.js?v=3.3.123',
  './js/app.js?v=3.3.123',
  './icon-192.png',
  './icon-512.png',
