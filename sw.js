const CACHE = 'showup-v3.3.117';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.117',
  './js/core.js?v=3.3.117',
  './js/derive.js?v=3.3.117',
  './js/util.js?v=3.3.117',
  './js/header.js?v=3.3.117',
  './js/report.js?v=3.3.117',
  './js/today.js?v=3.3.117',
  './js/lift.js?v=3.3.117',
  './js/stats.js?v=3.3.117',
  './js/history.js?v=3.3.117',
  './js/settings.js?v=3.3.117',
  './js/app.js?v=3.3.117',
  './icon-192.png',
  './icon-512.png',
