const CACHE = 'showup-v3.3.295';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.295',
  './js/core.js?v=3.3.295',
  './js/derive.js?v=3.3.295',
  './js/util.js?v=3.3.295',
  './js/header.js?v=3.3.295',
  './js/report.js?v=3.3.295',
  './js/today.js?v=3.3.295',
  './js/lift.js?v=3.3.295',
  './js/stats.js?v=3.3.295',
  './js/history.js?v=3.3.295',
  './js/settings.js?v=3.3.295',
  './js/app.js?v=3.3.295',
