const CACHE = 'showup-v3.3.307';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.307',
  './js/core.js?v=3.3.307',
  './js/derive.js?v=3.3.307',
  './js/util.js?v=3.3.307',
  './js/header.js?v=3.3.307',
  './js/report.js?v=3.3.307',
  './js/today.js?v=3.3.307',
  './js/lift.js?v=3.3.307',
  './js/stats.js?v=3.3.307',
  './js/history.js?v=3.3.307',
  './js/settings.js?v=3.3.307',
  './js/app.js?v=3.3.307',
