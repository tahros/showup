const CACHE = 'showup-v4.6.15';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.15',
  './css/planner.css?v=4.6.15',
  './css/mascot.css?v=4.6.15',
  './js/mascot.js?v=4.6.15',
  './js/plates.js?v=4.6.15',
  './js/plate-canvas.js?v=4.6.15',
  './css/plates.css?v=4.6.15',
  ...
  './js/core.js?v=4.6.15',
  './js/derive.js?v=4.6.15',
  './js/util.js?v=4.6.15',
  './js/planlink.js?v=4.6.15',
  './js/realset.js?v=4.6.15',
  './js/reprange.js?v=4.6.15',
  './js/verdict.js?v=4.6.15',
  './js/header.js?v=4.6.15',
  './js/report.js?v=4.6.15',
  './js/today.js?v=4.6.15',
  './js/progression.js?v=4.6.15',
  './js/lift.js?v=4.6.15',
  './js/writer.js?v=4.6.15',
  './js/planner.js?v=4.6.15',
  './js/planner-flow.js?v=4.6.15',
  './css/planner-flow.css?v=4.6.15',
  './js/stats.js?v=4.6.15',
  './js/history.js?v=4.6.15',
  './js/settings.js?v=4.6.15',
  './js/stats-story.js?v=4.6.15',
  './js/app.js?v=4.6.15',
