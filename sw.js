const CACHE = 'showup-v3.3.541';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.541',
  './js/core.js?v=3.3.541',
  './js/derive.js?v=3.3.541',
  './js/util.js?v=3.3.541',
  './js/header.js?v=3.3.541',
  './js/report.js?v=3.3.541',
  './js/today.js?v=3.3.541',
  './js/progression.js?v=3.3.541',
  './js/lift.js?v=3.3.541',
  './js/writer.js?v=3.3.541',
  './js/stats.js?v=3.3.541',
  './js/history.js?v=3.3.541',
  './js/settings.js?v=3.3.541',
  './js/app.js?v=3.3.541',
