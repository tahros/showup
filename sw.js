const CACHE = 'showup-v3.3.250';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.250',
  './js/core.js?v=3.3.250',
  './js/derive.js?v=3.3.250',
  './js/util.js?v=3.3.250',
  './js/header.js?v=3.3.250',
  './js/report.js?v=3.3.250',
  './js/today.js?v=3.3.250',
  './js/lift.js?v=3.3.250',
  './js/stats.js?v=3.3.250',
  './js/history.js?v=3.3.250',
  './js/settings.js?v=3.3.250',
  './js/app.js?v=3.3.250',
