const CACHE = 'showup-v3.3.88';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.88',
  './js/core.js?v=3.3.88',
  './js/derive.js?v=3.3.88',
  './js/util.js?v=3.3.88',
  './js/header.js?v=3.3.88',
  './js/report.js?v=3.3.88',
  './js/today.js?v=3.3.88',
  './js/lift.js?v=3.3.88',
  './js/stats.js?v=3.3.88',
  './js/history.js?v=3.3.88',
  './js/settings.js?v=3.3.88',
  './js/app.js?v=3.3.88',
  './icon-192.png',
  './icon-512.png',
