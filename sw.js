const CACHE = 'showup-v4.6.7';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.7',
  './css/planner.css?v=4.6.7',
  './css/mascot.css?v=4.6.7',
  './js/mascot.js?v=4.6.7',
  './js/plates.js?v=4.6.7',
  './js/plate-canvas.js?v=4.6.7',
  './css/plates.css?v=4.6.7',
  ...
  './js/core.js?v=4.6.7',
  './js/derive.js?v=4.6.7',
  './js/util.js?v=4.6.7',
  './js/planlink.js?v=4.6.7',
  './js/realset.js?v=4.6.7',
  './js/reprange.js?v=4.6.7',
  './js/verdict.js?v=4.6.7',
  './js/header.js?v=4.6.7',
  './js/report.js?v=4.6.7',
  './js/today.js?v=4.6.7',
  './js/progression.js?v=4.6.7',
  './js/lift.js?v=4.6.7',
  './js/writer.js?v=4.6.7',
  './js/planner.js?v=4.6.7',
  './js/planner-flow.js?v=4.6.7',
  './css/planner-flow.css?v=4.6.7',
  './js/stats.js?v=4.6.7',
  './js/history.js?v=4.6.7',
  './js/settings.js?v=4.6.7',
  './js/stats-story.js?v=4.6.7',
  './js/app.js?v=4.6.7',
