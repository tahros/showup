const CACHE = 'showup-v3.3.73';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.73',
  './js/core.js?v=3.3.73',
  './js/derive.js?v=3.3.73',
  './js/util.js?v=3.3.73',
  './js/header.js?v=3.3.73',
  './js/report.js?v=3.3.73',
  './js/today.js?v=3.3.73',
  './js/lift.js?v=3.3.73',
  './js/stats.js?v=3.3.73',
  './js/history.js?v=3.3.73',
  './js/settings.js?v=3.3.73',
  './js/app.js?v=3.3.73',
  './icon-192.png',
  './icon-512.png',
