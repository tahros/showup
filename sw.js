const CACHE = 'showup-v4.6.94';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.94',
  './css/planner.css?v=4.6.94',
  './css/mascot.css?v=4.6.94',
  './js/retro.js?v=4.6.94',
  './css/retro.css?v=4.6.94',
  './js/mascot.js?v=4.6.94',
  './js/plates.js?v=4.6.94',
  './js/plate-canvas.js?v=4.6.94',
  './css/plates.css?v=4.6.94',
  ...
  './js/core.js?v=4.6.94',
  './js/derive.js?v=4.6.94',
  './js/util.js?v=4.6.94',
  './js/planlink.js?v=4.6.94',
  './js/realset.js?v=4.6.94',
  './js/reprange.js?v=4.6.94',
  './js/verdict.js?v=4.6.94',
  './js/header.js?v=4.6.94',
  './js/report.js?v=4.6.94',
  './js/today.js?v=4.6.94',
  './js/progression.js?v=4.6.94',
  './js/lift.js?v=4.6.94',
  './js/writer.js?v=4.6.94',
  './js/planner.js?v=4.6.94',
  './js/planner-flow.js?v=4.6.94',
  './css/planner-flow.css?v=4.6.94',
  './js/stats.js?v=4.6.94',
  './js/history.js?v=4.6.94',
  './js/settings.js?v=4.6.94',
  './js/stats-story.js?v=4.6.94',
  './js/app.js?v=4.6.94',
