const CACHE = 'showup-v3.3.282';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.282',
  './js/core.js?v=3.3.282',
  './js/derive.js?v=3.3.282',
  './js/util.js?v=3.3.282',
  './js/header.js?v=3.3.282',
  './js/report.js?v=3.3.282',
  './js/today.js?v=3.3.282',
  './js/lift.js?v=3.3.282',
  './js/stats.js?v=3.3.282',
  './js/history.js?v=3.3.282',
  './js/settings.js?v=3.3.282',
  './js/app.js?v=3.3.282',
