const CACHE = 'showup-v3.3.109';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.109',
  './js/core.js?v=3.3.109',
  './js/derive.js?v=3.3.109',
  './js/util.js?v=3.3.109',
  './js/header.js?v=3.3.109',
  './js/report.js?v=3.3.109',
  './js/today.js?v=3.3.109',
  './js/lift.js?v=3.3.109',
  './js/stats.js?v=3.3.109',
  './js/history.js?v=3.3.109',
  './js/settings.js?v=3.3.109',
  './js/app.js?v=3.3.109',
  './icon-192.png',
  './icon-512.png',
