const CACHE = 'showup-v3.3.325';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.325',
  './js/core.js?v=3.3.325',
  './js/derive.js?v=3.3.325',
  './js/util.js?v=3.3.325',
  './js/header.js?v=3.3.325',
  './js/report.js?v=3.3.325',
  './js/today.js?v=3.3.325',
  './js/lift.js?v=3.3.325',
  './js/stats.js?v=3.3.325',
  './js/history.js?v=3.3.325',
  './js/settings.js?v=3.3.325',
  './js/app.js?v=3.3.325',
