const CACHE = 'showup-v4.6.4';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.4',
  './css/planner.css?v=4.6.4',
  './css/mascot.css?v=4.6.4',
  './js/mascot.js?v=4.6.4',
  './js/plates.js?v=4.6.4',
  './js/plate-canvas.js?v=4.6.4',
  './css/plates.css?v=4.6.4',
  ...
  './js/core.js?v=4.6.4',
  './js/derive.js?v=4.6.4',
  './js/util.js?v=4.6.4',
  './js/planlink.js?v=4.6.4',
  './js/realset.js?v=4.6.4',
  './js/reprange.js?v=4.6.4',
  './js/verdict.js?v=4.6.4',
  './js/header.js?v=4.6.4',
  './js/report.js?v=4.6.4',
  './js/today.js?v=4.6.4',
  './js/progression.js?v=4.6.4',
  './js/lift.js?v=4.6.4',
  './js/writer.js?v=4.6.4',
  './js/planner.js?v=4.6.4',
  './js/planner-flow.js?v=4.6.4',
  './css/planner-flow.css?v=4.6.4',
  './js/stats.js?v=4.6.4',
  './js/history.js?v=4.6.4',
  './js/settings.js?v=4.6.4',
  './js/stats-story.js?v=4.6.4',
  './js/app.js?v=4.6.4',
