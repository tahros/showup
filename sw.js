const CACHE = 'showup-v3.3.34';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.34',
  './js/core.js?v=3.3.34',
  './js/derive.js?v=3.3.34',
  './js/util.js?v=3.3.34',
  './js/header.js?v=3.3.34',
  './js/report.js?v=3.3.34',
  './js/today.js?v=3.3.34',
  './js/lift.js?v=3.3.34',
  './js/stats.js?v=3.3.34',
  './js/history.js?v=3.3.34',
  './js/settings.js?v=3.3.34',
  './js/app.js?v=3.3.34',
  './icon-192.png',
  './icon-512.png',
