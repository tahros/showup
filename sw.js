const CACHE = 'showup-v3.3.335';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.335',
  './js/core.js?v=3.3.335',
  './js/derive.js?v=3.3.335',
  './js/util.js?v=3.3.335',
  './js/header.js?v=3.3.335',
  './js/report.js?v=3.3.335',
  './js/today.js?v=3.3.335',
  './js/lift.js?v=3.3.335',
  './js/stats.js?v=3.3.335',
  './js/history.js?v=3.3.335',
  './js/settings.js?v=3.3.335',
  './js/app.js?v=3.3.335',
