const CACHE = 'showup-v3.3.214';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.214',
  './js/core.js?v=3.3.214',
  './js/derive.js?v=3.3.214',
  './js/util.js?v=3.3.214',
  './js/header.js?v=3.3.214',
  './js/report.js?v=3.3.214',
  './js/today.js?v=3.3.214',
  './js/lift.js?v=3.3.214',
  './js/stats.js?v=3.3.214',
  './js/history.js?v=3.3.214',
  './js/settings.js?v=3.3.214',
  './js/app.js?v=3.3.214',
