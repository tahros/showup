const CACHE = 'showup-v4.6.54';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.54',
  './css/planner.css?v=4.6.54',
  './css/mascot.css?v=4.6.54',
  './js/mascot.js?v=4.6.54',
  './js/plates.js?v=4.6.54',
  './js/plate-canvas.js?v=4.6.54',
  './css/plates.css?v=4.6.54',
  ...
  './js/core.js?v=4.6.54',
  './js/derive.js?v=4.6.54',
  './js/util.js?v=4.6.54',
  './js/planlink.js?v=4.6.54',
  './js/realset.js?v=4.6.54',
  './js/reprange.js?v=4.6.54',
  './js/verdict.js?v=4.6.54',
  './js/header.js?v=4.6.54',
  './js/report.js?v=4.6.54',
  './js/today.js?v=4.6.54',
  './js/progression.js?v=4.6.54',
  './js/lift.js?v=4.6.54',
  './js/writer.js?v=4.6.54',
  './js/planner.js?v=4.6.54',
  './js/planner-flow.js?v=4.6.54',
  './css/planner-flow.css?v=4.6.54',
  './js/stats.js?v=4.6.54',
  './js/history.js?v=4.6.54',
  './js/settings.js?v=4.6.54',
  './js/stats-story.js?v=4.6.54',
  './js/app.js?v=4.6.54',
