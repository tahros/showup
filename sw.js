const CACHE = 'showup-v4.6.91';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.91',
  './css/planner.css?v=4.6.91',
  './css/mascot.css?v=4.6.91',
  './js/mascot.js?v=4.6.91',
  './js/plates.js?v=4.6.91',
  './js/plate-canvas.js?v=4.6.91',
  './css/plates.css?v=4.6.91',
  ...
  './js/core.js?v=4.6.91',
  './js/derive.js?v=4.6.91',
  './js/util.js?v=4.6.91',
  './js/planlink.js?v=4.6.91',
  './js/realset.js?v=4.6.91',
  './js/reprange.js?v=4.6.91',
  './js/verdict.js?v=4.6.91',
  './js/header.js?v=4.6.91',
  './js/report.js?v=4.6.91',
  './js/today.js?v=4.6.91',
  './js/progression.js?v=4.6.91',
  './js/lift.js?v=4.6.91',
  './js/writer.js?v=4.6.91',
  './js/planner.js?v=4.6.91',
  './js/planner-flow.js?v=4.6.91',
  './css/planner-flow.css?v=4.6.91',
  './js/stats.js?v=4.6.91',
  './js/history.js?v=4.6.91',
  './js/settings.js?v=4.6.91',
  './js/stats-story.js?v=4.6.91',
  './js/app.js?v=4.6.91',
