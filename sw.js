const CACHE = 'showup-v3.3.183';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.183',
  './js/core.js?v=3.3.183',
  './js/derive.js?v=3.3.183',
  './js/util.js?v=3.3.183',
  './js/header.js?v=3.3.183',
  './js/report.js?v=3.3.183',
  './js/today.js?v=3.3.183',
  './js/lift.js?v=3.3.183',
  './js/stats.js?v=3.3.183',
  './js/history.js?v=3.3.183',
  './js/settings.js?v=3.3.183',
  './js/app.js?v=3.3.183',
  './icon-192.png',
  './icon-512.png',
