const CACHE = 'showup-v3.3.216';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.216',
  './js/core.js?v=3.3.216',
  './js/derive.js?v=3.3.216',
  './js/util.js?v=3.3.216',
  './js/header.js?v=3.3.216',
  './js/report.js?v=3.3.216',
  './js/today.js?v=3.3.216',
  './js/lift.js?v=3.3.216',
  './js/stats.js?v=3.3.216',
  './js/history.js?v=3.3.216',
  './js/settings.js?v=3.3.216',
  './js/app.js?v=3.3.216',
