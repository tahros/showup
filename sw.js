const CACHE = 'showup-v3.3.188';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.188',
  './js/core.js?v=3.3.188',
  './js/derive.js?v=3.3.188',
  './js/util.js?v=3.3.188',
  './js/header.js?v=3.3.188',
  './js/report.js?v=3.3.188',
  './js/today.js?v=3.3.188',
  './js/lift.js?v=3.3.188',
  './js/stats.js?v=3.3.188',
  './js/history.js?v=3.3.188',
  './js/settings.js?v=3.3.188',
  './js/app.js?v=3.3.188',
  './icon-192.png',
  './icon-512.png',
