const CACHE = 'showup-v3.3.233';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.233',
  './js/core.js?v=3.3.233',
  './js/derive.js?v=3.3.233',
  './js/util.js?v=3.3.233',
  './js/header.js?v=3.3.233',
  './js/report.js?v=3.3.233',
  './js/today.js?v=3.3.233',
  './js/lift.js?v=3.3.233',
  './js/stats.js?v=3.3.233',
  './js/history.js?v=3.3.233',
  './js/settings.js?v=3.3.233',
  './js/app.js?v=3.3.233',
