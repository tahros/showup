const CACHE = 'showup-v3.3.304';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.304',
  './js/core.js?v=3.3.304',
  './js/derive.js?v=3.3.304',
  './js/util.js?v=3.3.304',
  './js/header.js?v=3.3.304',
  './js/report.js?v=3.3.304',
  './js/today.js?v=3.3.304',
  './js/lift.js?v=3.3.304',
  './js/stats.js?v=3.3.304',
  './js/history.js?v=3.3.304',
  './js/settings.js?v=3.3.304',
  './js/app.js?v=3.3.304',
