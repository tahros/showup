const CACHE = 'showup-v3.3.13';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.13',
  './js/core.js?v=3.3.13',
  './js/derive.js?v=3.3.13',
  './js/util.js?v=3.3.13',
  './js/header.js?v=3.3.13',
  './js/report.js?v=3.3.13',
  './js/today.js?v=3.3.13',
  './js/lift.js?v=3.3.13',
  './js/stats.js?v=3.3.13',
  './js/history.js?v=3.3.13',
  './js/settings.js?v=3.3.13',
  './js/app.js?v=3.3.13',
  './icon-192.png',
  './icon-512.png',
