const CACHE = 'showup-v4.6.76';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.76',
  './css/planner.css?v=4.6.76',
  './css/mascot.css?v=4.6.76',
  './js/mascot.js?v=4.6.76',
  './js/plates.js?v=4.6.76',
  './js/plate-canvas.js?v=4.6.76',
  './css/plates.css?v=4.6.76',
  ...
  './js/core.js?v=4.6.76',
  './js/derive.js?v=4.6.76',
  './js/util.js?v=4.6.76',
  './js/planlink.js?v=4.6.76',
  './js/realset.js?v=4.6.76',
  './js/reprange.js?v=4.6.76',
  './js/verdict.js?v=4.6.76',
  './js/header.js?v=4.6.76',
  './js/report.js?v=4.6.76',
  './js/today.js?v=4.6.76',
  './js/progression.js?v=4.6.76',
  './js/lift.js?v=4.6.76',
  './js/writer.js?v=4.6.76',
  './js/planner.js?v=4.6.76',
  './js/planner-flow.js?v=4.6.76',
  './css/planner-flow.css?v=4.6.76',
  './js/stats.js?v=4.6.76',
  './js/history.js?v=4.6.76',
  './js/settings.js?v=4.6.76',
  './js/stats-story.js?v=4.6.76',
  './js/app.js?v=4.6.76',
