const CACHE = 'showup-v3.3.133';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.133',
  './js/core.js?v=3.3.133',
  './js/derive.js?v=3.3.133',
  './js/util.js?v=3.3.133',
  './js/header.js?v=3.3.133',
  './js/report.js?v=3.3.133',
  './js/today.js?v=3.3.133',
  './js/lift.js?v=3.3.133',
  './js/stats.js?v=3.3.133',
  './js/history.js?v=3.3.133',
  './js/settings.js?v=3.3.133',
  './js/app.js?v=3.3.133',
  './icon-192.png',
  './icon-512.png',
