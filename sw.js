const CACHE = 'showup-v3.3.62';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.62',
  './js/core.js?v=3.3.62',
  './js/derive.js?v=3.3.62',
  './js/util.js?v=3.3.62',
  './js/header.js?v=3.3.62',
  './js/report.js?v=3.3.62',
  './js/today.js?v=3.3.62',
  './js/lift.js?v=3.3.62',
  './js/stats.js?v=3.3.62',
  './js/history.js?v=3.3.62',
  './js/settings.js?v=3.3.62',
  './js/app.js?v=3.3.62',
  './icon-192.png',
  './icon-512.png',
