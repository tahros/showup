const CACHE = 'showup-v4.6.70';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.70',
  './css/planner.css?v=4.6.70',
  './css/mascot.css?v=4.6.70',
  './js/mascot.js?v=4.6.70',
  './js/plates.js?v=4.6.70',
  './js/plate-canvas.js?v=4.6.70',
  './css/plates.css?v=4.6.70',
  ...
  './js/core.js?v=4.6.70',
  './js/derive.js?v=4.6.70',
  './js/util.js?v=4.6.70',
  './js/planlink.js?v=4.6.70',
  './js/realset.js?v=4.6.70',
  './js/reprange.js?v=4.6.70',
  './js/verdict.js?v=4.6.70',
  './js/header.js?v=4.6.70',
  './js/report.js?v=4.6.70',
  './js/today.js?v=4.6.70',
  './js/progression.js?v=4.6.70',
  './js/lift.js?v=4.6.70',
  './js/writer.js?v=4.6.70',
  './js/planner.js?v=4.6.70',
  './js/planner-flow.js?v=4.6.70',
  './css/planner-flow.css?v=4.6.70',
  './js/stats.js?v=4.6.70',
  './js/history.js?v=4.6.70',
  './js/settings.js?v=4.6.70',
  './js/stats-story.js?v=4.6.70',
  './js/app.js?v=4.6.70',
