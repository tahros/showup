const CACHE = 'showup-v3.3.32';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.32',
  './js/core.js?v=3.3.32',
  './js/derive.js?v=3.3.32',
  './js/util.js?v=3.3.32',
  './js/header.js?v=3.3.32',
  './js/report.js?v=3.3.32',
  './js/today.js?v=3.3.32',
  './js/lift.js?v=3.3.32',
  './js/stats.js?v=3.3.32',
  './js/history.js?v=3.3.32',
  './js/settings.js?v=3.3.32',
  './js/app.js?v=3.3.32',
  './icon-192.png',
  './icon-512.png',
