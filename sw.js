const CACHE = 'showup-v4.6.55';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.55',
  './css/planner.css?v=4.6.55',
  './css/mascot.css?v=4.6.55',
  './js/mascot.js?v=4.6.55',
  './js/plates.js?v=4.6.55',
  './js/plate-canvas.js?v=4.6.55',
  './css/plates.css?v=4.6.55',
  ...
  './js/core.js?v=4.6.55',
  './js/derive.js?v=4.6.55',
  './js/util.js?v=4.6.55',
  './js/planlink.js?v=4.6.55',
  './js/realset.js?v=4.6.55',
  './js/reprange.js?v=4.6.55',
  './js/verdict.js?v=4.6.55',
  './js/header.js?v=4.6.55',
  './js/report.js?v=4.6.55',
  './js/today.js?v=4.6.55',
  './js/progression.js?v=4.6.55',
  './js/lift.js?v=4.6.55',
  './js/writer.js?v=4.6.55',
  './js/planner.js?v=4.6.55',
  './js/planner-flow.js?v=4.6.55',
  './css/planner-flow.css?v=4.6.55',
  './js/stats.js?v=4.6.55',
  './js/history.js?v=4.6.55',
  './js/settings.js?v=4.6.55',
  './js/stats-story.js?v=4.6.55',
  './js/app.js?v=4.6.55',
