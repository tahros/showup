const CACHE = 'showup-v3.3.172';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.172',
  './js/core.js?v=3.3.172',
  './js/derive.js?v=3.3.172',
  './js/util.js?v=3.3.172',
  './js/header.js?v=3.3.172',
  './js/report.js?v=3.3.172',
  './js/today.js?v=3.3.172',
  './js/lift.js?v=3.3.172',
  './js/stats.js?v=3.3.172',
  './js/history.js?v=3.3.172',
  './js/settings.js?v=3.3.172',
  './js/app.js?v=3.3.172',
  './icon-192.png',
  './icon-512.png',
