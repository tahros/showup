const CACHE = 'showup-v4.5.16';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.5.16',
  './css/planner.css?v=4.5.16',
  './css/mascot.css?v=4.5.16',
  './js/mascot.js?v=4.5.16',
  './js/plates.js?v=4.5.16',
  './js/plate-canvas.js?v=4.5.16',
  './css/plates.css?v=4.5.16',
  ...
  './js/core.js?v=4.5.16',
  './js/derive.js?v=4.5.16',
  './js/util.js?v=4.5.16',
  './js/realset.js?v=4.5.16',
  './js/reprange.js?v=4.5.16',
  './js/verdict.js?v=4.5.16',
  './js/header.js?v=4.5.16',
  './js/report.js?v=4.5.16',
  './js/today.js?v=4.5.16',
  './js/progression.js?v=4.5.16',
  './js/lift.js?v=4.5.16',
  './js/writer.js?v=4.5.16',
  './js/planner.js?v=4.5.16',
  './js/stats.js?v=4.5.16',
  './js/history.js?v=4.5.16',
  './js/settings.js?v=4.5.16',
  './js/stats-story.js?v=4.5.16',
  './js/app.js?v=4.5.16',
