const CACHE = 'showup-v4.6.35';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.35',
  './css/planner.css?v=4.6.35',
  './css/mascot.css?v=4.6.35',
  './js/mascot.js?v=4.6.35',
  './js/plates.js?v=4.6.35',
  './js/plate-canvas.js?v=4.6.35',
  './css/plates.css?v=4.6.35',
  ...
  './js/core.js?v=4.6.35',
  './js/derive.js?v=4.6.35',
  './js/util.js?v=4.6.35',
  './js/planlink.js?v=4.6.35',
  './js/realset.js?v=4.6.35',
  './js/reprange.js?v=4.6.35',
  './js/verdict.js?v=4.6.35',
  './js/header.js?v=4.6.35',
  './js/report.js?v=4.6.35',
  './js/today.js?v=4.6.35',
  './js/progression.js?v=4.6.35',
  './js/lift.js?v=4.6.35',
  './js/writer.js?v=4.6.35',
  './js/planner.js?v=4.6.35',
  './js/planner-flow.js?v=4.6.35',
  './css/planner-flow.css?v=4.6.35',
  './js/stats.js?v=4.6.35',
  './js/history.js?v=4.6.35',
  './js/settings.js?v=4.6.35',
  './js/stats-story.js?v=4.6.35',
  './js/app.js?v=4.6.35',
