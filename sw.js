const CACHE = 'showup-v3.3.202';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.202',
  './js/core.js?v=3.3.202',
  './js/derive.js?v=3.3.202',
  './js/util.js?v=3.3.202',
  './js/header.js?v=3.3.202',
  './js/report.js?v=3.3.202',
  './js/today.js?v=3.3.202',
  './js/lift.js?v=3.3.202',
  './js/stats.js?v=3.3.202',
  './js/history.js?v=3.3.202',
  './js/settings.js?v=3.3.202',
  './js/app.js?v=3.3.202',
  './icon-192.png',
  './icon-512.png',
