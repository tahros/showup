const CACHE = 'showup-v3.3.98';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.98',
  './js/core.js?v=3.3.98',
  './js/derive.js?v=3.3.98',
  './js/util.js?v=3.3.98',
  './js/header.js?v=3.3.98',
  './js/report.js?v=3.3.98',
  './js/today.js?v=3.3.98',
  './js/lift.js?v=3.3.98',
  './js/stats.js?v=3.3.98',
  './js/history.js?v=3.3.98',
  './js/settings.js?v=3.3.98',
  './js/app.js?v=3.3.98',
  './icon-192.png',
  './icon-512.png',
