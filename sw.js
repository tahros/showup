const CACHE = 'showup-v3.3.377';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.377',
  './js/core.js?v=3.3.377',
  './js/derive.js?v=3.3.377',
  './js/util.js?v=3.3.377',
  './js/header.js?v=3.3.377',
  './js/report.js?v=3.3.377',
  './js/today.js?v=3.3.377',
  './js/lift.js?v=3.3.377',
  './js/stats.js?v=3.3.377',
  './js/history.js?v=3.3.377',
  './js/settings.js?v=3.3.377',
  './js/app.js?v=3.3.377',
