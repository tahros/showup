const CACHE = 'showup-v3.3.386';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.386',
  './js/core.js?v=3.3.386',
  './js/derive.js?v=3.3.386',
  './js/util.js?v=3.3.386',
  './js/header.js?v=3.3.386',
  './js/report.js?v=3.3.386',
  './js/today.js?v=3.3.386',
  './js/lift.js?v=3.3.386',
  './js/stats.js?v=3.3.386',
  './js/history.js?v=3.3.386',
  './js/settings.js?v=3.3.386',
  './js/app.js?v=3.3.386',
