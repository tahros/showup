const CACHE = 'showup-v4.6.84';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.84',
  './css/planner.css?v=4.6.84',
  './css/mascot.css?v=4.6.84',
  './js/mascot.js?v=4.6.84',
  './js/plates.js?v=4.6.84',
  './js/plate-canvas.js?v=4.6.84',
  './css/plates.css?v=4.6.84',
  ...
  './js/core.js?v=4.6.84',
  './js/derive.js?v=4.6.84',
  './js/util.js?v=4.6.84',
  './js/planlink.js?v=4.6.84',
  './js/realset.js?v=4.6.84',
  './js/reprange.js?v=4.6.84',
  './js/verdict.js?v=4.6.84',
  './js/header.js?v=4.6.84',
  './js/report.js?v=4.6.84',
  './js/today.js?v=4.6.84',
  './js/progression.js?v=4.6.84',
  './js/lift.js?v=4.6.84',
  './js/writer.js?v=4.6.84',
  './js/planner.js?v=4.6.84',
  './js/planner-flow.js?v=4.6.84',
  './css/planner-flow.css?v=4.6.84',
  './js/stats.js?v=4.6.84',
  './js/history.js?v=4.6.84',
  './js/settings.js?v=4.6.84',
  './js/stats-story.js?v=4.6.84',
  './js/app.js?v=4.6.84',
