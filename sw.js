const CACHE = 'showup-v3.3.270';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.270',
  './js/core.js?v=3.3.270',
  './js/derive.js?v=3.3.270',
  './js/util.js?v=3.3.270',
  './js/header.js?v=3.3.270',
  './js/report.js?v=3.3.270',
  './js/today.js?v=3.3.270',
  './js/lift.js?v=3.3.270',
  './js/stats.js?v=3.3.270',
  './js/history.js?v=3.3.270',
  './js/settings.js?v=3.3.270',
  './js/app.js?v=3.3.270',
