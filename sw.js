const CACHE = 'showup-v3.3.146';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.146',
  './js/core.js?v=3.3.146',
  './js/derive.js?v=3.3.146',
  './js/util.js?v=3.3.146',
  './js/header.js?v=3.3.146',
  './js/report.js?v=3.3.146',
  './js/today.js?v=3.3.146',
  './js/lift.js?v=3.3.146',
  './js/stats.js?v=3.3.146',
  './js/history.js?v=3.3.146',
  './js/settings.js?v=3.3.146',
  './js/app.js?v=3.3.146',
  './icon-192.png',
  './icon-512.png',
