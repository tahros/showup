const CACHE = 'showup-v4.6.61';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.61',
  './css/planner.css?v=4.6.61',
  './css/mascot.css?v=4.6.61',
  './js/mascot.js?v=4.6.61',
  './js/plates.js?v=4.6.61',
  './js/plate-canvas.js?v=4.6.61',
  './css/plates.css?v=4.6.61',
  ...
  './js/core.js?v=4.6.61',
  './js/derive.js?v=4.6.61',
  './js/util.js?v=4.6.61',
  './js/planlink.js?v=4.6.61',
  './js/realset.js?v=4.6.61',
  './js/reprange.js?v=4.6.61',
  './js/verdict.js?v=4.6.61',
  './js/header.js?v=4.6.61',
  './js/report.js?v=4.6.61',
  './js/today.js?v=4.6.61',
  './js/progression.js?v=4.6.61',
  './js/lift.js?v=4.6.61',
  './js/writer.js?v=4.6.61',
  './js/planner.js?v=4.6.61',
  './js/planner-flow.js?v=4.6.61',
  './css/planner-flow.css?v=4.6.61',
  './js/stats.js?v=4.6.61',
  './js/history.js?v=4.6.61',
  './js/settings.js?v=4.6.61',
  './js/stats-story.js?v=4.6.61',
  './js/app.js?v=4.6.61',
