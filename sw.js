const CACHE = 'showup-v3.3.287';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.287',
  './js/core.js?v=3.3.287',
  './js/derive.js?v=3.3.287',
  './js/util.js?v=3.3.287',
  './js/header.js?v=3.3.287',
  './js/report.js?v=3.3.287',
  './js/today.js?v=3.3.287',
  './js/lift.js?v=3.3.287',
  './js/stats.js?v=3.3.287',
  './js/history.js?v=3.3.287',
  './js/settings.js?v=3.3.287',
  './js/app.js?v=3.3.287',
