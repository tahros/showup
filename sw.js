const CACHE = 'showup-v3.3.384';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.384',
  './js/core.js?v=3.3.384',
  './js/derive.js?v=3.3.384',
  './js/util.js?v=3.3.384',
  './js/header.js?v=3.3.384',
  './js/report.js?v=3.3.384',
  './js/today.js?v=3.3.384',
  './js/lift.js?v=3.3.384',
  './js/stats.js?v=3.3.384',
  './js/history.js?v=3.3.384',
  './js/settings.js?v=3.3.384',
  './js/app.js?v=3.3.384',
