const CACHE = 'showup-v4.6.42';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.42',
  './css/planner.css?v=4.6.42',
  './css/mascot.css?v=4.6.42',
  './js/mascot.js?v=4.6.42',
  './js/plates.js?v=4.6.42',
  './js/plate-canvas.js?v=4.6.42',
  './css/plates.css?v=4.6.42',
  ...
  './js/core.js?v=4.6.42',
  './js/derive.js?v=4.6.42',
  './js/util.js?v=4.6.42',
  './js/planlink.js?v=4.6.42',
  './js/realset.js?v=4.6.42',
  './js/reprange.js?v=4.6.42',
  './js/verdict.js?v=4.6.42',
  './js/header.js?v=4.6.42',
  './js/report.js?v=4.6.42',
  './js/today.js?v=4.6.42',
  './js/progression.js?v=4.6.42',
  './js/lift.js?v=4.6.42',
  './js/writer.js?v=4.6.42',
  './js/planner.js?v=4.6.42',
  './js/planner-flow.js?v=4.6.42',
  './css/planner-flow.css?v=4.6.42',
  './js/stats.js?v=4.6.42',
  './js/history.js?v=4.6.42',
  './js/settings.js?v=4.6.42',
  './js/stats-story.js?v=4.6.42',
  './js/app.js?v=4.6.42',
