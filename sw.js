const CACHE = 'showup-v4.6.98';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.98',
  './css/planner.css?v=4.6.98',
  './css/mascot.css?v=4.6.98',
  './js/retro.js?v=4.6.98',
  './css/retro.css?v=4.6.98',
  './js/mascot.js?v=4.6.98',
  './js/plates.js?v=4.6.98',
  './js/plate-canvas.js?v=4.6.98',
  './css/plates.css?v=4.6.98',
  ...
  './js/core.js?v=4.6.98',
  './js/derive.js?v=4.6.98',
  './js/util.js?v=4.6.98',
  './js/planlink.js?v=4.6.98',
  './js/realset.js?v=4.6.98',
  './js/reprange.js?v=4.6.98',
  './js/verdict.js?v=4.6.98',
  './js/header.js?v=4.6.98',
  './js/report.js?v=4.6.98',
  './js/today.js?v=4.6.98',
  './js/progression.js?v=4.6.98',
  './js/lift.js?v=4.6.98',
  './js/writer.js?v=4.6.98',
  './js/planner.js?v=4.6.98',
  './js/planner-flow.js?v=4.6.98',
  './css/planner-flow.css?v=4.6.98',
  './js/stats.js?v=4.6.98',
  './js/history.js?v=4.6.98',
  './js/settings.js?v=4.6.98',
  './js/stats-story.js?v=4.6.98',
  './js/app.js?v=4.6.98',
