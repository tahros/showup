const CACHE = 'showup-v3.3.116';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.116',
  './js/core.js?v=3.3.116',
  './js/derive.js?v=3.3.116',
  './js/util.js?v=3.3.116',
  './js/header.js?v=3.3.116',
  './js/report.js?v=3.3.116',
  './js/today.js?v=3.3.116',
  './js/lift.js?v=3.3.116',
  './js/stats.js?v=3.3.116',
  './js/history.js?v=3.3.116',
  './js/settings.js?v=3.3.116',
  './js/app.js?v=3.3.116',
  './icon-192.png',
  './icon-512.png',
