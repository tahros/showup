const CACHE = 'showup-v3.3.159';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.159',
  './js/core.js?v=3.3.159',
  './js/derive.js?v=3.3.159',
  './js/util.js?v=3.3.159',
  './js/header.js?v=3.3.159',
  './js/report.js?v=3.3.159',
  './js/today.js?v=3.3.159',
  './js/lift.js?v=3.3.159',
  './js/stats.js?v=3.3.159',
  './js/history.js?v=3.3.159',
  './js/settings.js?v=3.3.159',
  './js/app.js?v=3.3.159',
  './icon-192.png',
  './icon-512.png',
