const CACHE = 'showup-v3.3.313';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.313',
  './js/core.js?v=3.3.313',
  './js/derive.js?v=3.3.313',
  './js/util.js?v=3.3.313',
  './js/header.js?v=3.3.313',
  './js/report.js?v=3.3.313',
  './js/today.js?v=3.3.313',
  './js/lift.js?v=3.3.313',
  './js/stats.js?v=3.3.313',
  './js/history.js?v=3.3.313',
  './js/settings.js?v=3.3.313',
  './js/app.js?v=3.3.313',
