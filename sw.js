const CACHE = 'showup-v4.5.14';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.5.14',
  './css/planner.css?v=4.5.14',
  './css/mascot.css?v=4.5.14',
  './js/mascot.js?v=4.5.14',
  './js/plates.js?v=4.5.14',
  './js/plate-canvas.js?v=4.5.14',
  './css/plates.css?v=4.5.14',
  ...
  './js/core.js?v=4.5.14',
  './js/derive.js?v=4.5.14',
  './js/util.js?v=4.5.14',
  './js/realset.js?v=4.5.14',
  './js/reprange.js?v=4.5.14',
  './js/verdict.js?v=4.5.14',
  './js/header.js?v=4.5.14',
  './js/report.js?v=4.5.14',
  './js/today.js?v=4.5.14',
  './js/progression.js?v=4.5.14',
  './js/lift.js?v=4.5.14',
  './js/writer.js?v=4.5.14',
  './js/planner.js?v=4.5.14',
  './js/stats.js?v=4.5.14',
  './js/history.js?v=4.5.14',
  './js/settings.js?v=4.5.14',
  './js/stats-story.js?v=4.5.14',
  './js/app.js?v=4.5.14',
