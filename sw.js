const CACHE = 'showup-v3.3.244';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.244',
  './js/core.js?v=3.3.244',
  './js/derive.js?v=3.3.244',
  './js/util.js?v=3.3.244',
  './js/header.js?v=3.3.244',
  './js/report.js?v=3.3.244',
  './js/today.js?v=3.3.244',
  './js/lift.js?v=3.3.244',
  './js/stats.js?v=3.3.244',
  './js/history.js?v=3.3.244',
  './js/settings.js?v=3.3.244',
  './js/app.js?v=3.3.244',
