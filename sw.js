const CACHE = 'showup-v3.3.189';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.189',
  './js/core.js?v=3.3.189',
  './js/derive.js?v=3.3.189',
  './js/util.js?v=3.3.189',
  './js/header.js?v=3.3.189',
  './js/report.js?v=3.3.189',
  './js/today.js?v=3.3.189',
  './js/lift.js?v=3.3.189',
  './js/stats.js?v=3.3.189',
  './js/history.js?v=3.3.189',
  './js/settings.js?v=3.3.189',
  './js/app.js?v=3.3.189',
  './icon-192.png',
  './icon-512.png',
