const CACHE = 'showup-v4.6.24';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.24',
  './css/planner.css?v=4.6.24',
  './css/mascot.css?v=4.6.24',
  './js/mascot.js?v=4.6.24',
  './js/plates.js?v=4.6.24',
  './js/plate-canvas.js?v=4.6.24',
  './css/plates.css?v=4.6.24',
  ...
  './js/core.js?v=4.6.24',
  './js/derive.js?v=4.6.24',
  './js/util.js?v=4.6.24',
  './js/planlink.js?v=4.6.24',
  './js/realset.js?v=4.6.24',
  './js/reprange.js?v=4.6.24',
  './js/verdict.js?v=4.6.24',
  './js/header.js?v=4.6.24',
  './js/report.js?v=4.6.24',
  './js/today.js?v=4.6.24',
  './js/progression.js?v=4.6.24',
  './js/lift.js?v=4.6.24',
  './js/writer.js?v=4.6.24',
  './js/planner.js?v=4.6.24',
  './js/planner-flow.js?v=4.6.24',
  './css/planner-flow.css?v=4.6.24',
  './js/stats.js?v=4.6.24',
  './js/history.js?v=4.6.24',
  './js/settings.js?v=4.6.24',
  './js/stats-story.js?v=4.6.24',
  './js/app.js?v=4.6.24',
