const CACHE = 'showup-v3.3.29';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.29',
  './js/core.js?v=3.3.29',
  './js/derive.js?v=3.3.29',
  './js/util.js?v=3.3.29',
  './js/header.js?v=3.3.29',
  './js/report.js?v=3.3.29',
  './js/today.js?v=3.3.29',
  './js/lift.js?v=3.3.29',
  './js/stats.js?v=3.3.29',
  './js/history.js?v=3.3.29',
  './js/settings.js?v=3.3.29',
  './js/app.js?v=3.3.29',
  './icon-192.png',
  './icon-512.png',
