const CACHE = 'showup-v3.3.162';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.162',
  './js/core.js?v=3.3.162',
  './js/derive.js?v=3.3.162',
  './js/util.js?v=3.3.162',
  './js/header.js?v=3.3.162',
  './js/report.js?v=3.3.162',
  './js/today.js?v=3.3.162',
  './js/lift.js?v=3.3.162',
  './js/stats.js?v=3.3.162',
  './js/history.js?v=3.3.162',
  './js/settings.js?v=3.3.162',
  './js/app.js?v=3.3.162',
  './icon-192.png',
  './icon-512.png',
