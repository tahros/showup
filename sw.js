const CACHE = 'showup-v3.3.112';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.112',
  './js/core.js?v=3.3.112',
  './js/derive.js?v=3.3.112',
  './js/util.js?v=3.3.112',
  './js/header.js?v=3.3.112',
  './js/report.js?v=3.3.112',
  './js/today.js?v=3.3.112',
  './js/lift.js?v=3.3.112',
  './js/stats.js?v=3.3.112',
  './js/history.js?v=3.3.112',
  './js/settings.js?v=3.3.112',
  './js/app.js?v=3.3.112',
  './icon-192.png',
  './icon-512.png',
