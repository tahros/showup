const CACHE = 'showup-v3.3.80';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.80',
  './js/core.js?v=3.3.80',
  './js/derive.js?v=3.3.80',
  './js/util.js?v=3.3.80',
  './js/header.js?v=3.3.80',
  './js/report.js?v=3.3.80',
  './js/today.js?v=3.3.80',
  './js/lift.js?v=3.3.80',
  './js/stats.js?v=3.3.80',
  './js/history.js?v=3.3.80',
  './js/settings.js?v=3.3.80',
  './js/app.js?v=3.3.80',
  './icon-192.png',
  './icon-512.png',
