const CACHE = 'showup-v3.3.18';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.18',
  './js/core.js?v=3.3.18',
  './js/derive.js?v=3.3.18',
  './js/util.js?v=3.3.18',
  './js/header.js?v=3.3.18',
  './js/report.js?v=3.3.18',
  './js/today.js?v=3.3.18',
  './js/lift.js?v=3.3.18',
  './js/stats.js?v=3.3.18',
  './js/history.js?v=3.3.18',
  './js/settings.js?v=3.3.18',
  './js/app.js?v=3.3.18',
  './icon-192.png',
  './icon-512.png',
