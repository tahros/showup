const CACHE = 'showup-v3.3.129';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.129',
  './js/core.js?v=3.3.129',
  './js/derive.js?v=3.3.129',
  './js/util.js?v=3.3.129',
  './js/header.js?v=3.3.129',
  './js/report.js?v=3.3.129',
  './js/today.js?v=3.3.129',
  './js/lift.js?v=3.3.129',
  './js/stats.js?v=3.3.129',
  './js/history.js?v=3.3.129',
  './js/settings.js?v=3.3.129',
  './js/app.js?v=3.3.129',
  './icon-192.png',
  './icon-512.png',
