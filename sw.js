const CACHE = 'showup-v4.6.90';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.90',
  './css/planner.css?v=4.6.90',
  './css/mascot.css?v=4.6.90',
  './js/mascot.js?v=4.6.90',
  './js/plates.js?v=4.6.90',
  './js/plate-canvas.js?v=4.6.90',
  './css/plates.css?v=4.6.90',
  ...
  './js/core.js?v=4.6.90',
  './js/derive.js?v=4.6.90',
  './js/util.js?v=4.6.90',
  './js/planlink.js?v=4.6.90',
  './js/realset.js?v=4.6.90',
  './js/reprange.js?v=4.6.90',
  './js/verdict.js?v=4.6.90',
  './js/header.js?v=4.6.90',
  './js/report.js?v=4.6.90',
  './js/today.js?v=4.6.90',
  './js/progression.js?v=4.6.90',
  './js/lift.js?v=4.6.90',
  './js/writer.js?v=4.6.90',
  './js/planner.js?v=4.6.90',
  './js/planner-flow.js?v=4.6.90',
  './css/planner-flow.css?v=4.6.90',
  './js/stats.js?v=4.6.90',
  './js/history.js?v=4.6.90',
  './js/settings.js?v=4.6.90',
  './js/stats-story.js?v=4.6.90',
  './js/app.js?v=4.6.90',
