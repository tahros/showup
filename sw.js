const CACHE = 'showup-v3.3.297';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.297',
  './js/core.js?v=3.3.297',
  './js/derive.js?v=3.3.297',
  './js/util.js?v=3.3.297',
  './js/header.js?v=3.3.297',
  './js/report.js?v=3.3.297',
  './js/today.js?v=3.3.297',
  './js/lift.js?v=3.3.297',
  './js/stats.js?v=3.3.297',
  './js/history.js?v=3.3.297',
  './js/settings.js?v=3.3.297',
  './js/app.js?v=3.3.297',
