const CACHE = 'showup-v4.1.9';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.1.9',
  './css/planner.css?v=4.1.9',
  './css/mascot.css?v=4.1.9',
  './js/mascot.js?v=4.1.9',
  ...
  './js/core.js?v=4.1.9',
  './js/derive.js?v=4.1.9',
  './js/util.js?v=4.1.9',
  './js/header.js?v=4.1.9',
  './js/report.js?v=4.1.9',
  './js/today.js?v=4.1.9',
  './js/progression.js?v=4.1.9',
  './js/lift.js?v=4.1.9',
  './js/writer.js?v=4.1.9',
  './js/planner.js?v=4.1.9',
  './js/stats.js?v=4.1.9',
  './js/history.js?v=4.1.9',
  './js/settings.js?v=4.1.9',
  './js/app.js?v=4.1.9',
