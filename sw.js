const CACHE = 'showup-v3.3.329';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.329',
  './js/core.js?v=3.3.329',
  './js/derive.js?v=3.3.329',
  './js/util.js?v=3.3.329',
  './js/header.js?v=3.3.329',
  './js/report.js?v=3.3.329',
  './js/today.js?v=3.3.329',
  './js/lift.js?v=3.3.329',
  './js/stats.js?v=3.3.329',
  './js/history.js?v=3.3.329',
  './js/settings.js?v=3.3.329',
  './js/app.js?v=3.3.329',
