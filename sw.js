const CACHE = 'showup-v3.3.150';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.150',
  './js/core.js?v=3.3.150',
  './js/derive.js?v=3.3.150',
  './js/util.js?v=3.3.150',
  './js/header.js?v=3.3.150',
  './js/report.js?v=3.3.150',
  './js/today.js?v=3.3.150',
  './js/lift.js?v=3.3.150',
  './js/stats.js?v=3.3.150',
  './js/history.js?v=3.3.150',
  './js/settings.js?v=3.3.150',
  './js/app.js?v=3.3.150',
  './icon-192.png',
  './icon-512.png',
