const CACHE = 'showup-v4.2.8';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.2.8',
  './css/planner.css?v=4.2.8',
  './css/mascot.css?v=4.2.8',
  './js/mascot.js?v=4.2.8',
  './js/plates.js?v=4.2.8',
  './js/plate-canvas.js?v=4.2.8',
  './css/plates.css?v=4.2.8',
  ...
  './js/core.js?v=4.2.8',
  './js/derive.js?v=4.2.8',
  './js/util.js?v=4.2.8',
  './js/header.js?v=4.2.8',
  './js/report.js?v=4.2.8',
  './js/today.js?v=4.2.8',
  './js/progression.js?v=4.2.8',
  './js/lift.js?v=4.2.8',
  './js/writer.js?v=4.2.8',
  './js/planner.js?v=4.2.8',
  './js/stats.js?v=4.2.8',
  './js/history.js?v=4.2.8',
  './js/settings.js?v=4.2.8',
  './js/app.js?v=4.2.8',
