const CACHE = 'showup-v3.3.41';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.41',
  './js/core.js?v=3.3.41',
  './js/derive.js?v=3.3.41',
  './js/util.js?v=3.3.41',
  './js/header.js?v=3.3.41',
  './js/report.js?v=3.3.41',
  './js/today.js?v=3.3.41',
  './js/lift.js?v=3.3.41',
  './js/stats.js?v=3.3.41',
  './js/history.js?v=3.3.41',
  './js/settings.js?v=3.3.41',
  './js/app.js?v=3.3.41',
  './icon-192.png',
  './icon-512.png',
