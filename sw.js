const CACHE = 'showup-v3.3.139';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.139',
  './js/core.js?v=3.3.139',
  './js/derive.js?v=3.3.139',
  './js/util.js?v=3.3.139',
  './js/header.js?v=3.3.139',
  './js/report.js?v=3.3.139',
  './js/today.js?v=3.3.139',
  './js/lift.js?v=3.3.139',
  './js/stats.js?v=3.3.139',
  './js/history.js?v=3.3.139',
  './js/settings.js?v=3.3.139',
  './js/app.js?v=3.3.139',
  './icon-192.png',
  './icon-512.png',
