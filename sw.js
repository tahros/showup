const CACHE = 'showup-v3.3.323';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.323',
  './js/core.js?v=3.3.323',
  './js/derive.js?v=3.3.323',
  './js/util.js?v=3.3.323',
  './js/header.js?v=3.3.323',
  './js/report.js?v=3.3.323',
  './js/today.js?v=3.3.323',
  './js/lift.js?v=3.3.323',
  './js/stats.js?v=3.3.323',
  './js/history.js?v=3.3.323',
  './js/settings.js?v=3.3.323',
  './js/app.js?v=3.3.323',
