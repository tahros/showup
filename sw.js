const CACHE = 'showup-v3.3.86';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.86',
  './js/core.js?v=3.3.86',
  './js/derive.js?v=3.3.86',
  './js/util.js?v=3.3.86',
  './js/header.js?v=3.3.86',
  './js/report.js?v=3.3.86',
  './js/today.js?v=3.3.86',
  './js/lift.js?v=3.3.86',
  './js/stats.js?v=3.3.86',
  './js/history.js?v=3.3.86',
  './js/settings.js?v=3.3.86',
  './js/app.js?v=3.3.86',
  './icon-192.png',
  './icon-512.png',
