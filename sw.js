const CACHE = 'showup-v4.6.144';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.144',
  './css/planner.css?v=4.6.144',
  './css/mascot.css?v=4.6.144',
  './js/retro.js?v=4.6.144',
  './css/retro.css?v=4.6.144',
  './js/mascot.js?v=4.6.144',
  './js/plates.js?v=4.6.144',
  './js/plate-canvas.js?v=4.6.144',
  './css/plates.css?v=4.6.144',
  ...
  './css/fonts.css?v=4.6.144',
  './assets/fonts/web/ibm-plex-sans-latin-400-normal.woff2',
  './assets/fonts/web/ibm-plex-sans-latin-500-normal.woff2',
  './assets/fonts/web/ibm-plex-sans-latin-600-normal.woff2',
  './assets/fonts/web/ibm-plex-sans-latin-700-normal.woff2',
  './assets/fonts/web/ibm-plex-mono-latin-400-normal.woff2',
  './assets/fonts/web/ibm-plex-mono-latin-500-normal.woff2',
  './assets/fonts/web/ibm-plex-mono-latin-600-normal.woff2',
  ...
  './assets/mascot-mark-chrome.png',
  './assets/mascot-mark-white.png',
  './js/core.js?v=4.6.144',
  './js/ota.js?v=4.6.144',
  './js/derive.js?v=4.6.144',
  './js/util.js?v=4.6.144',
  './js/planlink.js?v=4.6.144',
  './js/realset.js?v=4.6.144',
  './js/reprange.js?v=4.6.144',
  './js/verdict.js?v=4.6.144',
  './js/header.js?v=4.6.144',
  './js/report.js?v=4.6.144',
  './js/today.js?v=4.6.144',
  './js/progression.js?v=4.6.144',
  './js/lift.js?v=4.6.144',
  './js/writer.js?v=4.6.144',
  './js/reminders.js?v=4.6.144',
  './js/health.js?v=4.6.144',
  './js/planner.js?v=4.6.144',
  './js/planner-flow.js?v=4.6.144',
  './css/planner-flow.css?v=4.6.144',
  './js/stats.js?v=4.6.144',
  './js/history.js?v=4.6.144',
  './js/settings.js?v=4.6.144',
  './js/stats-story.js?v=4.6.144',
  './js/heat-replay.js?v=4.6.144',
  './js/app.js?v=4.6.144',
  './js/membership.js?v=4.6.144',
  './js/metrics.js?v=4.6.144',
