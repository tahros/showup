const CACHE = 'showup-v3.3.74';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.74',
  './js/core.js?v=3.3.74',
  './js/derive.js?v=3.3.74',
  './js/util.js?v=3.3.74',
  './js/header.js?v=3.3.74',
  './js/report.js?v=3.3.74',
  './js/today.js?v=3.3.74',
  './js/lift.js?v=3.3.74',
  './js/stats.js?v=3.3.74',
  './js/history.js?v=3.3.74',
  './js/settings.js?v=3.3.74',
  './js/app.js?v=3.3.74',
  './icon-192.png',
  './icon-512.png',
