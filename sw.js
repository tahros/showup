const CACHE = 'showup-v3.3.264';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.264',
  './js/core.js?v=3.3.264',
  './js/derive.js?v=3.3.264',
  './js/util.js?v=3.3.264',
  './js/header.js?v=3.3.264',
  './js/report.js?v=3.3.264',
  './js/today.js?v=3.3.264',
  './js/lift.js?v=3.3.264',
  './js/stats.js?v=3.3.264',
  './js/history.js?v=3.3.264',
  './js/settings.js?v=3.3.264',
  './js/app.js?v=3.3.264',
