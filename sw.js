const CACHE = 'showup-v3.3.20';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.20',
  './js/core.js?v=3.3.20',
  './js/derive.js?v=3.3.20',
  './js/util.js?v=3.3.20',
  './js/header.js?v=3.3.20',
  './js/report.js?v=3.3.20',
  './js/today.js?v=3.3.20',
  './js/lift.js?v=3.3.20',
  './js/stats.js?v=3.3.20',
  './js/history.js?v=3.3.20',
  './js/settings.js?v=3.3.20',
  './js/app.js?v=3.3.20',
  './icon-192.png',
  './icon-512.png',
