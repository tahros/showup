const CACHE = 'showup-v4.1.10';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.1.10',
  './css/planner.css?v=4.1.10',
  './css/mascot.css?v=4.1.10',
  './js/mascot.js?v=4.1.10',
  ...
  './js/core.js?v=4.1.10',
  './js/derive.js?v=4.1.10',
  './js/util.js?v=4.1.10',
  './js/header.js?v=4.1.10',
  './js/report.js?v=4.1.10',
  './js/today.js?v=4.1.10',
  './js/progression.js?v=4.1.10',
  './js/lift.js?v=4.1.10',
  './js/writer.js?v=4.1.10',
  './js/planner.js?v=4.1.10',
  './js/stats.js?v=4.1.10',
  './js/history.js?v=4.1.10',
  './js/settings.js?v=4.1.10',
  './js/app.js?v=4.1.10',
