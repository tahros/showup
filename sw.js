const CACHE = 'showup-v3.3.182';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.182',
  './js/core.js?v=3.3.182',
  './js/derive.js?v=3.3.182',
  './js/util.js?v=3.3.182',
  './js/header.js?v=3.3.182',
  './js/report.js?v=3.3.182',
  './js/today.js?v=3.3.182',
  './js/lift.js?v=3.3.182',
  './js/stats.js?v=3.3.182',
  './js/history.js?v=3.3.182',
  './js/settings.js?v=3.3.182',
  './js/app.js?v=3.3.182',
  './icon-192.png',
  './icon-512.png',
