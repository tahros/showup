const CACHE = 'showup-v3.3.33';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.33',
  './js/core.js?v=3.3.33',
  './js/derive.js?v=3.3.33',
  './js/util.js?v=3.3.33',
  './js/header.js?v=3.3.33',
  './js/report.js?v=3.3.33',
  './js/today.js?v=3.3.33',
  './js/lift.js?v=3.3.33',
  './js/stats.js?v=3.3.33',
  './js/history.js?v=3.3.33',
  './js/settings.js?v=3.3.33',
  './js/app.js?v=3.3.33',
  './icon-192.png',
  './icon-512.png',
