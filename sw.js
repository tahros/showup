const CACHE = 'showup-v3.3.198';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.198',
  './js/core.js?v=3.3.198',
  './js/derive.js?v=3.3.198',
  './js/util.js?v=3.3.198',
  './js/header.js?v=3.3.198',
  './js/report.js?v=3.3.198',
  './js/today.js?v=3.3.198',
  './js/lift.js?v=3.3.198',
  './js/stats.js?v=3.3.198',
  './js/history.js?v=3.3.198',
  './js/settings.js?v=3.3.198',
  './js/app.js?v=3.3.198',
  './icon-192.png',
  './icon-512.png',
