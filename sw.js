const CACHE = 'showup-v3.3.234';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.234',
  './js/core.js?v=3.3.234',
  './js/derive.js?v=3.3.234',
  './js/util.js?v=3.3.234',
  './js/header.js?v=3.3.234',
  './js/report.js?v=3.3.234',
  './js/today.js?v=3.3.234',
  './js/lift.js?v=3.3.234',
  './js/stats.js?v=3.3.234',
  './js/history.js?v=3.3.234',
  './js/settings.js?v=3.3.234',
  './js/app.js?v=3.3.234',
