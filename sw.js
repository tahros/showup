const CACHE = 'showup-v3.3.155';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.155',
  './js/core.js?v=3.3.155',
  './js/derive.js?v=3.3.155',
  './js/util.js?v=3.3.155',
  './js/header.js?v=3.3.155',
  './js/report.js?v=3.3.155',
  './js/today.js?v=3.3.155',
  './js/lift.js?v=3.3.155',
  './js/stats.js?v=3.3.155',
  './js/history.js?v=3.3.155',
  './js/settings.js?v=3.3.155',
  './js/app.js?v=3.3.155',
  './icon-192.png',
  './icon-512.png',
