const CACHE = 'showup-v3.3.213';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.213',
  './js/core.js?v=3.3.213',
  './js/derive.js?v=3.3.213',
  './js/util.js?v=3.3.213',
  './js/header.js?v=3.3.213',
  './js/report.js?v=3.3.213',
  './js/today.js?v=3.3.213',
  './js/lift.js?v=3.3.213',
  './js/stats.js?v=3.3.213',
  './js/history.js?v=3.3.213',
  './js/settings.js?v=3.3.213',
  './js/app.js?v=3.3.213',
