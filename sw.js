const CACHE = 'showup-v3.3.54';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.54',
  './js/core.js?v=3.3.54',
  './js/derive.js?v=3.3.54',
  './js/util.js?v=3.3.54',
  './js/header.js?v=3.3.54',
  './js/report.js?v=3.3.54',
  './js/today.js?v=3.3.54',
  './js/lift.js?v=3.3.54',
  './js/stats.js?v=3.3.54',
  './js/history.js?v=3.3.54',
  './js/settings.js?v=3.3.54',
  './js/app.js?v=3.3.54',
  './icon-192.png',
  './icon-512.png',
