const CACHE = 'showup-v4.1.12';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.1.12',
  './css/planner.css?v=4.1.12',
  './css/mascot.css?v=4.1.12',
  './js/mascot.js?v=4.1.12',
  ...
  './js/core.js?v=4.1.12',
  './js/derive.js?v=4.1.12',
  './js/util.js?v=4.1.12',
  './js/header.js?v=4.1.12',
  './js/report.js?v=4.1.12',
  './js/today.js?v=4.1.12',
  './js/progression.js?v=4.1.12',
  './js/lift.js?v=4.1.12',
  './js/writer.js?v=4.1.12',
  './js/planner.js?v=4.1.12',
  './js/stats.js?v=4.1.12',
  './js/history.js?v=4.1.12',
  './js/settings.js?v=4.1.12',
  './js/app.js?v=4.1.12',
