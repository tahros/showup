const CACHE = 'showup-v4.5.22';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.5.22',
  './css/planner.css?v=4.5.22',
  './css/mascot.css?v=4.5.22',
  './js/mascot.js?v=4.5.22',
  './js/plates.js?v=4.5.22',
  './js/plate-canvas.js?v=4.5.22',
  './css/plates.css?v=4.5.22',
  ...
  './js/core.js?v=4.5.22',
  './js/derive.js?v=4.5.22',
  './js/util.js?v=4.5.22',
  './js/realset.js?v=4.5.22',
  './js/reprange.js?v=4.5.22',
  './js/verdict.js?v=4.5.22',
  './js/header.js?v=4.5.22',
  './js/report.js?v=4.5.22',
  './js/today.js?v=4.5.22',
  './js/progression.js?v=4.5.22',
  './js/lift.js?v=4.5.22',
  './js/writer.js?v=4.5.22',
  './js/planner.js?v=4.5.22',
  './js/stats.js?v=4.5.22',
  './js/history.js?v=4.5.22',
  './js/settings.js?v=4.5.22',
  './js/stats-story.js?v=4.5.22',
  './js/app.js?v=4.5.22',
