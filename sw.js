const CACHE = 'showup-v3.3.340';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.340',
  './js/core.js?v=3.3.340',
  './js/derive.js?v=3.3.340',
  './js/util.js?v=3.3.340',
  './js/header.js?v=3.3.340',
  './js/report.js?v=3.3.340',
  './js/today.js?v=3.3.340',
  './js/lift.js?v=3.3.340',
  './js/stats.js?v=3.3.340',
  './js/history.js?v=3.3.340',
  './js/settings.js?v=3.3.340',
  './js/app.js?v=3.3.340',
