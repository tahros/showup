const CACHE = 'showup-v4.6.31';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.31',
  './css/planner.css?v=4.6.31',
  './css/mascot.css?v=4.6.31',
  './js/mascot.js?v=4.6.31',
  './js/plates.js?v=4.6.31',
  './js/plate-canvas.js?v=4.6.31',
  './css/plates.css?v=4.6.31',
  ...
  './js/core.js?v=4.6.31',
  './js/derive.js?v=4.6.31',
  './js/util.js?v=4.6.31',
  './js/planlink.js?v=4.6.31',
  './js/realset.js?v=4.6.31',
  './js/reprange.js?v=4.6.31',
  './js/verdict.js?v=4.6.31',
  './js/header.js?v=4.6.31',
  './js/report.js?v=4.6.31',
  './js/today.js?v=4.6.31',
  './js/progression.js?v=4.6.31',
  './js/lift.js?v=4.6.31',
  './js/writer.js?v=4.6.31',
  './js/planner.js?v=4.6.31',
  './js/planner-flow.js?v=4.6.31',
  './css/planner-flow.css?v=4.6.31',
  './js/stats.js?v=4.6.31',
  './js/history.js?v=4.6.31',
  './js/settings.js?v=4.6.31',
  './js/stats-story.js?v=4.6.31',
  './js/app.js?v=4.6.31',
