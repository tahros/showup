const CACHE = 'showup-v3.3.303';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.303',
  './js/core.js?v=3.3.303',
  './js/derive.js?v=3.3.303',
  './js/util.js?v=3.3.303',
  './js/header.js?v=3.3.303',
  './js/report.js?v=3.3.303',
  './js/today.js?v=3.3.303',
  './js/lift.js?v=3.3.303',
  './js/stats.js?v=3.3.303',
  './js/history.js?v=3.3.303',
  './js/settings.js?v=3.3.303',
  './js/app.js?v=3.3.303',
