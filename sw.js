const CACHE = 'showup-v4.6.69';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.69',
  './css/planner.css?v=4.6.69',
  './css/mascot.css?v=4.6.69',
  './js/mascot.js?v=4.6.69',
  './js/plates.js?v=4.6.69',
  './js/plate-canvas.js?v=4.6.69',
  './css/plates.css?v=4.6.69',
  ...
  './js/core.js?v=4.6.69',
  './js/derive.js?v=4.6.69',
  './js/util.js?v=4.6.69',
  './js/planlink.js?v=4.6.69',
  './js/realset.js?v=4.6.69',
  './js/reprange.js?v=4.6.69',
  './js/verdict.js?v=4.6.69',
  './js/header.js?v=4.6.69',
  './js/report.js?v=4.6.69',
  './js/today.js?v=4.6.69',
  './js/progression.js?v=4.6.69',
  './js/lift.js?v=4.6.69',
  './js/writer.js?v=4.6.69',
  './js/planner.js?v=4.6.69',
  './js/planner-flow.js?v=4.6.69',
  './css/planner-flow.css?v=4.6.69',
  './js/stats.js?v=4.6.69',
  './js/history.js?v=4.6.69',
  './js/settings.js?v=4.6.69',
  './js/stats-story.js?v=4.6.69',
  './js/app.js?v=4.6.69',
