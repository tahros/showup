const CACHE = 'showup-v3.3.149';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.149',
  './js/core.js?v=3.3.149',
  './js/derive.js?v=3.3.149',
  './js/util.js?v=3.3.149',
  './js/header.js?v=3.3.149',
  './js/report.js?v=3.3.149',
  './js/today.js?v=3.3.149',
  './js/lift.js?v=3.3.149',
  './js/stats.js?v=3.3.149',
  './js/history.js?v=3.3.149',
  './js/settings.js?v=3.3.149',
  './js/app.js?v=3.3.149',
  './icon-192.png',
  './icon-512.png',
