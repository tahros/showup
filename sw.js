const CACHE = 'showup-v3.3.97';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.97',
  './js/core.js?v=3.3.97',
  './js/derive.js?v=3.3.97',
  './js/util.js?v=3.3.97',
  './js/header.js?v=3.3.97',
  './js/report.js?v=3.3.97',
  './js/today.js?v=3.3.97',
  './js/lift.js?v=3.3.97',
  './js/stats.js?v=3.3.97',
  './js/history.js?v=3.3.97',
  './js/settings.js?v=3.3.97',
  './js/app.js?v=3.3.97',
  './icon-192.png',
  './icon-512.png',
