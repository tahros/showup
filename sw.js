const CACHE = 'showup-v3.3.136';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.136',
  './js/core.js?v=3.3.136',
  './js/derive.js?v=3.3.136',
  './js/util.js?v=3.3.136',
  './js/header.js?v=3.3.136',
  './js/report.js?v=3.3.136',
  './js/today.js?v=3.3.136',
  './js/lift.js?v=3.3.136',
  './js/stats.js?v=3.3.136',
  './js/history.js?v=3.3.136',
  './js/settings.js?v=3.3.136',
  './js/app.js?v=3.3.136',
  './icon-192.png',
  './icon-512.png',
