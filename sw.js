const CACHE = 'showup-v4.6.89';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.89',
  './css/planner.css?v=4.6.89',
  './css/mascot.css?v=4.6.89',
  './js/mascot.js?v=4.6.89',
  './js/plates.js?v=4.6.89',
  './js/plate-canvas.js?v=4.6.89',
  './css/plates.css?v=4.6.89',
  ...
  './js/core.js?v=4.6.89',
  './js/derive.js?v=4.6.89',
  './js/util.js?v=4.6.89',
  './js/planlink.js?v=4.6.89',
  './js/realset.js?v=4.6.89',
  './js/reprange.js?v=4.6.89',
  './js/verdict.js?v=4.6.89',
  './js/header.js?v=4.6.89',
  './js/report.js?v=4.6.89',
  './js/today.js?v=4.6.89',
  './js/progression.js?v=4.6.89',
  './js/lift.js?v=4.6.89',
  './js/writer.js?v=4.6.89',
  './js/planner.js?v=4.6.89',
  './js/planner-flow.js?v=4.6.89',
  './css/planner-flow.css?v=4.6.89',
  './js/stats.js?v=4.6.89',
  './js/history.js?v=4.6.89',
  './js/settings.js?v=4.6.89',
  './js/stats-story.js?v=4.6.89',
  './js/app.js?v=4.6.89',
