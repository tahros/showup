const CACHE = 'showup-v3.3.299';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.299',
  './js/core.js?v=3.3.299',
  './js/derive.js?v=3.3.299',
  './js/util.js?v=3.3.299',
  './js/header.js?v=3.3.299',
  './js/report.js?v=3.3.299',
  './js/today.js?v=3.3.299',
  './js/lift.js?v=3.3.299',
  './js/stats.js?v=3.3.299',
  './js/history.js?v=3.3.299',
  './js/settings.js?v=3.3.299',
  './js/app.js?v=3.3.299',
