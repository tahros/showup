const CACHE = 'showup-v3.3.114';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.114',
  './js/core.js?v=3.3.114',
  './js/derive.js?v=3.3.114',
  './js/util.js?v=3.3.114',
  './js/header.js?v=3.3.114',
  './js/report.js?v=3.3.114',
  './js/today.js?v=3.3.114',
  './js/lift.js?v=3.3.114',
  './js/stats.js?v=3.3.114',
  './js/history.js?v=3.3.114',
  './js/settings.js?v=3.3.114',
  './js/app.js?v=3.3.114',
  './icon-192.png',
  './icon-512.png',
