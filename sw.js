const CACHE = 'showup-v3.3.171';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.171',
  './js/core.js?v=3.3.171',
  './js/derive.js?v=3.3.171',
  './js/util.js?v=3.3.171',
  './js/header.js?v=3.3.171',
  './js/report.js?v=3.3.171',
  './js/today.js?v=3.3.171',
  './js/lift.js?v=3.3.171',
  './js/stats.js?v=3.3.171',
  './js/history.js?v=3.3.171',
  './js/settings.js?v=3.3.171',
  './js/app.js?v=3.3.171',
  './icon-192.png',
  './icon-512.png',
