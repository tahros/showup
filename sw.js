const CACHE = 'showup-v3.3.51';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.51',
  './js/core.js?v=3.3.51',
  './js/derive.js?v=3.3.51',
  './js/util.js?v=3.3.51',
  './js/header.js?v=3.3.51',
  './js/report.js?v=3.3.51',
  './js/today.js?v=3.3.51',
  './js/lift.js?v=3.3.51',
  './js/stats.js?v=3.3.51',
  './js/history.js?v=3.3.51',
  './js/settings.js?v=3.3.51',
  './js/app.js?v=3.3.51',
  './icon-192.png',
  './icon-512.png',
