const CACHE = 'showup-v3.3.177';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.177',
  './js/core.js?v=3.3.177',
  './js/derive.js?v=3.3.177',
  './js/util.js?v=3.3.177',
  './js/header.js?v=3.3.177',
  './js/report.js?v=3.3.177',
  './js/today.js?v=3.3.177',
  './js/lift.js?v=3.3.177',
  './js/stats.js?v=3.3.177',
  './js/history.js?v=3.3.177',
  './js/settings.js?v=3.3.177',
  './js/app.js?v=3.3.177',
  './icon-192.png',
  './icon-512.png',
