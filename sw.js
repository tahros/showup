const CACHE = 'showup-v4.6.26';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.26',
  './css/planner.css?v=4.6.26',
  './css/mascot.css?v=4.6.26',
  './js/mascot.js?v=4.6.26',
  './js/plates.js?v=4.6.26',
  './js/plate-canvas.js?v=4.6.26',
  './css/plates.css?v=4.6.26',
  ...
  './js/core.js?v=4.6.26',
  './js/derive.js?v=4.6.26',
  './js/util.js?v=4.6.26',
  './js/planlink.js?v=4.6.26',
  './js/realset.js?v=4.6.26',
  './js/reprange.js?v=4.6.26',
  './js/verdict.js?v=4.6.26',
  './js/header.js?v=4.6.26',
  './js/report.js?v=4.6.26',
  './js/today.js?v=4.6.26',
  './js/progression.js?v=4.6.26',
  './js/lift.js?v=4.6.26',
  './js/writer.js?v=4.6.26',
  './js/planner.js?v=4.6.26',
  './js/planner-flow.js?v=4.6.26',
  './css/planner-flow.css?v=4.6.26',
  './js/stats.js?v=4.6.26',
  './js/history.js?v=4.6.26',
  './js/settings.js?v=4.6.26',
  './js/stats-story.js?v=4.6.26',
  './js/app.js?v=4.6.26',
