const CACHE = 'showup-v3.3.210';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.210',
  './js/core.js?v=3.3.210',
  './js/derive.js?v=3.3.210',
  './js/util.js?v=3.3.210',
  './js/header.js?v=3.3.210',
  './js/report.js?v=3.3.210',
  './js/today.js?v=3.3.210',
  './js/lift.js?v=3.3.210',
  './js/stats.js?v=3.3.210',
  './js/history.js?v=3.3.210',
  './js/settings.js?v=3.3.210',
  './js/app.js?v=3.3.210',
  './icon-192.png',
  './icon-512.png',
