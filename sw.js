const CACHE = 'showup-v3.3.204';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.204',
  './js/core.js?v=3.3.204',
  './js/derive.js?v=3.3.204',
  './js/util.js?v=3.3.204',
  './js/header.js?v=3.3.204',
  './js/report.js?v=3.3.204',
  './js/today.js?v=3.3.204',
  './js/lift.js?v=3.3.204',
  './js/stats.js?v=3.3.204',
  './js/history.js?v=3.3.204',
  './js/settings.js?v=3.3.204',
  './js/app.js?v=3.3.204',
  './icon-192.png',
  './icon-512.png',
