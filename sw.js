const CACHE = 'showup-v3.3.103';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.103',
  './js/core.js?v=3.3.103',
  './js/derive.js?v=3.3.103',
  './js/util.js?v=3.3.103',
  './js/header.js?v=3.3.103',
  './js/report.js?v=3.3.103',
  './js/today.js?v=3.3.103',
  './js/lift.js?v=3.3.103',
  './js/stats.js?v=3.3.103',
  './js/history.js?v=3.3.103',
  './js/settings.js?v=3.3.103',
  './js/app.js?v=3.3.103',
  './icon-192.png',
  './icon-512.png',
