const CACHE = 'showup-v3.3.50';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.50',
  './js/core.js?v=3.3.50',
  './js/derive.js?v=3.3.50',
  './js/util.js?v=3.3.50',
  './js/header.js?v=3.3.50',
  './js/report.js?v=3.3.50',
  './js/today.js?v=3.3.50',
  './js/lift.js?v=3.3.50',
  './js/stats.js?v=3.3.50',
  './js/history.js?v=3.3.50',
  './js/settings.js?v=3.3.50',
  './js/app.js?v=3.3.50',
  './icon-192.png',
  './icon-512.png',
