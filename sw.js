const CACHE = 'showup-v4.6.97';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.97',
  './css/planner.css?v=4.6.97',
  './css/mascot.css?v=4.6.97',
  './js/retro.js?v=4.6.97',
  './css/retro.css?v=4.6.97',
  './js/mascot.js?v=4.6.97',
  './js/plates.js?v=4.6.97',
  './js/plate-canvas.js?v=4.6.97',
  './css/plates.css?v=4.6.97',
  ...
  './js/core.js?v=4.6.97',
  './js/derive.js?v=4.6.97',
  './js/util.js?v=4.6.97',
  './js/planlink.js?v=4.6.97',
  './js/realset.js?v=4.6.97',
  './js/reprange.js?v=4.6.97',
  './js/verdict.js?v=4.6.97',
  './js/header.js?v=4.6.97',
  './js/report.js?v=4.6.97',
  './js/today.js?v=4.6.97',
  './js/progression.js?v=4.6.97',
  './js/lift.js?v=4.6.97',
  './js/writer.js?v=4.6.97',
  './js/planner.js?v=4.6.97',
  './js/planner-flow.js?v=4.6.97',
  './css/planner-flow.css?v=4.6.97',
  './js/stats.js?v=4.6.97',
  './js/history.js?v=4.6.97',
  './js/settings.js?v=4.6.97',
  './js/stats-story.js?v=4.6.97',
  './js/app.js?v=4.6.97',
