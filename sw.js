const CACHE = 'showup-v3.3.277';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.277',
  './js/core.js?v=3.3.277',
  './js/derive.js?v=3.3.277',
  './js/util.js?v=3.3.277',
  './js/header.js?v=3.3.277',
  './js/report.js?v=3.3.277',
  './js/today.js?v=3.3.277',
  './js/lift.js?v=3.3.277',
  './js/stats.js?v=3.3.277',
  './js/history.js?v=3.3.277',
  './js/settings.js?v=3.3.277',
  './js/app.js?v=3.3.277',
