const CACHE = 'showup-v3.3.341';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.341',
  './js/core.js?v=3.3.341',
  './js/derive.js?v=3.3.341',
  './js/util.js?v=3.3.341',
  './js/header.js?v=3.3.341',
  './js/report.js?v=3.3.341',
  './js/today.js?v=3.3.341',
  './js/lift.js?v=3.3.341',
  './js/stats.js?v=3.3.341',
  './js/history.js?v=3.3.341',
  './js/settings.js?v=3.3.341',
  './js/app.js?v=3.3.341',
