const CACHE = 'showup-v3.3.142';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.142',
  './js/core.js?v=3.3.142',
  './js/derive.js?v=3.3.142',
  './js/util.js?v=3.3.142',
  './js/header.js?v=3.3.142',
  './js/report.js?v=3.3.142',
  './js/today.js?v=3.3.142',
  './js/lift.js?v=3.3.142',
  './js/stats.js?v=3.3.142',
  './js/history.js?v=3.3.142',
  './js/settings.js?v=3.3.142',
  './js/app.js?v=3.3.142',
  './icon-192.png',
  './icon-512.png',
