const CACHE = 'showup-v4.6.23';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.23',
  './css/planner.css?v=4.6.23',
  './css/mascot.css?v=4.6.23',
  './js/mascot.js?v=4.6.23',
  './js/plates.js?v=4.6.23',
  './js/plate-canvas.js?v=4.6.23',
  './css/plates.css?v=4.6.23',
  ...
  './js/core.js?v=4.6.23',
  './js/derive.js?v=4.6.23',
  './js/util.js?v=4.6.23',
  './js/planlink.js?v=4.6.23',
  './js/realset.js?v=4.6.23',
  './js/reprange.js?v=4.6.23',
  './js/verdict.js?v=4.6.23',
  './js/header.js?v=4.6.23',
  './js/report.js?v=4.6.23',
  './js/today.js?v=4.6.23',
  './js/progression.js?v=4.6.23',
  './js/lift.js?v=4.6.23',
  './js/writer.js?v=4.6.23',
  './js/planner.js?v=4.6.23',
  './js/planner-flow.js?v=4.6.23',
  './css/planner-flow.css?v=4.6.23',
  './js/stats.js?v=4.6.23',
  './js/history.js?v=4.6.23',
  './js/settings.js?v=4.6.23',
  './js/stats-story.js?v=4.6.23',
  './js/app.js?v=4.6.23',
