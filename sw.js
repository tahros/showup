const CACHE = 'showup-v3.3.360';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.360',
  './js/core.js?v=3.3.360',
  './js/derive.js?v=3.3.360',
  './js/util.js?v=3.3.360',
  './js/header.js?v=3.3.360',
  './js/report.js?v=3.3.360',
  './js/today.js?v=3.3.360',
  './js/lift.js?v=3.3.360',
  './js/stats.js?v=3.3.360',
  './js/history.js?v=3.3.360',
  './js/settings.js?v=3.3.360',
  './js/app.js?v=3.3.360',
