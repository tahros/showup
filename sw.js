const CACHE = 'showup-v4.6.83';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.83',
  './css/planner.css?v=4.6.83',
  './css/mascot.css?v=4.6.83',
  './js/mascot.js?v=4.6.83',
  './js/plates.js?v=4.6.83',
  './js/plate-canvas.js?v=4.6.83',
  './css/plates.css?v=4.6.83',
  ...
  './js/core.js?v=4.6.83',
  './js/derive.js?v=4.6.83',
  './js/util.js?v=4.6.83',
  './js/planlink.js?v=4.6.83',
  './js/realset.js?v=4.6.83',
  './js/reprange.js?v=4.6.83',
  './js/verdict.js?v=4.6.83',
  './js/header.js?v=4.6.83',
  './js/report.js?v=4.6.83',
  './js/today.js?v=4.6.83',
  './js/progression.js?v=4.6.83',
  './js/lift.js?v=4.6.83',
  './js/writer.js?v=4.6.83',
  './js/planner.js?v=4.6.83',
  './js/planner-flow.js?v=4.6.83',
  './css/planner-flow.css?v=4.6.83',
  './js/stats.js?v=4.6.83',
  './js/history.js?v=4.6.83',
  './js/settings.js?v=4.6.83',
  './js/stats-story.js?v=4.6.83',
  './js/app.js?v=4.6.83',
