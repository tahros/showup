const CACHE = 'showup-v3.3.124';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.124',
  './js/core.js?v=3.3.124',
  './js/derive.js?v=3.3.124',
  './js/util.js?v=3.3.124',
  './js/header.js?v=3.3.124',
  './js/report.js?v=3.3.124',
  './js/today.js?v=3.3.124',
  './js/lift.js?v=3.3.124',
  './js/stats.js?v=3.3.124',
  './js/history.js?v=3.3.124',
  './js/settings.js?v=3.3.124',
  './js/app.js?v=3.3.124',
  './icon-192.png',
  './icon-512.png',
