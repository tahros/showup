const CACHE = 'showup-v3.3.302';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.302',
  './js/core.js?v=3.3.302',
  './js/derive.js?v=3.3.302',
  './js/util.js?v=3.3.302',
  './js/header.js?v=3.3.302',
  './js/report.js?v=3.3.302',
  './js/today.js?v=3.3.302',
  './js/lift.js?v=3.3.302',
  './js/stats.js?v=3.3.302',
  './js/history.js?v=3.3.302',
  './js/settings.js?v=3.3.302',
  './js/app.js?v=3.3.302',
