const CACHE = 'showup-v4.6.75';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.75',
  './css/planner.css?v=4.6.75',
  './css/mascot.css?v=4.6.75',
  './js/mascot.js?v=4.6.75',
  './js/plates.js?v=4.6.75',
  './js/plate-canvas.js?v=4.6.75',
  './css/plates.css?v=4.6.75',
  ...
  './js/core.js?v=4.6.75',
  './js/derive.js?v=4.6.75',
  './js/util.js?v=4.6.75',
  './js/planlink.js?v=4.6.75',
  './js/realset.js?v=4.6.75',
  './js/reprange.js?v=4.6.75',
  './js/verdict.js?v=4.6.75',
  './js/header.js?v=4.6.75',
  './js/report.js?v=4.6.75',
  './js/today.js?v=4.6.75',
  './js/progression.js?v=4.6.75',
  './js/lift.js?v=4.6.75',
  './js/writer.js?v=4.6.75',
  './js/planner.js?v=4.6.75',
  './js/planner-flow.js?v=4.6.75',
  './css/planner-flow.css?v=4.6.75',
  './js/stats.js?v=4.6.75',
  './js/history.js?v=4.6.75',
  './js/settings.js?v=4.6.75',
  './js/stats-story.js?v=4.6.75',
  './js/app.js?v=4.6.75',
