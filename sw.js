const CACHE = 'showup-v4.6.41';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.41',
  './css/planner.css?v=4.6.41',
  './css/mascot.css?v=4.6.41',
  './js/mascot.js?v=4.6.41',
  './js/plates.js?v=4.6.41',
  './js/plate-canvas.js?v=4.6.41',
  './css/plates.css?v=4.6.41',
  ...
  './js/core.js?v=4.6.41',
  './js/derive.js?v=4.6.41',
  './js/util.js?v=4.6.41',
  './js/planlink.js?v=4.6.41',
  './js/realset.js?v=4.6.41',
  './js/reprange.js?v=4.6.41',
  './js/verdict.js?v=4.6.41',
  './js/header.js?v=4.6.41',
  './js/report.js?v=4.6.41',
  './js/today.js?v=4.6.41',
  './js/progression.js?v=4.6.41',
  './js/lift.js?v=4.6.41',
  './js/writer.js?v=4.6.41',
  './js/planner.js?v=4.6.41',
  './js/planner-flow.js?v=4.6.41',
  './css/planner-flow.css?v=4.6.41',
  './js/stats.js?v=4.6.41',
  './js/history.js?v=4.6.41',
  './js/settings.js?v=4.6.41',
  './js/stats-story.js?v=4.6.41',
  './js/app.js?v=4.6.41',
