const CACHE = 'showup-v3.3.209';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.209',
  './js/core.js?v=3.3.209',
  './js/derive.js?v=3.3.209',
  './js/util.js?v=3.3.209',
  './js/header.js?v=3.3.209',
  './js/report.js?v=3.3.209',
  './js/today.js?v=3.3.209',
  './js/lift.js?v=3.3.209',
  './js/stats.js?v=3.3.209',
  './js/history.js?v=3.3.209',
  './js/settings.js?v=3.3.209',
  './js/app.js?v=3.3.209',
  './icon-192.png',
  './icon-512.png',
