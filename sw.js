const CACHE = 'showup-v4.6.29';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.29',
  './css/planner.css?v=4.6.29',
  './css/mascot.css?v=4.6.29',
  './js/mascot.js?v=4.6.29',
  './js/plates.js?v=4.6.29',
  './js/plate-canvas.js?v=4.6.29',
  './css/plates.css?v=4.6.29',
  ...
  './js/core.js?v=4.6.29',
  './js/derive.js?v=4.6.29',
  './js/util.js?v=4.6.29',
  './js/planlink.js?v=4.6.29',
  './js/realset.js?v=4.6.29',
  './js/reprange.js?v=4.6.29',
  './js/verdict.js?v=4.6.29',
  './js/header.js?v=4.6.29',
  './js/report.js?v=4.6.29',
  './js/today.js?v=4.6.29',
  './js/progression.js?v=4.6.29',
  './js/lift.js?v=4.6.29',
  './js/writer.js?v=4.6.29',
  './js/planner.js?v=4.6.29',
  './js/planner-flow.js?v=4.6.29',
  './css/planner-flow.css?v=4.6.29',
  './js/stats.js?v=4.6.29',
  './js/history.js?v=4.6.29',
  './js/settings.js?v=4.6.29',
  './js/stats-story.js?v=4.6.29',
  './js/app.js?v=4.6.29',
