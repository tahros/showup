const CACHE = 'showup-v3.3.263';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.263',
  './js/core.js?v=3.3.263',
  './js/derive.js?v=3.3.263',
  './js/util.js?v=3.3.263',
  './js/header.js?v=3.3.263',
  './js/report.js?v=3.3.263',
  './js/today.js?v=3.3.263',
  './js/lift.js?v=3.3.263',
  './js/stats.js?v=3.3.263',
  './js/history.js?v=3.3.263',
  './js/settings.js?v=3.3.263',
  './js/app.js?v=3.3.263',
