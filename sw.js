const CACHE = 'showup-v3.3.447';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.447',
  './js/core.js?v=3.3.447',
  './js/derive.js?v=3.3.447',
  './js/util.js?v=3.3.447',
  './js/header.js?v=3.3.447',
  './js/report.js?v=3.3.447',
  './js/today.js?v=3.3.447',
  './js/lift.js?v=3.3.447',
  './js/writer.js?v=3.3.447',
  './js/stats.js?v=3.3.447',
  './js/history.js?v=3.3.447',
  './js/settings.js?v=3.3.447',
  './js/app.js?v=3.3.447',
