const CACHE = 'showup-v3.3.230';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.230',
  './js/core.js?v=3.3.230',
  './js/derive.js?v=3.3.230',
  './js/util.js?v=3.3.230',
  './js/header.js?v=3.3.230',
  './js/report.js?v=3.3.230',
  './js/today.js?v=3.3.230',
  './js/lift.js?v=3.3.230',
  './js/stats.js?v=3.3.230',
  './js/history.js?v=3.3.230',
  './js/settings.js?v=3.3.230',
  './js/app.js?v=3.3.230',
