const CACHE = 'showup-v3.3.108';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.108',
  './js/core.js?v=3.3.108',
  './js/derive.js?v=3.3.108',
  './js/util.js?v=3.3.108',
  './js/header.js?v=3.3.108',
  './js/report.js?v=3.3.108',
  './js/today.js?v=3.3.108',
  './js/lift.js?v=3.3.108',
  './js/stats.js?v=3.3.108',
  './js/history.js?v=3.3.108',
  './js/settings.js?v=3.3.108',
  './js/app.js?v=3.3.108',
  './icon-192.png',
  './icon-512.png',
