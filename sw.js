const CACHE = 'showup-v3.3.239';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.239',
  './js/core.js?v=3.3.239',
  './js/derive.js?v=3.3.239',
  './js/util.js?v=3.3.239',
  './js/header.js?v=3.3.239',
  './js/report.js?v=3.3.239',
  './js/today.js?v=3.3.239',
  './js/lift.js?v=3.3.239',
  './js/stats.js?v=3.3.239',
  './js/history.js?v=3.3.239',
  './js/settings.js?v=3.3.239',
  './js/app.js?v=3.3.239',
