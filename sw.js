const CACHE = 'showup-v3.3.537';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.537',
  './js/core.js?v=3.3.537',
  './js/derive.js?v=3.3.537',
  './js/util.js?v=3.3.537',
  './js/header.js?v=3.3.537',
  './js/report.js?v=3.3.537',
  './js/today.js?v=3.3.537',
  './js/progression.js?v=3.3.537',
  './js/lift.js?v=3.3.537',
  './js/writer.js?v=3.3.537',
  './js/stats.js?v=3.3.537',
  './js/history.js?v=3.3.537',
  './js/settings.js?v=3.3.537',
  './js/app.js?v=3.3.537',
