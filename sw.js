const CACHE = 'showup-v3.3.65';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.65',
  './js/core.js?v=3.3.65',
  './js/derive.js?v=3.3.65',
  './js/util.js?v=3.3.65',
  './js/header.js?v=3.3.65',
  './js/report.js?v=3.3.65',
  './js/today.js?v=3.3.65',
  './js/lift.js?v=3.3.65',
  './js/stats.js?v=3.3.65',
  './js/history.js?v=3.3.65',
  './js/settings.js?v=3.3.65',
  './js/app.js?v=3.3.65',
  './icon-192.png',
  './icon-512.png',
