const CACHE = 'showup-v4.6.80';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.80',
  './css/planner.css?v=4.6.80',
  './css/mascot.css?v=4.6.80',
  './js/mascot.js?v=4.6.80',
  './js/plates.js?v=4.6.80',
  './js/plate-canvas.js?v=4.6.80',
  './css/plates.css?v=4.6.80',
  ...
  './js/core.js?v=4.6.80',
  './js/derive.js?v=4.6.80',
  './js/util.js?v=4.6.80',
  './js/planlink.js?v=4.6.80',
  './js/realset.js?v=4.6.80',
  './js/reprange.js?v=4.6.80',
  './js/verdict.js?v=4.6.80',
  './js/header.js?v=4.6.80',
  './js/report.js?v=4.6.80',
  './js/today.js?v=4.6.80',
  './js/progression.js?v=4.6.80',
  './js/lift.js?v=4.6.80',
  './js/writer.js?v=4.6.80',
  './js/planner.js?v=4.6.80',
  './js/planner-flow.js?v=4.6.80',
  './css/planner-flow.css?v=4.6.80',
  './js/stats.js?v=4.6.80',
  './js/history.js?v=4.6.80',
  './js/settings.js?v=4.6.80',
  './js/stats-story.js?v=4.6.80',
  './js/app.js?v=4.6.80',
