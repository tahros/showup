const CACHE = 'showup-v3.3.240';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.240',
  './js/core.js?v=3.3.240',
  './js/derive.js?v=3.3.240',
  './js/util.js?v=3.3.240',
  './js/header.js?v=3.3.240',
  './js/report.js?v=3.3.240',
  './js/today.js?v=3.3.240',
  './js/lift.js?v=3.3.240',
  './js/stats.js?v=3.3.240',
  './js/history.js?v=3.3.240',
  './js/settings.js?v=3.3.240',
  './js/app.js?v=3.3.240',
