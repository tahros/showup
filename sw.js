const CACHE = 'showup-v3.3.336';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.336',
  './js/core.js?v=3.3.336',
  './js/derive.js?v=3.3.336',
  './js/util.js?v=3.3.336',
  './js/header.js?v=3.3.336',
  './js/report.js?v=3.3.336',
  './js/today.js?v=3.3.336',
  './js/lift.js?v=3.3.336',
  './js/stats.js?v=3.3.336',
  './js/history.js?v=3.3.336',
  './js/settings.js?v=3.3.336',
  './js/app.js?v=3.3.336',
