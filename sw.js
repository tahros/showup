const CACHE = 'showup-v3.3.67';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.67',
  './js/core.js?v=3.3.67',
  './js/derive.js?v=3.3.67',
  './js/util.js?v=3.3.67',
  './js/header.js?v=3.3.67',
  './js/report.js?v=3.3.67',
  './js/today.js?v=3.3.67',
  './js/lift.js?v=3.3.67',
  './js/stats.js?v=3.3.67',
  './js/history.js?v=3.3.67',
  './js/settings.js?v=3.3.67',
  './js/app.js?v=3.3.67',
  './icon-192.png',
  './icon-512.png',
