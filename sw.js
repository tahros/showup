const CACHE = 'showup-v3.3.79';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.79',
  './js/core.js?v=3.3.79',
  './js/derive.js?v=3.3.79',
  './js/util.js?v=3.3.79',
  './js/header.js?v=3.3.79',
  './js/report.js?v=3.3.79',
  './js/today.js?v=3.3.79',
  './js/lift.js?v=3.3.79',
  './js/stats.js?v=3.3.79',
  './js/history.js?v=3.3.79',
  './js/settings.js?v=3.3.79',
  './js/app.js?v=3.3.79',
  './icon-192.png',
  './icon-512.png',
