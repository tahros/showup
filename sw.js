const CACHE = 'showup-v3.3.300';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.300',
  './js/core.js?v=3.3.300',
  './js/derive.js?v=3.3.300',
  './js/util.js?v=3.3.300',
  './js/header.js?v=3.3.300',
  './js/report.js?v=3.3.300',
  './js/today.js?v=3.3.300',
  './js/lift.js?v=3.3.300',
  './js/stats.js?v=3.3.300',
  './js/history.js?v=3.3.300',
  './js/settings.js?v=3.3.300',
  './js/app.js?v=3.3.300',
