const CACHE = 'showup-v3.3.94';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.94',
  './js/core.js?v=3.3.94',
  './js/derive.js?v=3.3.94',
  './js/util.js?v=3.3.94',
  './js/header.js?v=3.3.94',
  './js/report.js?v=3.3.94',
  './js/today.js?v=3.3.94',
  './js/lift.js?v=3.3.94',
  './js/stats.js?v=3.3.94',
  './js/history.js?v=3.3.94',
  './js/settings.js?v=3.3.94',
  './js/app.js?v=3.3.94',
  './icon-192.png',
  './icon-512.png',
