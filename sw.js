const CACHE = 'showup-v3.3.12';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.12',
  './js/core.js?v=3.3.12',
  './js/derive.js?v=3.3.12',
  './js/util.js?v=3.3.12',
  './js/header.js?v=3.3.12',
  './js/report.js?v=3.3.12',
  './js/today.js?v=3.3.12',
  './js/lift.js?v=3.3.12',
  './js/stats.js?v=3.3.12',
  './js/history.js?v=3.3.12',
  './js/settings.js?v=3.3.12',
  './js/app.js?v=3.3.12',
  './icon-192.png',
  './icon-512.png',
