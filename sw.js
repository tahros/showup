const CACHE = 'showup-v3.3.126';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.126',
  './js/core.js?v=3.3.126',
  './js/derive.js?v=3.3.126',
  './js/util.js?v=3.3.126',
  './js/header.js?v=3.3.126',
  './js/report.js?v=3.3.126',
  './js/today.js?v=3.3.126',
  './js/lift.js?v=3.3.126',
  './js/stats.js?v=3.3.126',
  './js/history.js?v=3.3.126',
  './js/settings.js?v=3.3.126',
  './js/app.js?v=3.3.126',
  './icon-192.png',
  './icon-512.png',
