const CACHE = 'showup-v4.6.86';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.86',
  './css/planner.css?v=4.6.86',
  './css/mascot.css?v=4.6.86',
  './js/mascot.js?v=4.6.86',
  './js/plates.js?v=4.6.86',
  './js/plate-canvas.js?v=4.6.86',
  './css/plates.css?v=4.6.86',
  ...
  './js/core.js?v=4.6.86',
  './js/derive.js?v=4.6.86',
  './js/util.js?v=4.6.86',
  './js/planlink.js?v=4.6.86',
  './js/realset.js?v=4.6.86',
  './js/reprange.js?v=4.6.86',
  './js/verdict.js?v=4.6.86',
  './js/header.js?v=4.6.86',
  './js/report.js?v=4.6.86',
  './js/today.js?v=4.6.86',
  './js/progression.js?v=4.6.86',
  './js/lift.js?v=4.6.86',
  './js/writer.js?v=4.6.86',
  './js/planner.js?v=4.6.86',
  './js/planner-flow.js?v=4.6.86',
  './css/planner-flow.css?v=4.6.86',
  './js/stats.js?v=4.6.86',
  './js/history.js?v=4.6.86',
  './js/settings.js?v=4.6.86',
  './js/stats-story.js?v=4.6.86',
  './js/app.js?v=4.6.86',
