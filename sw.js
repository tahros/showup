const CACHE = 'showup-v3.3.348';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.348',
  './js/core.js?v=3.3.348',
  './js/derive.js?v=3.3.348',
  './js/util.js?v=3.3.348',
  './js/header.js?v=3.3.348',
  './js/report.js?v=3.3.348',
  './js/today.js?v=3.3.348',
  './js/lift.js?v=3.3.348',
  './js/stats.js?v=3.3.348',
  './js/history.js?v=3.3.348',
  './js/settings.js?v=3.3.348',
  './js/app.js?v=3.3.348',
