const CACHE = 'showup-v3.3.152';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.152',
  './js/core.js?v=3.3.152',
  './js/derive.js?v=3.3.152',
  './js/util.js?v=3.3.152',
  './js/header.js?v=3.3.152',
  './js/report.js?v=3.3.152',
  './js/today.js?v=3.3.152',
  './js/lift.js?v=3.3.152',
  './js/stats.js?v=3.3.152',
  './js/history.js?v=3.3.152',
  './js/settings.js?v=3.3.152',
  './js/app.js?v=3.3.152',
  './icon-192.png',
  './icon-512.png',
