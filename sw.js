const CACHE = 'showup-v3.3.66';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.66',
  './js/core.js?v=3.3.66',
  './js/derive.js?v=3.3.66',
  './js/util.js?v=3.3.66',
  './js/header.js?v=3.3.66',
  './js/report.js?v=3.3.66',
  './js/today.js?v=3.3.66',
  './js/lift.js?v=3.3.66',
  './js/stats.js?v=3.3.66',
  './js/history.js?v=3.3.66',
  './js/settings.js?v=3.3.66',
  './js/app.js?v=3.3.66',
  './icon-192.png',
  './icon-512.png',
