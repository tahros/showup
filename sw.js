const CACHE = 'showup-v3.3.316';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.316',
  './js/core.js?v=3.3.316',
  './js/derive.js?v=3.3.316',
  './js/util.js?v=3.3.316',
  './js/header.js?v=3.3.316',
  './js/report.js?v=3.3.316',
  './js/today.js?v=3.3.316',
  './js/lift.js?v=3.3.316',
  './js/stats.js?v=3.3.316',
  './js/history.js?v=3.3.316',
  './js/settings.js?v=3.3.316',
  './js/app.js?v=3.3.316',
