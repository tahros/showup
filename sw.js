const CACHE = 'showup-v3.3.125';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.125',
  './js/core.js?v=3.3.125',
  './js/derive.js?v=3.3.125',
  './js/util.js?v=3.3.125',
  './js/header.js?v=3.3.125',
  './js/report.js?v=3.3.125',
  './js/today.js?v=3.3.125',
  './js/lift.js?v=3.3.125',
  './js/stats.js?v=3.3.125',
  './js/history.js?v=3.3.125',
  './js/settings.js?v=3.3.125',
  './js/app.js?v=3.3.125',
  './icon-192.png',
  './icon-512.png',
