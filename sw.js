const CACHE = 'showup-v3.3.110';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.110',
  './js/core.js?v=3.3.110',
  './js/derive.js?v=3.3.110',
  './js/util.js?v=3.3.110',
  './js/header.js?v=3.3.110',
  './js/report.js?v=3.3.110',
  './js/today.js?v=3.3.110',
  './js/lift.js?v=3.3.110',
  './js/stats.js?v=3.3.110',
  './js/history.js?v=3.3.110',
  './js/settings.js?v=3.3.110',
  './js/app.js?v=3.3.110',
  './icon-192.png',
  './icon-512.png',
