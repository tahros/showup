const CACHE = 'showup-v3.3.353';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.353',
  './js/core.js?v=3.3.353',
  './js/derive.js?v=3.3.353',
  './js/util.js?v=3.3.353',
  './js/header.js?v=3.3.353',
  './js/report.js?v=3.3.353',
  './js/today.js?v=3.3.353',
  './js/lift.js?v=3.3.353',
  './js/stats.js?v=3.3.353',
  './js/history.js?v=3.3.353',
  './js/settings.js?v=3.3.353',
  './js/app.js?v=3.3.353',
