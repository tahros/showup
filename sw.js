const CACHE = 'showup-v4.6.36';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.36',
  './css/planner.css?v=4.6.36',
  './css/mascot.css?v=4.6.36',
  './js/mascot.js?v=4.6.36',
  './js/plates.js?v=4.6.36',
  './js/plate-canvas.js?v=4.6.36',
  './css/plates.css?v=4.6.36',
  ...
  './js/core.js?v=4.6.36',
  './js/derive.js?v=4.6.36',
  './js/util.js?v=4.6.36',
  './js/planlink.js?v=4.6.36',
  './js/realset.js?v=4.6.36',
  './js/reprange.js?v=4.6.36',
  './js/verdict.js?v=4.6.36',
  './js/header.js?v=4.6.36',
  './js/report.js?v=4.6.36',
  './js/today.js?v=4.6.36',
  './js/progression.js?v=4.6.36',
  './js/lift.js?v=4.6.36',
  './js/writer.js?v=4.6.36',
  './js/planner.js?v=4.6.36',
  './js/planner-flow.js?v=4.6.36',
  './css/planner-flow.css?v=4.6.36',
  './js/stats.js?v=4.6.36',
  './js/history.js?v=4.6.36',
  './js/settings.js?v=4.6.36',
  './js/stats-story.js?v=4.6.36',
  './js/app.js?v=4.6.36',
