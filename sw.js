const CACHE = 'showup-v3.3.201';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.201',
  './js/core.js?v=3.3.201',
  './js/derive.js?v=3.3.201',
  './js/util.js?v=3.3.201',
  './js/header.js?v=3.3.201',
  './js/report.js?v=3.3.201',
  './js/today.js?v=3.3.201',
  './js/lift.js?v=3.3.201',
  './js/stats.js?v=3.3.201',
  './js/history.js?v=3.3.201',
  './js/settings.js?v=3.3.201',
  './js/app.js?v=3.3.201',
  './icon-192.png',
  './icon-512.png',
