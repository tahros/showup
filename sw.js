...
const SHELL = [
  ...
  './js/core.js?v=3.3.96',
  './js/derive.js?v=3.3.96',
  './js/util.js?v=3.3.96',
  './js/header.js?v=3.3.96',
  './js/report.js?v=3.3.96',
  './js/today.js?v=3.3.96',
  './js/lift.js?v=3.3.96',
  './js/stats.js?v=3.3.96',
  './js/history.js?v=3.3.96',
  './js/settings.js?v=3.3.96',
  './js/app.js?v=3.3.96',
  './icon-192.png',
  './icon-512.png',
