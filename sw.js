const CACHE = 'showup-v3.3.317';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.317',
  './js/core.js?v=3.3.317',
  './js/derive.js?v=3.3.317',
  './js/util.js?v=3.3.317',
  './js/header.js?v=3.3.317',
  './js/report.js?v=3.3.317',
  './js/today.js?v=3.3.317',
  './js/lift.js?v=3.3.317',
  './js/stats.js?v=3.3.317',
  './js/history.js?v=3.3.317',
  './js/settings.js?v=3.3.317',
  './js/app.js?v=3.3.317',
