const CACHE = 'showup-v3.3.393';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.393',
  './js/core.js?v=3.3.393',
  './js/derive.js?v=3.3.393',
  './js/util.js?v=3.3.393',
  './js/header.js?v=3.3.393',
  './js/report.js?v=3.3.393',
  './js/today.js?v=3.3.393',
  './js/lift.js?v=3.3.393',
  './js/stats.js?v=3.3.393',
  './js/history.js?v=3.3.393',
  './js/settings.js?v=3.3.393',
  './js/app.js?v=3.3.393',
