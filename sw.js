const CACHE = 'showup-v3.3.91';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.91',
  './js/core.js?v=3.3.91',
  './js/derive.js?v=3.3.91',
  './js/util.js?v=3.3.91',
  './js/header.js?v=3.3.91',
  './js/report.js?v=3.3.91',
  './js/today.js?v=3.3.91',
  './js/lift.js?v=3.3.91',
  './js/stats.js?v=3.3.91',
  './js/history.js?v=3.3.91',
  './js/settings.js?v=3.3.91',
  './js/app.js?v=3.3.91',
  './icon-192.png',
  './icon-512.png',
