const CACHE = 'showup-v3.3.164';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.164',
  './js/core.js?v=3.3.164',
  './js/derive.js?v=3.3.164',
  './js/util.js?v=3.3.164',
  './js/header.js?v=3.3.164',
  './js/report.js?v=3.3.164',
  './js/today.js?v=3.3.164',
  './js/lift.js?v=3.3.164',
  './js/stats.js?v=3.3.164',
  './js/history.js?v=3.3.164',
  './js/settings.js?v=3.3.164',
  './js/app.js?v=3.3.164',
  './icon-192.png',
  './icon-512.png',
