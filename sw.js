const CACHE = 'showup-v3.3.465';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.465',
  './js/core.js?v=3.3.465',
  './js/derive.js?v=3.3.465',
  './js/util.js?v=3.3.465',
  './js/header.js?v=3.3.465',
  './js/report.js?v=3.3.465',
  './js/today.js?v=3.3.465',
  './js/lift.js?v=3.3.465',
  './js/writer.js?v=3.3.465',
  './js/stats.js?v=3.3.465',
  './js/history.js?v=3.3.465',
  './js/settings.js?v=3.3.465',
  './js/app.js?v=3.3.465',
