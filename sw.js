const CACHE = 'showup-v3.3.52';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.52',
  './js/core.js?v=3.3.52',
  './js/derive.js?v=3.3.52',
  './js/util.js?v=3.3.52',
  './js/header.js?v=3.3.52',
  './js/report.js?v=3.3.52',
  './js/today.js?v=3.3.52',
  './js/lift.js?v=3.3.52',
  './js/stats.js?v=3.3.52',
  './js/history.js?v=3.3.52',
  './js/settings.js?v=3.3.52',
  './js/app.js?v=3.3.52',
  './icon-192.png',
  './icon-512.png',
