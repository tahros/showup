const CACHE = 'showup-v3.3.63';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.63',
  './js/core.js?v=3.3.63',
  './js/derive.js?v=3.3.63',
  './js/util.js?v=3.3.63',
  './js/header.js?v=3.3.63',
  './js/report.js?v=3.3.63',
  './js/today.js?v=3.3.63',
  './js/lift.js?v=3.3.63',
  './js/stats.js?v=3.3.63',
  './js/history.js?v=3.3.63',
  './js/settings.js?v=3.3.63',
  './js/app.js?v=3.3.63',
  './icon-192.png',
  './icon-512.png',
