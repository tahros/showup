const CACHE = 'showup-v4.2.2';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.2.2',
  './css/planner.css?v=4.2.2',
  './css/mascot.css?v=4.2.2',
  './js/mascot.js?v=4.2.2',
  './js/plates.js?v=4.2.2',
  './css/plates.css?v=4.2.2',
  ...
  './js/core.js?v=4.2.2',
  './js/derive.js?v=4.2.2',
  './js/util.js?v=4.2.2',
  './js/header.js?v=4.2.2',
  './js/report.js?v=4.2.2',
  './js/today.js?v=4.2.2',
  './js/progression.js?v=4.2.2',
  './js/lift.js?v=4.2.2',
  './js/writer.js?v=4.2.2',
  './js/planner.js?v=4.2.2',
  './js/stats.js?v=4.2.2',
  './js/history.js?v=4.2.2',
  './js/settings.js?v=4.2.2',
  './js/app.js?v=4.2.2',
