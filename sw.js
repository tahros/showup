const CACHE = 'showup-v3.3.215';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.215',
  './js/core.js?v=3.3.215',
  './js/derive.js?v=3.3.215',
  './js/util.js?v=3.3.215',
  './js/header.js?v=3.3.215',
  './js/report.js?v=3.3.215',
  './js/today.js?v=3.3.215',
  './js/lift.js?v=3.3.215',
  './js/stats.js?v=3.3.215',
  './js/history.js?v=3.3.215',
  './js/settings.js?v=3.3.215',
  './js/app.js?v=3.3.215',
