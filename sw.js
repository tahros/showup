const CACHE = 'showup-v3.3.99';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.99',
  './js/core.js?v=3.3.99',
  './js/derive.js?v=3.3.99',
  './js/util.js?v=3.3.99',
  './js/header.js?v=3.3.99',
  './js/report.js?v=3.3.99',
  './js/today.js?v=3.3.99',
  './js/lift.js?v=3.3.99',
  './js/stats.js?v=3.3.99',
  './js/history.js?v=3.3.99',
  './js/settings.js?v=3.3.99',
  './js/app.js?v=3.3.99',
  './icon-192.png',
  './icon-512.png',
