const CACHE = 'showup-v3.3.121';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.121',
  './js/core.js?v=3.3.121',
  './js/derive.js?v=3.3.121',
  './js/util.js?v=3.3.121',
  './js/header.js?v=3.3.121',
  './js/report.js?v=3.3.121',
  './js/today.js?v=3.3.121',
  './js/lift.js?v=3.3.121',
  './js/stats.js?v=3.3.121',
  './js/history.js?v=3.3.121',
  './js/settings.js?v=3.3.121',
  './js/app.js?v=3.3.121',
  './icon-192.png',
  './icon-512.png',
