const CACHE = 'showup-v3.3.312';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.312',
  './js/core.js?v=3.3.312',
  './js/derive.js?v=3.3.312',
  './js/util.js?v=3.3.312',
  './js/header.js?v=3.3.312',
  './js/report.js?v=3.3.312',
  './js/today.js?v=3.3.312',
  './js/lift.js?v=3.3.312',
  './js/stats.js?v=3.3.312',
  './js/history.js?v=3.3.312',
  './js/settings.js?v=3.3.312',
  './js/app.js?v=3.3.312',
