const CACHE = 'showup-v4.6.18';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.18',
  './css/planner.css?v=4.6.18',
  './css/mascot.css?v=4.6.18',
  './js/mascot.js?v=4.6.18',
  './js/plates.js?v=4.6.18',
  './js/plate-canvas.js?v=4.6.18',
  './css/plates.css?v=4.6.18',
  ...
  './js/core.js?v=4.6.18',
  './js/derive.js?v=4.6.18',
  './js/util.js?v=4.6.18',
  './js/planlink.js?v=4.6.18',
  './js/realset.js?v=4.6.18',
  './js/reprange.js?v=4.6.18',
  './js/verdict.js?v=4.6.18',
  './js/header.js?v=4.6.18',
  './js/report.js?v=4.6.18',
  './js/today.js?v=4.6.18',
  './js/progression.js?v=4.6.18',
  './js/lift.js?v=4.6.18',
  './js/writer.js?v=4.6.18',
  './js/planner.js?v=4.6.18',
  './js/planner-flow.js?v=4.6.18',
  './css/planner-flow.css?v=4.6.18',
  './js/stats.js?v=4.6.18',
  './js/history.js?v=4.6.18',
  './js/settings.js?v=4.6.18',
  './js/stats-story.js?v=4.6.18',
  './js/app.js?v=4.6.18',
