const CACHE = 'showup-v4.6.101';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.101',
  './css/planner.css?v=4.6.101',
  './css/mascot.css?v=4.6.101',
  './js/retro.js?v=4.6.101',
  './css/retro.css?v=4.6.101',
  './js/mascot.js?v=4.6.101',
  './js/plates.js?v=4.6.101',
  './js/plate-canvas.js?v=4.6.101',
  './css/plates.css?v=4.6.101',
  ...
  './js/core.js?v=4.6.101',
  './js/derive.js?v=4.6.101',
  './js/util.js?v=4.6.101',
  './js/planlink.js?v=4.6.101',
  './js/realset.js?v=4.6.101',
  './js/reprange.js?v=4.6.101',
  './js/verdict.js?v=4.6.101',
  './js/header.js?v=4.6.101',
  './js/report.js?v=4.6.101',
  './js/today.js?v=4.6.101',
  './js/progression.js?v=4.6.101',
  './js/lift.js?v=4.6.101',
  './js/writer.js?v=4.6.101',
  './js/planner.js?v=4.6.101',
  './js/planner-flow.js?v=4.6.101',
  './css/planner-flow.css?v=4.6.101',
  './js/stats.js?v=4.6.101',
  './js/history.js?v=4.6.101',
  './js/settings.js?v=4.6.101',
  './js/stats-story.js?v=4.6.101',
  './js/app.js?v=4.6.101',
