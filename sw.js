const CACHE = 'showup-v3.3.75';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.75',
  './js/core.js?v=3.3.75',
  './js/derive.js?v=3.3.75',
  './js/util.js?v=3.3.75',
  './js/header.js?v=3.3.75',
  './js/report.js?v=3.3.75',
  './js/today.js?v=3.3.75',
  './js/lift.js?v=3.3.75',
  './js/stats.js?v=3.3.75',
  './js/history.js?v=3.3.75',
  './js/settings.js?v=3.3.75',
  './js/app.js?v=3.3.75',
  './icon-192.png',
  './icon-512.png',
