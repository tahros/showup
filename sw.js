const CACHE = 'showup-v4.6.40';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.40',
  './css/planner.css?v=4.6.40',
  './css/mascot.css?v=4.6.40',
  './js/mascot.js?v=4.6.40',
  './js/plates.js?v=4.6.40',
  './js/plate-canvas.js?v=4.6.40',
  './css/plates.css?v=4.6.40',
  ...
  './js/core.js?v=4.6.40',
  './js/derive.js?v=4.6.40',
  './js/util.js?v=4.6.40',
  './js/planlink.js?v=4.6.40',
  './js/realset.js?v=4.6.40',
  './js/reprange.js?v=4.6.40',
  './js/verdict.js?v=4.6.40',
  './js/header.js?v=4.6.40',
  './js/report.js?v=4.6.40',
  './js/today.js?v=4.6.40',
  './js/progression.js?v=4.6.40',
  './js/lift.js?v=4.6.40',
  './js/writer.js?v=4.6.40',
  './js/planner.js?v=4.6.40',
  './js/planner-flow.js?v=4.6.40',
  './css/planner-flow.css?v=4.6.40',
  './js/stats.js?v=4.6.40',
  './js/history.js?v=4.6.40',
  './js/settings.js?v=4.6.40',
  './js/stats-story.js?v=4.6.40',
  './js/app.js?v=4.6.40',
