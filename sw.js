const CACHE = 'showup-v3.3.59';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.59',
  './js/core.js?v=3.3.59',
  './js/derive.js?v=3.3.59',
  './js/util.js?v=3.3.59',
  './js/header.js?v=3.3.59',
  './js/report.js?v=3.3.59',
  './js/today.js?v=3.3.59',
  './js/lift.js?v=3.3.59',
  './js/stats.js?v=3.3.59',
  './js/history.js?v=3.3.59',
  './js/settings.js?v=3.3.59',
  './js/app.js?v=3.3.59',
  './icon-192.png',
  './icon-512.png',
