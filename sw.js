const CACHE = 'showup-v3.3.370';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.370',
  './js/core.js?v=3.3.370',
  './js/derive.js?v=3.3.370',
  './js/util.js?v=3.3.370',
  './js/header.js?v=3.3.370',
  './js/report.js?v=3.3.370',
  './js/today.js?v=3.3.370',
  './js/lift.js?v=3.3.370',
  './js/stats.js?v=3.3.370',
  './js/history.js?v=3.3.370',
  './js/settings.js?v=3.3.370',
  './js/app.js?v=3.3.370',
