const CACHE = 'showup-v3.3.170';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.170',
  './js/core.js?v=3.3.170',
  './js/derive.js?v=3.3.170',
  './js/util.js?v=3.3.170',
  './js/header.js?v=3.3.170',
  './js/report.js?v=3.3.170',
  './js/today.js?v=3.3.170',
  './js/lift.js?v=3.3.170',
  './js/stats.js?v=3.3.170',
  './js/history.js?v=3.3.170',
  './js/settings.js?v=3.3.170',
  './js/app.js?v=3.3.170',
  './icon-192.png',
  './icon-512.png',
