const CACHE = 'showup-v4.6.67';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.67',
  './css/planner.css?v=4.6.67',
  './css/mascot.css?v=4.6.67',
  './js/mascot.js?v=4.6.67',
  './js/plates.js?v=4.6.67',
  './js/plate-canvas.js?v=4.6.67',
  './css/plates.css?v=4.6.67',
  ...
  './js/core.js?v=4.6.67',
  './js/derive.js?v=4.6.67',
  './js/util.js?v=4.6.67',
  './js/planlink.js?v=4.6.67',
  './js/realset.js?v=4.6.67',
  './js/reprange.js?v=4.6.67',
  './js/verdict.js?v=4.6.67',
  './js/header.js?v=4.6.67',
  './js/report.js?v=4.6.67',
  './js/today.js?v=4.6.67',
  './js/progression.js?v=4.6.67',
  './js/lift.js?v=4.6.67',
  './js/writer.js?v=4.6.67',
  './js/planner.js?v=4.6.67',
  './js/planner-flow.js?v=4.6.67',
  './css/planner-flow.css?v=4.6.67',
  './js/stats.js?v=4.6.67',
  './js/history.js?v=4.6.67',
  './js/settings.js?v=4.6.67',
  './js/stats-story.js?v=4.6.67',
  './js/app.js?v=4.6.67',
