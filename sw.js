const CACHE = 'showup-v3.3.355';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.355',
  './js/core.js?v=3.3.355',
  './js/derive.js?v=3.3.355',
  './js/util.js?v=3.3.355',
  './js/header.js?v=3.3.355',
  './js/report.js?v=3.3.355',
  './js/today.js?v=3.3.355',
  './js/lift.js?v=3.3.355',
  './js/stats.js?v=3.3.355',
  './js/history.js?v=3.3.355',
  './js/settings.js?v=3.3.355',
  './js/app.js?v=3.3.355',
