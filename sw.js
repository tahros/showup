const CACHE = 'showup-v3.3.81';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.81',
  './js/core.js?v=3.3.81',
  './js/derive.js?v=3.3.81',
  './js/util.js?v=3.3.81',
  './js/header.js?v=3.3.81',
  './js/report.js?v=3.3.81',
  './js/today.js?v=3.3.81',
  './js/lift.js?v=3.3.81',
  './js/stats.js?v=3.3.81',
  './js/history.js?v=3.3.81',
  './js/settings.js?v=3.3.81',
  './js/app.js?v=3.3.81',
  './icon-192.png',
  './icon-512.png',
