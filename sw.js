const CACHE = 'showup-v3.3.267';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.267',
  './js/core.js?v=3.3.267',
  './js/derive.js?v=3.3.267',
  './js/util.js?v=3.3.267',
  './js/header.js?v=3.3.267',
  './js/report.js?v=3.3.267',
  './js/today.js?v=3.3.267',
  './js/lift.js?v=3.3.267',
  './js/stats.js?v=3.3.267',
  './js/history.js?v=3.3.267',
  './js/settings.js?v=3.3.267',
  './js/app.js?v=3.3.267',
