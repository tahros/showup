const CACHE = 'showup-v3.3.111';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.111',
  './js/core.js?v=3.3.111',
  './js/derive.js?v=3.3.111',
  './js/util.js?v=3.3.111',
  './js/header.js?v=3.3.111',
  './js/report.js?v=3.3.111',
  './js/today.js?v=3.3.111',
  './js/lift.js?v=3.3.111',
  './js/stats.js?v=3.3.111',
  './js/history.js?v=3.3.111',
  './js/settings.js?v=3.3.111',
  './js/app.js?v=3.3.111',
  './icon-192.png',
  './icon-512.png',
