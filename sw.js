const CACHE = 'showup-v3.3.147';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.147',
  './js/core.js?v=3.3.147',
  './js/derive.js?v=3.3.147',
  './js/util.js?v=3.3.147',
  './js/header.js?v=3.3.147',
  './js/report.js?v=3.3.147',
  './js/today.js?v=3.3.147',
  './js/lift.js?v=3.3.147',
  './js/stats.js?v=3.3.147',
  './js/history.js?v=3.3.147',
  './js/settings.js?v=3.3.147',
  './js/app.js?v=3.3.147',
  './icon-192.png',
  './icon-512.png',
