const CACHE = 'showup-v4.2.5';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.2.5',
  './css/planner.css?v=4.2.5',
  './css/mascot.css?v=4.2.5',
  './js/mascot.js?v=4.2.5',
  './js/plates.js?v=4.2.5',
  './js/plate-canvas.js?v=4.2.5',
  './css/plates.css?v=4.2.5',
  ...
  './js/core.js?v=4.2.5',
  './js/derive.js?v=4.2.5',
  './js/util.js?v=4.2.5',
  './js/header.js?v=4.2.5',
  './js/report.js?v=4.2.5',
  './js/today.js?v=4.2.5',
  './js/progression.js?v=4.2.5',
  './js/lift.js?v=4.2.5',
  './js/writer.js?v=4.2.5',
  './js/planner.js?v=4.2.5',
  './js/stats.js?v=4.2.5',
  './js/history.js?v=4.2.5',
  './js/settings.js?v=4.2.5',
  './js/app.js?v=4.2.5',
