const CACHE = 'showup-v3.3.144';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.144',
  './js/core.js?v=3.3.144',
  './js/derive.js?v=3.3.144',
  './js/util.js?v=3.3.144',
  './js/header.js?v=3.3.144',
  './js/report.js?v=3.3.144',
  './js/today.js?v=3.3.144',
  './js/lift.js?v=3.3.144',
  './js/stats.js?v=3.3.144',
  './js/history.js?v=3.3.144',
  './js/settings.js?v=3.3.144',
  './js/app.js?v=3.3.144',
  './icon-192.png',
  './icon-512.png',
