const CACHE = 'showup-v4.6.43';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.43',
  './css/planner.css?v=4.6.43',
  './css/mascot.css?v=4.6.43',
  './js/mascot.js?v=4.6.43',
  './js/plates.js?v=4.6.43',
  './js/plate-canvas.js?v=4.6.43',
  './css/plates.css?v=4.6.43',
  ...
  './js/core.js?v=4.6.43',
  './js/derive.js?v=4.6.43',
  './js/util.js?v=4.6.43',
  './js/planlink.js?v=4.6.43',
  './js/realset.js?v=4.6.43',
  './js/reprange.js?v=4.6.43',
  './js/verdict.js?v=4.6.43',
  './js/header.js?v=4.6.43',
  './js/report.js?v=4.6.43',
  './js/today.js?v=4.6.43',
  './js/progression.js?v=4.6.43',
  './js/lift.js?v=4.6.43',
  './js/writer.js?v=4.6.43',
  './js/planner.js?v=4.6.43',
  './js/planner-flow.js?v=4.6.43',
  './css/planner-flow.css?v=4.6.43',
  './js/stats.js?v=4.6.43',
  './js/history.js?v=4.6.43',
  './js/settings.js?v=4.6.43',
  './js/stats-story.js?v=4.6.43',
  './js/app.js?v=4.6.43',
