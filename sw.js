const CACHE = 'showup-v3.3.261';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.261',
  './js/core.js?v=3.3.261',
  './js/derive.js?v=3.3.261',
  './js/util.js?v=3.3.261',
  './js/header.js?v=3.3.261',
  './js/report.js?v=3.3.261',
  './js/today.js?v=3.3.261',
  './js/lift.js?v=3.3.261',
  './js/stats.js?v=3.3.261',
  './js/history.js?v=3.3.261',
  './js/settings.js?v=3.3.261',
  './js/app.js?v=3.3.261',
