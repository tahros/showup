const CACHE = 'showup-v3.3.388';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.388',
  './js/core.js?v=3.3.388',
  './js/derive.js?v=3.3.388',
  './js/util.js?v=3.3.388',
  './js/header.js?v=3.3.388',
  './js/report.js?v=3.3.388',
  './js/today.js?v=3.3.388',
  './js/lift.js?v=3.3.388',
  './js/stats.js?v=3.3.388',
  './js/history.js?v=3.3.388',
  './js/settings.js?v=3.3.388',
  './js/app.js?v=3.3.388',
