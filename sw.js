const CACHE = 'showup-v3.3.453';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.453',
  './js/core.js?v=3.3.453',
  './js/derive.js?v=3.3.453',
  './js/util.js?v=3.3.453',
  './js/header.js?v=3.3.453',
  './js/report.js?v=3.3.453',
  './js/today.js?v=3.3.453',
  './js/lift.js?v=3.3.453',
  './js/writer.js?v=3.3.453',
  './js/stats.js?v=3.3.453',
  './js/history.js?v=3.3.453',
  './js/settings.js?v=3.3.453',
  './js/app.js?v=3.3.453',
