const CACHE = 'showup-v4.6.59';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.59',
  './css/planner.css?v=4.6.59',
  './css/mascot.css?v=4.6.59',
  './js/mascot.js?v=4.6.59',
  './js/plates.js?v=4.6.59',
  './js/plate-canvas.js?v=4.6.59',
  './css/plates.css?v=4.6.59',
  ...
  './js/core.js?v=4.6.59',
  './js/derive.js?v=4.6.59',
  './js/util.js?v=4.6.59',
  './js/planlink.js?v=4.6.59',
  './js/realset.js?v=4.6.59',
  './js/reprange.js?v=4.6.59',
  './js/verdict.js?v=4.6.59',
  './js/header.js?v=4.6.59',
  './js/report.js?v=4.6.59',
  './js/today.js?v=4.6.59',
  './js/progression.js?v=4.6.59',
  './js/lift.js?v=4.6.59',
  './js/writer.js?v=4.6.59',
  './js/planner.js?v=4.6.59',
  './js/planner-flow.js?v=4.6.59',
  './css/planner-flow.css?v=4.6.59',
  './js/stats.js?v=4.6.59',
  './js/history.js?v=4.6.59',
  './js/settings.js?v=4.6.59',
  './js/stats-story.js?v=4.6.59',
  './js/app.js?v=4.6.59',
