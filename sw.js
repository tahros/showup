const CACHE = 'showup-v3.3.174';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.174',
  './js/core.js?v=3.3.174',
  './js/derive.js?v=3.3.174',
  './js/util.js?v=3.3.174',
  './js/header.js?v=3.3.174',
  './js/report.js?v=3.3.174',
  './js/today.js?v=3.3.174',
  './js/lift.js?v=3.3.174',
  './js/stats.js?v=3.3.174',
  './js/history.js?v=3.3.174',
  './js/settings.js?v=3.3.174',
  './js/app.js?v=3.3.174',
  './icon-192.png',
  './icon-512.png',
