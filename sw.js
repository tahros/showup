...
const SHELL = [
  ...
  './js/core.js?v=3.3.24',
  './js/derive.js?v=3.3.24',
  './js/util.js?v=3.3.24',
  './js/header.js?v=3.3.24',
  './js/report.js?v=3.3.24',
  './js/today.js?v=3.3.24',
  './js/lift.js?v=3.3.24',
  './js/stats.js?v=3.3.24',
  './js/history.js?v=3.3.24',
  './js/settings.js?v=3.3.24',
  './js/app.js?v=3.3.24',
  './icon-192.png',
  './icon-512.png',
