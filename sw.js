const CACHE = 'showup-v3.3.254';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.254',
  './js/core.js?v=3.3.254',
  './js/derive.js?v=3.3.254',
  './js/util.js?v=3.3.254',
  './js/header.js?v=3.3.254',
  './js/report.js?v=3.3.254',
  './js/today.js?v=3.3.254',
  './js/lift.js?v=3.3.254',
  './js/stats.js?v=3.3.254',
  './js/history.js?v=3.3.254',
  './js/settings.js?v=3.3.254',
  './js/app.js?v=3.3.254',
