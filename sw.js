const CACHE = 'showup-v3.3.78';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.78',
  './js/core.js?v=3.3.78',
  './js/derive.js?v=3.3.78',
  './js/util.js?v=3.3.78',
  './js/header.js?v=3.3.78',
  './js/report.js?v=3.3.78',
  './js/today.js?v=3.3.78',
  './js/lift.js?v=3.3.78',
  './js/stats.js?v=3.3.78',
  './js/history.js?v=3.3.78',
  './js/settings.js?v=3.3.78',
  './js/app.js?v=3.3.78',
  './icon-192.png',
  './icon-512.png',
