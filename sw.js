const CACHE = 'showup-v3.3.301';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.301',
  './js/core.js?v=3.3.301',
  './js/derive.js?v=3.3.301',
  './js/util.js?v=3.3.301',
  './js/header.js?v=3.3.301',
  './js/report.js?v=3.3.301',
  './js/today.js?v=3.3.301',
  './js/lift.js?v=3.3.301',
  './js/stats.js?v=3.3.301',
  './js/history.js?v=3.3.301',
  './js/settings.js?v=3.3.301',
  './js/app.js?v=3.3.301',
