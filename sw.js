const CACHE = 'showup-v3.3.363';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.363',
  './js/core.js?v=3.3.363',
  './js/derive.js?v=3.3.363',
  './js/util.js?v=3.3.363',
  './js/header.js?v=3.3.363',
  './js/report.js?v=3.3.363',
  './js/today.js?v=3.3.363',
  './js/lift.js?v=3.3.363',
  './js/stats.js?v=3.3.363',
  './js/history.js?v=3.3.363',
  './js/settings.js?v=3.3.363',
  './js/app.js?v=3.3.363',
