const CACHE = 'showup-v4.2.4';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.2.4',
  './css/planner.css?v=4.2.4',
  './css/mascot.css?v=4.2.4',
  './js/mascot.js?v=4.2.4',
  './js/plates.js?v=4.2.4',
  './js/plate-canvas.js?v=4.2.4',
  './css/plates.css?v=4.2.4',
  ...
  './js/core.js?v=4.2.4',
  './js/derive.js?v=4.2.4',
  './js/util.js?v=4.2.4',
  './js/header.js?v=4.2.4',
  './js/report.js?v=4.2.4',
  './js/today.js?v=4.2.4',
  './js/progression.js?v=4.2.4',
  './js/lift.js?v=4.2.4',
  './js/writer.js?v=4.2.4',
  './js/planner.js?v=4.2.4',
  './js/stats.js?v=4.2.4',
  './js/history.js?v=4.2.4',
  './js/settings.js?v=4.2.4',
  './js/app.js?v=4.2.4',
