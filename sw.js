const CACHE = 'showup-v4.6.49';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.49',
  './css/planner.css?v=4.6.49',
  './css/mascot.css?v=4.6.49',
  './js/mascot.js?v=4.6.49',
  './js/plates.js?v=4.6.49',
  './js/plate-canvas.js?v=4.6.49',
  './css/plates.css?v=4.6.49',
  ...
  './js/core.js?v=4.6.49',
  './js/derive.js?v=4.6.49',
  './js/util.js?v=4.6.49',
  './js/planlink.js?v=4.6.49',
  './js/realset.js?v=4.6.49',
  './js/reprange.js?v=4.6.49',
  './js/verdict.js?v=4.6.49',
  './js/header.js?v=4.6.49',
  './js/report.js?v=4.6.49',
  './js/today.js?v=4.6.49',
  './js/progression.js?v=4.6.49',
  './js/lift.js?v=4.6.49',
  './js/writer.js?v=4.6.49',
  './js/planner.js?v=4.6.49',
  './js/planner-flow.js?v=4.6.49',
  './css/planner-flow.css?v=4.6.49',
  './js/stats.js?v=4.6.49',
  './js/history.js?v=4.6.49',
  './js/settings.js?v=4.6.49',
  './js/stats-story.js?v=4.6.49',
  './js/app.js?v=4.6.49',
