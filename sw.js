const CACHE = 'showup-v4.6.27';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.27',
  './css/planner.css?v=4.6.27',
  './css/mascot.css?v=4.6.27',
  './js/mascot.js?v=4.6.27',
  './js/plates.js?v=4.6.27',
  './js/plate-canvas.js?v=4.6.27',
  './css/plates.css?v=4.6.27',
  ...
  './js/core.js?v=4.6.27',
  './js/derive.js?v=4.6.27',
  './js/util.js?v=4.6.27',
  './js/planlink.js?v=4.6.27',
  './js/realset.js?v=4.6.27',
  './js/reprange.js?v=4.6.27',
  './js/verdict.js?v=4.6.27',
  './js/header.js?v=4.6.27',
  './js/report.js?v=4.6.27',
  './js/today.js?v=4.6.27',
  './js/progression.js?v=4.6.27',
  './js/lift.js?v=4.6.27',
  './js/writer.js?v=4.6.27',
  './js/planner.js?v=4.6.27',
  './js/planner-flow.js?v=4.6.27',
  './css/planner-flow.css?v=4.6.27',
  './js/stats.js?v=4.6.27',
  './js/history.js?v=4.6.27',
  './js/settings.js?v=4.6.27',
  './js/stats-story.js?v=4.6.27',
  './js/app.js?v=4.6.27',
