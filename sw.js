const CACHE = 'showup-v3.3.17';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.17',
  './js/core.js?v=3.3.17',
  './js/derive.js?v=3.3.17',
  './js/util.js?v=3.3.17',
  './js/header.js?v=3.3.17',
  './js/report.js?v=3.3.17',
  './js/today.js?v=3.3.17',
  './js/lift.js?v=3.3.17',
  './js/stats.js?v=3.3.17',
  './js/history.js?v=3.3.17',
  './js/settings.js?v=3.3.17',
  './js/app.js?v=3.3.17',
  './icon-192.png',
  './icon-512.png',
