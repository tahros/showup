const CACHE = 'showup-v4.1.0';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.1.0',
  './css/planner.css?v=4.1.0',
  './css/mascot.css?v=4.1.0',
  './js/mascot.js?v=4.1.0',
  ...
  './js/core.js?v=4.1.0',
  './js/derive.js?v=4.1.0',
  './js/util.js?v=4.1.0',
  './js/header.js?v=4.1.0',
  './js/report.js?v=4.1.0',
  './js/today.js?v=4.1.0',
  './js/progression.js?v=4.1.0',
  './js/lift.js?v=4.1.0',
  './js/writer.js?v=4.1.0',
  './js/planner.js?v=4.1.0',
  './js/stats.js?v=4.1.0',
  './js/history.js?v=4.1.0',
  './js/settings.js?v=4.1.0',
  './js/app.js?v=4.1.0',
