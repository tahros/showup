const CACHE = 'showup-v4.5.6';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.5.6',
  './css/planner.css?v=4.5.6',
  './css/mascot.css?v=4.5.6',
  './js/mascot.js?v=4.5.6',
  './js/plates.js?v=4.5.6',
  './js/plate-canvas.js?v=4.5.6',
  './css/plates.css?v=4.5.6',
  ...
  './js/core.js?v=4.5.6',
  './js/derive.js?v=4.5.6',
  './js/util.js?v=4.5.6',
  './js/realset.js?v=4.5.6',
  './js/reprange.js?v=4.5.6',
  './js/verdict.js?v=4.5.6',
  './js/header.js?v=4.5.6',
  './js/report.js?v=4.5.6',
  './js/today.js?v=4.5.6',
  './js/progression.js?v=4.5.6',
  './js/lift.js?v=4.5.6',
  './js/writer.js?v=4.5.6',
  './js/planner.js?v=4.5.6',
  './js/stats.js?v=4.5.6',
  './js/history.js?v=4.5.6',
  './js/settings.js?v=4.5.6',
  './js/stats-story.js?v=4.5.6',
  './js/app.js?v=4.5.6',
