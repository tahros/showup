...
const SHELL = [
  ...
  './js/core.js?v=3.3.48',
  './js/derive.js?v=3.3.48',
  './js/util.js?v=3.3.48',
  './js/header.js?v=3.3.48',
  './js/report.js?v=3.3.48',
  './js/today.js?v=3.3.48',
  './js/lift.js?v=3.3.48',
  './js/stats.js?v=3.3.48',
  './js/history.js?v=3.3.48',
  './js/settings.js?v=3.3.48',
  './js/app.js?v=3.3.48',
  './icon-192.png',
  './icon-512.png',
