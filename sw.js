const CACHE = 'showup-v4.6.34';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.34',
  './css/planner.css?v=4.6.34',
  './css/mascot.css?v=4.6.34',
  './js/mascot.js?v=4.6.34',
  './js/plates.js?v=4.6.34',
  './js/plate-canvas.js?v=4.6.34',
  './css/plates.css?v=4.6.34',
  ...
  './js/core.js?v=4.6.34',
  './js/derive.js?v=4.6.34',
  './js/util.js?v=4.6.34',
  './js/planlink.js?v=4.6.34',
  './js/realset.js?v=4.6.34',
  './js/reprange.js?v=4.6.34',
  './js/verdict.js?v=4.6.34',
  './js/header.js?v=4.6.34',
  './js/report.js?v=4.6.34',
  './js/today.js?v=4.6.34',
  './js/progression.js?v=4.6.34',
  './js/lift.js?v=4.6.34',
  './js/writer.js?v=4.6.34',
  './js/planner.js?v=4.6.34',
  './js/planner-flow.js?v=4.6.34',
  './css/planner-flow.css?v=4.6.34',
  './js/stats.js?v=4.6.34',
  './js/history.js?v=4.6.34',
  './js/settings.js?v=4.6.34',
  './js/stats-story.js?v=4.6.34',
  './js/app.js?v=4.6.34',
