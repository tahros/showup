const CACHE = 'showup-v3.3.289';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.289',
  './js/core.js?v=3.3.289',
  './js/derive.js?v=3.3.289',
  './js/util.js?v=3.3.289',
  './js/header.js?v=3.3.289',
  './js/report.js?v=3.3.289',
  './js/today.js?v=3.3.289',
  './js/lift.js?v=3.3.289',
  './js/stats.js?v=3.3.289',
  './js/history.js?v=3.3.289',
  './js/settings.js?v=3.3.289',
  './js/app.js?v=3.3.289',
