const CACHE = 'showup-v3.3.319';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.319',
  './js/core.js?v=3.3.319',
  './js/derive.js?v=3.3.319',
  './js/util.js?v=3.3.319',
  './js/header.js?v=3.3.319',
  './js/report.js?v=3.3.319',
  './js/today.js?v=3.3.319',
  './js/lift.js?v=3.3.319',
  './js/stats.js?v=3.3.319',
  './js/history.js?v=3.3.319',
  './js/settings.js?v=3.3.319',
  './js/app.js?v=3.3.319',
