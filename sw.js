const CACHE = 'showup-v3.3.186';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.186',
  './js/core.js?v=3.3.186',
  './js/derive.js?v=3.3.186',
  './js/util.js?v=3.3.186',
  './js/header.js?v=3.3.186',
  './js/report.js?v=3.3.186',
  './js/today.js?v=3.3.186',
  './js/lift.js?v=3.3.186',
  './js/stats.js?v=3.3.186',
  './js/history.js?v=3.3.186',
  './js/settings.js?v=3.3.186',
  './js/app.js?v=3.3.186',
  './icon-192.png',
  './icon-512.png',
