const CACHE = 'showup-v3.3.137';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.137',
  './js/core.js?v=3.3.137',
  './js/derive.js?v=3.3.137',
  './js/util.js?v=3.3.137',
  './js/header.js?v=3.3.137',
  './js/report.js?v=3.3.137',
  './js/today.js?v=3.3.137',
  './js/lift.js?v=3.3.137',
  './js/stats.js?v=3.3.137',
  './js/history.js?v=3.3.137',
  './js/settings.js?v=3.3.137',
  './js/app.js?v=3.3.137',
  './icon-192.png',
  './icon-512.png',
