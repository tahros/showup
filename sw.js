const CACHE = 'showup-v3.3.169';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.169',
  './js/core.js?v=3.3.169',
  './js/derive.js?v=3.3.169',
  './js/util.js?v=3.3.169',
  './js/header.js?v=3.3.169',
  './js/report.js?v=3.3.169',
  './js/today.js?v=3.3.169',
  './js/lift.js?v=3.3.169',
  './js/stats.js?v=3.3.169',
  './js/history.js?v=3.3.169',
  './js/settings.js?v=3.3.169',
  './js/app.js?v=3.3.169',
  './icon-192.png',
  './icon-512.png',
