const CACHE = 'showup-v3.3.368';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.368',
  './js/core.js?v=3.3.368',
  './js/derive.js?v=3.3.368',
  './js/util.js?v=3.3.368',
  './js/header.js?v=3.3.368',
  './js/report.js?v=3.3.368',
  './js/today.js?v=3.3.368',
  './js/lift.js?v=3.3.368',
  './js/stats.js?v=3.3.368',
  './js/history.js?v=3.3.368',
  './js/settings.js?v=3.3.368',
  './js/app.js?v=3.3.368',
