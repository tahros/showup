const CACHE = 'showup-v3.3.21';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.21',
  './js/core.js?v=3.3.21',
  './js/derive.js?v=3.3.21',
  './js/util.js?v=3.3.21',
  './js/header.js?v=3.3.21',
  './js/report.js?v=3.3.21',
  './js/today.js?v=3.3.21',
  './js/lift.js?v=3.3.21',
  './js/stats.js?v=3.3.21',
  './js/history.js?v=3.3.21',
  './js/settings.js?v=3.3.21',
  './js/app.js?v=3.3.21',
  './icon-192.png',
  './icon-512.png',
