const CACHE = 'showup-v3.3.278';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.278',
  './js/core.js?v=3.3.278',
  './js/derive.js?v=3.3.278',
  './js/util.js?v=3.3.278',
  './js/header.js?v=3.3.278',
  './js/report.js?v=3.3.278',
  './js/today.js?v=3.3.278',
  './js/lift.js?v=3.3.278',
  './js/stats.js?v=3.3.278',
  './js/history.js?v=3.3.278',
  './js/settings.js?v=3.3.278',
  './js/app.js?v=3.3.278',
