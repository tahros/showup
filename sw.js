const CACHE = 'showup-v3.3.181';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.181',
  './js/core.js?v=3.3.181',
  './js/derive.js?v=3.3.181',
  './js/util.js?v=3.3.181',
  './js/header.js?v=3.3.181',
  './js/report.js?v=3.3.181',
  './js/today.js?v=3.3.181',
  './js/lift.js?v=3.3.181',
  './js/stats.js?v=3.3.181',
  './js/history.js?v=3.3.181',
  './js/settings.js?v=3.3.181',
  './js/app.js?v=3.3.181',
  './icon-192.png',
  './icon-512.png',
