const CACHE = 'showup-v3.3.42';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.42',
  './js/core.js?v=3.3.42',
  './js/derive.js?v=3.3.42',
  './js/util.js?v=3.3.42',
  './js/header.js?v=3.3.42',
  './js/report.js?v=3.3.42',
  './js/today.js?v=3.3.42',
  './js/lift.js?v=3.3.42',
  './js/stats.js?v=3.3.42',
  './js/history.js?v=3.3.42',
  './js/settings.js?v=3.3.42',
  './js/app.js?v=3.3.42',
  './icon-192.png',
  './icon-512.png',
