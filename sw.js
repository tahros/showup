const CACHE = 'showup-v3.3.151';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.151',
  './js/core.js?v=3.3.151',
  './js/derive.js?v=3.3.151',
  './js/util.js?v=3.3.151',
  './js/header.js?v=3.3.151',
  './js/report.js?v=3.3.151',
  './js/today.js?v=3.3.151',
  './js/lift.js?v=3.3.151',
  './js/stats.js?v=3.3.151',
  './js/history.js?v=3.3.151',
  './js/settings.js?v=3.3.151',
  './js/app.js?v=3.3.151',
  './icon-192.png',
  './icon-512.png',
