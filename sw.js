const CACHE = 'showup-v3.3.223';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.223',
  './js/core.js?v=3.3.223',
  './js/derive.js?v=3.3.223',
  './js/util.js?v=3.3.223',
  './js/header.js?v=3.3.223',
  './js/report.js?v=3.3.223',
  './js/today.js?v=3.3.223',
  './js/lift.js?v=3.3.223',
  './js/stats.js?v=3.3.223',
  './js/history.js?v=3.3.223',
  './js/settings.js?v=3.3.223',
  './js/app.js?v=3.3.223',
