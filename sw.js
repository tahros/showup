const CACHE = 'showup-v3.3.180';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.180',
  './js/core.js?v=3.3.180',
  './js/derive.js?v=3.3.180',
  './js/util.js?v=3.3.180',
  './js/header.js?v=3.3.180',
  './js/report.js?v=3.3.180',
  './js/today.js?v=3.3.180',
  './js/lift.js?v=3.3.180',
  './js/stats.js?v=3.3.180',
  './js/history.js?v=3.3.180',
  './js/settings.js?v=3.3.180',
  './js/app.js?v=3.3.180',
  './icon-192.png',
  './icon-512.png',
