const CACHE = 'showup-v3.3.290';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.290',
  './js/core.js?v=3.3.290',
  './js/derive.js?v=3.3.290',
  './js/util.js?v=3.3.290',
  './js/header.js?v=3.3.290',
  './js/report.js?v=3.3.290',
  './js/today.js?v=3.3.290',
  './js/lift.js?v=3.3.290',
  './js/stats.js?v=3.3.290',
  './js/history.js?v=3.3.290',
  './js/settings.js?v=3.3.290',
  './js/app.js?v=3.3.290',
