const CACHE = 'showup-v4.6.32';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.32',
  './css/planner.css?v=4.6.32',
  './css/mascot.css?v=4.6.32',
  './js/mascot.js?v=4.6.32',
  './js/plates.js?v=4.6.32',
  './js/plate-canvas.js?v=4.6.32',
  './css/plates.css?v=4.6.32',
  ...
  './js/core.js?v=4.6.32',
  './js/derive.js?v=4.6.32',
  './js/util.js?v=4.6.32',
  './js/planlink.js?v=4.6.32',
  './js/realset.js?v=4.6.32',
  './js/reprange.js?v=4.6.32',
  './js/verdict.js?v=4.6.32',
  './js/header.js?v=4.6.32',
  './js/report.js?v=4.6.32',
  './js/today.js?v=4.6.32',
  './js/progression.js?v=4.6.32',
  './js/lift.js?v=4.6.32',
  './js/writer.js?v=4.6.32',
  './js/planner.js?v=4.6.32',
  './js/planner-flow.js?v=4.6.32',
  './css/planner-flow.css?v=4.6.32',
  './js/stats.js?v=4.6.32',
  './js/history.js?v=4.6.32',
  './js/settings.js?v=4.6.32',
  './js/stats-story.js?v=4.6.32',
  './js/app.js?v=4.6.32',
