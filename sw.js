const CACHE = 'showup-v3.3.241';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.241',
  './js/core.js?v=3.3.241',
  './js/derive.js?v=3.3.241',
  './js/util.js?v=3.3.241',
  './js/header.js?v=3.3.241',
  './js/report.js?v=3.3.241',
  './js/today.js?v=3.3.241',
  './js/lift.js?v=3.3.241',
  './js/stats.js?v=3.3.241',
  './js/history.js?v=3.3.241',
  './js/settings.js?v=3.3.241',
  './js/app.js?v=3.3.241',
