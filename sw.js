const CACHE = 'showup-v3.3.71';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.71',
  './js/core.js?v=3.3.71',
  './js/derive.js?v=3.3.71',
  './js/util.js?v=3.3.71',
  './js/header.js?v=3.3.71',
  './js/report.js?v=3.3.71',
  './js/today.js?v=3.3.71',
  './js/lift.js?v=3.3.71',
  './js/stats.js?v=3.3.71',
  './js/history.js?v=3.3.71',
  './js/settings.js?v=3.3.71',
  './js/app.js?v=3.3.71',
  './icon-192.png',
  './icon-512.png',
