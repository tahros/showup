const CACHE = 'showup-v3.3.294';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.294',
  './js/core.js?v=3.3.294',
  './js/derive.js?v=3.3.294',
  './js/util.js?v=3.3.294',
  './js/header.js?v=3.3.294',
  './js/report.js?v=3.3.294',
  './js/today.js?v=3.3.294',
  './js/lift.js?v=3.3.294',
  './js/stats.js?v=3.3.294',
  './js/history.js?v=3.3.294',
  './js/settings.js?v=3.3.294',
  './js/app.js?v=3.3.294',
