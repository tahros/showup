const CACHE = 'showup-v3.3.138';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.138',
  './js/core.js?v=3.3.138',
  './js/derive.js?v=3.3.138',
  './js/util.js?v=3.3.138',
  './js/header.js?v=3.3.138',
  './js/report.js?v=3.3.138',
  './js/today.js?v=3.3.138',
  './js/lift.js?v=3.3.138',
  './js/stats.js?v=3.3.138',
  './js/history.js?v=3.3.138',
  './js/settings.js?v=3.3.138',
  './js/app.js?v=3.3.138',
  './icon-192.png',
  './icon-512.png',
