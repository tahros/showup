const CACHE = 'showup-v3.3.87';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.87',
  './js/core.js?v=3.3.87',
  './js/derive.js?v=3.3.87',
  './js/util.js?v=3.3.87',
  './js/header.js?v=3.3.87',
  './js/report.js?v=3.3.87',
  './js/today.js?v=3.3.87',
  './js/lift.js?v=3.3.87',
  './js/stats.js?v=3.3.87',
  './js/history.js?v=3.3.87',
  './js/settings.js?v=3.3.87',
  './js/app.js?v=3.3.87',
  './icon-192.png',
  './icon-512.png',
