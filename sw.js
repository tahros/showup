const CACHE = 'showup-v3.3.258';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.258',
  './js/core.js?v=3.3.258',
  './js/derive.js?v=3.3.258',
  './js/util.js?v=3.3.258',
  './js/header.js?v=3.3.258',
  './js/report.js?v=3.3.258',
  './js/today.js?v=3.3.258',
  './js/lift.js?v=3.3.258',
  './js/stats.js?v=3.3.258',
  './js/history.js?v=3.3.258',
  './js/settings.js?v=3.3.258',
  './js/app.js?v=3.3.258',
