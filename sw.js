const CACHE = 'showup-v3.3.92';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.92',
  './js/core.js?v=3.3.92',
  './js/derive.js?v=3.3.92',
  './js/util.js?v=3.3.92',
  './js/header.js?v=3.3.92',
  './js/report.js?v=3.3.92',
  './js/today.js?v=3.3.92',
  './js/lift.js?v=3.3.92',
  './js/stats.js?v=3.3.92',
  './js/history.js?v=3.3.92',
  './js/settings.js?v=3.3.92',
  './js/app.js?v=3.3.92',
  './icon-192.png',
  './icon-512.png',
