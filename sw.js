const CACHE = 'showup-v3.3.160';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.160',
  './js/core.js?v=3.3.160',
  './js/derive.js?v=3.3.160',
  './js/util.js?v=3.3.160',
  './js/header.js?v=3.3.160',
  './js/report.js?v=3.3.160',
  './js/today.js?v=3.3.160',
  './js/lift.js?v=3.3.160',
  './js/stats.js?v=3.3.160',
  './js/history.js?v=3.3.160',
  './js/settings.js?v=3.3.160',
  './js/app.js?v=3.3.160',
  './icon-192.png',
  './icon-512.png',
