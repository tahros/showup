const CACHE = 'showup-v3.3.520';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.520',
  './js/core.js?v=3.3.520',
  './js/derive.js?v=3.3.520',
  './js/util.js?v=3.3.520',
  './js/header.js?v=3.3.520',
  './js/report.js?v=3.3.520',
  './js/today.js?v=3.3.520',
  './js/lift.js?v=3.3.520',
  './js/writer.js?v=3.3.520',
  './js/stats.js?v=3.3.520',
  './js/history.js?v=3.3.520',
  './js/settings.js?v=3.3.520',
  './js/app.js?v=3.3.520',
