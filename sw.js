const CACHE = 'showup-v4.6.88';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.88',
  './css/planner.css?v=4.6.88',
  './css/mascot.css?v=4.6.88',
  './js/mascot.js?v=4.6.88',
  './js/plates.js?v=4.6.88',
  './js/plate-canvas.js?v=4.6.88',
  './css/plates.css?v=4.6.88',
  ...
  './js/core.js?v=4.6.88',
  './js/derive.js?v=4.6.88',
  './js/util.js?v=4.6.88',
  './js/planlink.js?v=4.6.88',
  './js/realset.js?v=4.6.88',
  './js/reprange.js?v=4.6.88',
  './js/verdict.js?v=4.6.88',
  './js/header.js?v=4.6.88',
  './js/report.js?v=4.6.88',
  './js/today.js?v=4.6.88',
  './js/progression.js?v=4.6.88',
  './js/lift.js?v=4.6.88',
  './js/writer.js?v=4.6.88',
  './js/planner.js?v=4.6.88',
  './js/planner-flow.js?v=4.6.88',
  './css/planner-flow.css?v=4.6.88',
  './js/stats.js?v=4.6.88',
  './js/history.js?v=4.6.88',
  './js/settings.js?v=4.6.88',
  './js/stats-story.js?v=4.6.88',
  './js/app.js?v=4.6.88',
