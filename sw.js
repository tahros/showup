const CACHE = 'showup-v3.3.158';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.158',
  './js/core.js?v=3.3.158',
  './js/derive.js?v=3.3.158',
  './js/util.js?v=3.3.158',
  './js/header.js?v=3.3.158',
  './js/report.js?v=3.3.158',
  './js/today.js?v=3.3.158',
  './js/lift.js?v=3.3.158',
  './js/stats.js?v=3.3.158',
  './js/history.js?v=3.3.158',
  './js/settings.js?v=3.3.158',
  './js/app.js?v=3.3.158',
  './icon-192.png',
  './icon-512.png',
