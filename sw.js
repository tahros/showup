const CACHE = 'showup-v3.3.196';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.196',
  './js/core.js?v=3.3.196',
  './js/derive.js?v=3.3.196',
  './js/util.js?v=3.3.196',
  './js/header.js?v=3.3.196',
  './js/report.js?v=3.3.196',
  './js/today.js?v=3.3.196',
  './js/lift.js?v=3.3.196',
  './js/stats.js?v=3.3.196',
  './js/history.js?v=3.3.196',
  './js/settings.js?v=3.3.196',
  './js/app.js?v=3.3.196',
  './icon-192.png',
  './icon-512.png',
