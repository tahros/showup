const CACHE = 'showup-v3.3.179';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.179',
  './js/core.js?v=3.3.179',
  './js/derive.js?v=3.3.179',
  './js/util.js?v=3.3.179',
  './js/header.js?v=3.3.179',
  './js/report.js?v=3.3.179',
  './js/today.js?v=3.3.179',
  './js/lift.js?v=3.3.179',
  './js/stats.js?v=3.3.179',
  './js/history.js?v=3.3.179',
  './js/settings.js?v=3.3.179',
  './js/app.js?v=3.3.179',
  './icon-192.png',
  './icon-512.png',
