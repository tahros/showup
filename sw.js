const CACHE = 'showup-v3.3.205';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.205',
  './js/core.js?v=3.3.205',
  './js/derive.js?v=3.3.205',
  './js/util.js?v=3.3.205',
  './js/header.js?v=3.3.205',
  './js/report.js?v=3.3.205',
  './js/today.js?v=3.3.205',
  './js/lift.js?v=3.3.205',
  './js/stats.js?v=3.3.205',
  './js/history.js?v=3.3.205',
  './js/settings.js?v=3.3.205',
  './js/app.js?v=3.3.205',
  './icon-192.png',
  './icon-512.png',
