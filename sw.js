const CACHE = 'showup-v3.3.321';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.321',
  './js/core.js?v=3.3.321',
  './js/derive.js?v=3.3.321',
  './js/util.js?v=3.3.321',
  './js/header.js?v=3.3.321',
  './js/report.js?v=3.3.321',
  './js/today.js?v=3.3.321',
  './js/lift.js?v=3.3.321',
  './js/stats.js?v=3.3.321',
  './js/history.js?v=3.3.321',
  './js/settings.js?v=3.3.321',
  './js/app.js?v=3.3.321',
