const CACHE = 'showup-v3.3.43';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.43',
  './js/core.js?v=3.3.43',
  './js/derive.js?v=3.3.43',
  './js/util.js?v=3.3.43',
  './js/header.js?v=3.3.43',
  './js/report.js?v=3.3.43',
  './js/today.js?v=3.3.43',
  './js/lift.js?v=3.3.43',
  './js/stats.js?v=3.3.43',
  './js/history.js?v=3.3.43',
  './js/settings.js?v=3.3.43',
  './js/app.js?v=3.3.43',
  './icon-192.png',
  './icon-512.png',
