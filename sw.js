const CACHE = 'showup-v3.3.318';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.318',
  './js/core.js?v=3.3.318',
  './js/derive.js?v=3.3.318',
  './js/util.js?v=3.3.318',
  './js/header.js?v=3.3.318',
  './js/report.js?v=3.3.318',
  './js/today.js?v=3.3.318',
  './js/lift.js?v=3.3.318',
  './js/stats.js?v=3.3.318',
  './js/history.js?v=3.3.318',
  './js/settings.js?v=3.3.318',
  './js/app.js?v=3.3.318',
