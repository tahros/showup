const CACHE = 'showup-v4.3.3';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.3.3',
  './css/planner.css?v=4.3.3',
  './css/mascot.css?v=4.3.3',
  './js/mascot.js?v=4.3.3',
  './js/plates.js?v=4.3.3',
  './js/plate-canvas.js?v=4.3.3',
  './css/plates.css?v=4.3.3',
  ...
  './js/core.js?v=4.3.3',
  './js/derive.js?v=4.3.3',
  './js/util.js?v=4.3.3',
  './js/header.js?v=4.3.3',
  './js/report.js?v=4.3.3',
  './js/today.js?v=4.3.3',
  './js/progression.js?v=4.3.3',
  './js/lift.js?v=4.3.3',
  './js/writer.js?v=4.3.3',
  './js/planner.js?v=4.3.3',
  './js/stats.js?v=4.3.3',
  './js/history.js?v=4.3.3',
  './js/settings.js?v=4.3.3',
  './js/app.js?v=4.3.3',
