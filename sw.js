const CACHE = 'showup-v4.6.9';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.9',
  './css/planner.css?v=4.6.9',
  './css/mascot.css?v=4.6.9',
  './js/mascot.js?v=4.6.9',
  './js/plates.js?v=4.6.9',
  './js/plate-canvas.js?v=4.6.9',
  './css/plates.css?v=4.6.9',
  ...
  './js/core.js?v=4.6.9',
  './js/derive.js?v=4.6.9',
  './js/util.js?v=4.6.9',
  './js/planlink.js?v=4.6.9',
  './js/realset.js?v=4.6.9',
  './js/reprange.js?v=4.6.9',
  './js/verdict.js?v=4.6.9',
  './js/header.js?v=4.6.9',
  './js/report.js?v=4.6.9',
  './js/today.js?v=4.6.9',
  './js/progression.js?v=4.6.9',
  './js/lift.js?v=4.6.9',
  './js/writer.js?v=4.6.9',
  './js/planner.js?v=4.6.9',
  './js/planner-flow.js?v=4.6.9',
  './css/planner-flow.css?v=4.6.9',
  './js/stats.js?v=4.6.9',
  './js/history.js?v=4.6.9',
  './js/settings.js?v=4.6.9',
  './js/stats-story.js?v=4.6.9',
  './js/app.js?v=4.6.9',
