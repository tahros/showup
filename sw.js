const CACHE = 'showup-v3.3.249';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.249',
  './js/core.js?v=3.3.249',
  './js/derive.js?v=3.3.249',
  './js/util.js?v=3.3.249',
  './js/header.js?v=3.3.249',
  './js/report.js?v=3.3.249',
  './js/today.js?v=3.3.249',
  './js/lift.js?v=3.3.249',
  './js/stats.js?v=3.3.249',
  './js/history.js?v=3.3.249',
  './js/settings.js?v=3.3.249',
  './js/app.js?v=3.3.249',
