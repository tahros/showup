const CACHE = 'showup-v3.3.288';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.288',
  './js/core.js?v=3.3.288',
  './js/derive.js?v=3.3.288',
  './js/util.js?v=3.3.288',
  './js/header.js?v=3.3.288',
  './js/report.js?v=3.3.288',
  './js/today.js?v=3.3.288',
  './js/lift.js?v=3.3.288',
  './js/stats.js?v=3.3.288',
  './js/history.js?v=3.3.288',
  './js/settings.js?v=3.3.288',
  './js/app.js?v=3.3.288',
