const CACHE = 'showup-v3.3.184';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.184',
  './js/core.js?v=3.3.184',
  './js/derive.js?v=3.3.184',
  './js/util.js?v=3.3.184',
  './js/header.js?v=3.3.184',
  './js/report.js?v=3.3.184',
  './js/today.js?v=3.3.184',
  './js/lift.js?v=3.3.184',
  './js/stats.js?v=3.3.184',
  './js/history.js?v=3.3.184',
  './js/settings.js?v=3.3.184',
  './js/app.js?v=3.3.184',
  './icon-192.png',
  './icon-512.png',
