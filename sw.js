const CACHE = 'showup-v3.3.127';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.127',
  './js/core.js?v=3.3.127',
  './js/derive.js?v=3.3.127',
  './js/util.js?v=3.3.127',
  './js/header.js?v=3.3.127',
  './js/report.js?v=3.3.127',
  './js/today.js?v=3.3.127',
  './js/lift.js?v=3.3.127',
  './js/stats.js?v=3.3.127',
  './js/history.js?v=3.3.127',
  './js/settings.js?v=3.3.127',
  './js/app.js?v=3.3.127',
  './icon-192.png',
  './icon-512.png',
