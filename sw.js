const CACHE = 'showup-v3.3.83';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.83',
  './js/core.js?v=3.3.83',
  './js/derive.js?v=3.3.83',
  './js/util.js?v=3.3.83',
  './js/header.js?v=3.3.83',
  './js/report.js?v=3.3.83',
  './js/today.js?v=3.3.83',
  './js/lift.js?v=3.3.83',
  './js/stats.js?v=3.3.83',
  './js/history.js?v=3.3.83',
  './js/settings.js?v=3.3.83',
  './js/app.js?v=3.3.83',
  './icon-192.png',
  './icon-512.png',
