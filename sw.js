const CACHE = 'showup-v3.3.10';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.10',
  './js/core.js?v=3.3.10',
  './js/derive.js?v=3.3.10',
  './js/util.js?v=3.3.10',
  './js/header.js?v=3.3.10',
  './js/report.js?v=3.3.10',
  './js/today.js?v=3.3.10',
  './js/lift.js?v=3.3.10',
  './js/stats.js?v=3.3.10',
  './js/history.js?v=3.3.10',
  './js/settings.js?v=3.3.10',
  './js/app.js?v=3.3.10',
  './icon-192.png',
  './icon-512.png',
