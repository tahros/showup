const CACHE = 'showup-v3.3.237';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.237',
  './js/core.js?v=3.3.237',
  './js/derive.js?v=3.3.237',
  './js/util.js?v=3.3.237',
  './js/header.js?v=3.3.237',
  './js/report.js?v=3.3.237',
  './js/today.js?v=3.3.237',
  './js/lift.js?v=3.3.237',
  './js/stats.js?v=3.3.237',
  './js/history.js?v=3.3.237',
  './js/settings.js?v=3.3.237',
  './js/app.js?v=3.3.237',
