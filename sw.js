const CACHE = 'showup-v3.3.61';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.61',
  './js/core.js?v=3.3.61',
  './js/derive.js?v=3.3.61',
  './js/util.js?v=3.3.61',
  './js/header.js?v=3.3.61',
  './js/report.js?v=3.3.61',
  './js/today.js?v=3.3.61',
  './js/lift.js?v=3.3.61',
  './js/stats.js?v=3.3.61',
  './js/history.js?v=3.3.61',
  './js/settings.js?v=3.3.61',
  './js/app.js?v=3.3.61',
  './icon-192.png',
  './icon-512.png',
