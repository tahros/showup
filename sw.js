const CACHE = 'showup-v4.6.56';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.56',
  './css/planner.css?v=4.6.56',
  './css/mascot.css?v=4.6.56',
  './js/mascot.js?v=4.6.56',
  './js/plates.js?v=4.6.56',
  './js/plate-canvas.js?v=4.6.56',
  './css/plates.css?v=4.6.56',
  ...
  './js/core.js?v=4.6.56',
  './js/derive.js?v=4.6.56',
  './js/util.js?v=4.6.56',
  './js/planlink.js?v=4.6.56',
  './js/realset.js?v=4.6.56',
  './js/reprange.js?v=4.6.56',
  './js/verdict.js?v=4.6.56',
  './js/header.js?v=4.6.56',
  './js/report.js?v=4.6.56',
  './js/today.js?v=4.6.56',
  './js/progression.js?v=4.6.56',
  './js/lift.js?v=4.6.56',
  './js/writer.js?v=4.6.56',
  './js/planner.js?v=4.6.56',
  './js/planner-flow.js?v=4.6.56',
  './css/planner-flow.css?v=4.6.56',
  './js/stats.js?v=4.6.56',
  './js/history.js?v=4.6.56',
  './js/settings.js?v=4.6.56',
  './js/stats-story.js?v=4.6.56',
  './js/app.js?v=4.6.56',
