const CACHE = 'showup-v4.6.39';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.39',
  './css/planner.css?v=4.6.39',
  './css/mascot.css?v=4.6.39',
  './js/mascot.js?v=4.6.39',
  './js/plates.js?v=4.6.39',
  './js/plate-canvas.js?v=4.6.39',
  './css/plates.css?v=4.6.39',
  ...
  './js/core.js?v=4.6.39',
  './js/derive.js?v=4.6.39',
  './js/util.js?v=4.6.39',
  './js/planlink.js?v=4.6.39',
  './js/realset.js?v=4.6.39',
  './js/reprange.js?v=4.6.39',
  './js/verdict.js?v=4.6.39',
  './js/header.js?v=4.6.39',
  './js/report.js?v=4.6.39',
  './js/today.js?v=4.6.39',
  './js/progression.js?v=4.6.39',
  './js/lift.js?v=4.6.39',
  './js/writer.js?v=4.6.39',
  './js/planner.js?v=4.6.39',
  './js/planner-flow.js?v=4.6.39',
  './css/planner-flow.css?v=4.6.39',
  './js/stats.js?v=4.6.39',
  './js/history.js?v=4.6.39',
  './js/settings.js?v=4.6.39',
  './js/stats-story.js?v=4.6.39',
  './js/app.js?v=4.6.39',
