const CACHE = 'showup-v3.3.272';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.272',
  './js/core.js?v=3.3.272',
  './js/derive.js?v=3.3.272',
  './js/util.js?v=3.3.272',
  './js/header.js?v=3.3.272',
  './js/report.js?v=3.3.272',
  './js/today.js?v=3.3.272',
  './js/lift.js?v=3.3.272',
  './js/stats.js?v=3.3.272',
  './js/history.js?v=3.3.272',
  './js/settings.js?v=3.3.272',
  './js/app.js?v=3.3.272',
