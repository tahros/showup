const CACHE = 'showup-v3.3.306';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.306',
  './js/core.js?v=3.3.306',
  './js/derive.js?v=3.3.306',
  './js/util.js?v=3.3.306',
  './js/header.js?v=3.3.306',
  './js/report.js?v=3.3.306',
  './js/today.js?v=3.3.306',
  './js/lift.js?v=3.3.306',
  './js/stats.js?v=3.3.306',
  './js/history.js?v=3.3.306',
  './js/settings.js?v=3.3.306',
  './js/app.js?v=3.3.306',
