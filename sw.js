const CACHE = 'showup-v4.6.72';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.72',
  './css/planner.css?v=4.6.72',
  './css/mascot.css?v=4.6.72',
  './js/mascot.js?v=4.6.72',
  './js/plates.js?v=4.6.72',
  './js/plate-canvas.js?v=4.6.72',
  './css/plates.css?v=4.6.72',
  ...
  './js/core.js?v=4.6.72',
  './js/derive.js?v=4.6.72',
  './js/util.js?v=4.6.72',
  './js/planlink.js?v=4.6.72',
  './js/realset.js?v=4.6.72',
  './js/reprange.js?v=4.6.72',
  './js/verdict.js?v=4.6.72',
  './js/header.js?v=4.6.72',
  './js/report.js?v=4.6.72',
  './js/today.js?v=4.6.72',
  './js/progression.js?v=4.6.72',
  './js/lift.js?v=4.6.72',
  './js/writer.js?v=4.6.72',
  './js/planner.js?v=4.6.72',
  './js/planner-flow.js?v=4.6.72',
  './css/planner-flow.css?v=4.6.72',
  './js/stats.js?v=4.6.72',
  './js/history.js?v=4.6.72',
  './js/settings.js?v=4.6.72',
  './js/stats-story.js?v=4.6.72',
  './js/app.js?v=4.6.72',
