const CACHE = 'showup-v4.5.20';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.5.20',
  './css/planner.css?v=4.5.20',
  './css/mascot.css?v=4.5.20',
  './js/mascot.js?v=4.5.20',
  './js/plates.js?v=4.5.20',
  './js/plate-canvas.js?v=4.5.20',
  './css/plates.css?v=4.5.20',
  ...
  './js/core.js?v=4.5.20',
  './js/derive.js?v=4.5.20',
  './js/util.js?v=4.5.20',
  './js/realset.js?v=4.5.20',
  './js/reprange.js?v=4.5.20',
  './js/verdict.js?v=4.5.20',
  './js/header.js?v=4.5.20',
  './js/report.js?v=4.5.20',
  './js/today.js?v=4.5.20',
  './js/progression.js?v=4.5.20',
  './js/lift.js?v=4.5.20',
  './js/writer.js?v=4.5.20',
  './js/planner.js?v=4.5.20',
  './js/stats.js?v=4.5.20',
  './js/history.js?v=4.5.20',
  './js/settings.js?v=4.5.20',
  './js/stats-story.js?v=4.5.20',
  './js/app.js?v=4.5.20',
