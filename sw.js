const CACHE = 'showup-v4.6.82';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.82',
  './css/planner.css?v=4.6.82',
  './css/mascot.css?v=4.6.82',
  './js/mascot.js?v=4.6.82',
  './js/plates.js?v=4.6.82',
  './js/plate-canvas.js?v=4.6.82',
  './css/plates.css?v=4.6.82',
  ...
  './js/core.js?v=4.6.82',
  './js/derive.js?v=4.6.82',
  './js/util.js?v=4.6.82',
  './js/planlink.js?v=4.6.82',
  './js/realset.js?v=4.6.82',
  './js/reprange.js?v=4.6.82',
  './js/verdict.js?v=4.6.82',
  './js/header.js?v=4.6.82',
  './js/report.js?v=4.6.82',
  './js/today.js?v=4.6.82',
  './js/progression.js?v=4.6.82',
  './js/lift.js?v=4.6.82',
  './js/writer.js?v=4.6.82',
  './js/planner.js?v=4.6.82',
  './js/planner-flow.js?v=4.6.82',
  './css/planner-flow.css?v=4.6.82',
  './js/stats.js?v=4.6.82',
  './js/history.js?v=4.6.82',
  './js/settings.js?v=4.6.82',
  './js/stats-story.js?v=4.6.82',
  './js/app.js?v=4.6.82',
