const CACHE = 'showup-v3.3.292';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.292',
  './js/core.js?v=3.3.292',
  './js/derive.js?v=3.3.292',
  './js/util.js?v=3.3.292',
  './js/header.js?v=3.3.292',
  './js/report.js?v=3.3.292',
  './js/today.js?v=3.3.292',
  './js/lift.js?v=3.3.292',
  './js/stats.js?v=3.3.292',
  './js/history.js?v=3.3.292',
  './js/settings.js?v=3.3.292',
  './js/app.js?v=3.3.292',
