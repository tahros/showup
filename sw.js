...
const SHELL = [
  ...
  './js/core.js?v=3.3.95',
  './js/derive.js?v=3.3.95',
  './js/util.js?v=3.3.95',
  './js/header.js?v=3.3.95',
  './js/report.js?v=3.3.95',
  './js/today.js?v=3.3.95',
  './js/lift.js?v=3.3.95',
  './js/stats.js?v=3.3.95',
  './js/history.js?v=3.3.95',
  './js/settings.js?v=3.3.95',
  './js/app.js?v=3.3.95',
  './icon-192.png',
  './icon-512.png',
