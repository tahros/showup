const CACHE = 'showup-v4.6.52';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.52',
  './css/planner.css?v=4.6.52',
  './css/mascot.css?v=4.6.52',
  './js/mascot.js?v=4.6.52',
  './js/plates.js?v=4.6.52',
  './js/plate-canvas.js?v=4.6.52',
  './css/plates.css?v=4.6.52',
  ...
  './js/core.js?v=4.6.52',
  './js/derive.js?v=4.6.52',
  './js/util.js?v=4.6.52',
  './js/planlink.js?v=4.6.52',
  './js/realset.js?v=4.6.52',
  './js/reprange.js?v=4.6.52',
  './js/verdict.js?v=4.6.52',
  './js/header.js?v=4.6.52',
  './js/report.js?v=4.6.52',
  './js/today.js?v=4.6.52',
  './js/progression.js?v=4.6.52',
  './js/lift.js?v=4.6.52',
  './js/writer.js?v=4.6.52',
  './js/planner.js?v=4.6.52',
  './js/planner-flow.js?v=4.6.52',
  './css/planner-flow.css?v=4.6.52',
  './js/stats.js?v=4.6.52',
  './js/history.js?v=4.6.52',
  './js/settings.js?v=4.6.52',
  './js/stats-story.js?v=4.6.52',
  './js/app.js?v=4.6.52',
