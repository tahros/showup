...
const SHELL = [
  ...
  './js/core.js?v=3.3.47',
  './js/derive.js?v=3.3.47',
  './js/util.js?v=3.3.47',
  './js/header.js?v=3.3.47',
  './js/report.js?v=3.3.47',
  './js/today.js?v=3.3.47',
  './js/lift.js?v=3.3.47',
  './js/stats.js?v=3.3.47',
  './js/history.js?v=3.3.47',
  './js/settings.js?v=3.3.47',
  './js/app.js?v=3.3.47',
  './icon-192.png',
  './icon-512.png',
