const CACHE = 'showup-v3.3.167';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.167',
  './js/core.js?v=3.3.167',
  './js/derive.js?v=3.3.167',
  './js/util.js?v=3.3.167',
  './js/header.js?v=3.3.167',
  './js/report.js?v=3.3.167',
  './js/today.js?v=3.3.167',
  './js/lift.js?v=3.3.167',
  './js/stats.js?v=3.3.167',
  './js/history.js?v=3.3.167',
  './js/settings.js?v=3.3.167',
  './js/app.js?v=3.3.167',
  './icon-192.png',
  './icon-512.png',
