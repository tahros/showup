const CACHE = 'showup-v3.3.15';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.15',
  './js/core.js?v=3.3.15',
  './js/derive.js?v=3.3.15',
  './js/util.js?v=3.3.15',
  './js/header.js?v=3.3.15',
  './js/report.js?v=3.3.15',
  './js/today.js?v=3.3.15',
  './js/lift.js?v=3.3.15',
  './js/stats.js?v=3.3.15',
  './js/history.js?v=3.3.15',
  './js/settings.js?v=3.3.15',
  './js/app.js?v=3.3.15',
  './icon-192.png',
  './icon-512.png',
