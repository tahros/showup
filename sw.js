const CACHE = 'showup-v4.6.21';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.21',
  './css/planner.css?v=4.6.21',
  './css/mascot.css?v=4.6.21',
  './js/mascot.js?v=4.6.21',
  './js/plates.js?v=4.6.21',
  './js/plate-canvas.js?v=4.6.21',
  './css/plates.css?v=4.6.21',
  ...
  './js/core.js?v=4.6.21',
  './js/derive.js?v=4.6.21',
  './js/util.js?v=4.6.21',
  './js/planlink.js?v=4.6.21',
  './js/realset.js?v=4.6.21',
  './js/reprange.js?v=4.6.21',
  './js/verdict.js?v=4.6.21',
  './js/header.js?v=4.6.21',
  './js/report.js?v=4.6.21',
  './js/today.js?v=4.6.21',
  './js/progression.js?v=4.6.21',
  './js/lift.js?v=4.6.21',
  './js/writer.js?v=4.6.21',
  './js/planner.js?v=4.6.21',
  './js/planner-flow.js?v=4.6.21',
  './css/planner-flow.css?v=4.6.21',
  './js/stats.js?v=4.6.21',
  './js/history.js?v=4.6.21',
  './js/settings.js?v=4.6.21',
  './js/stats-story.js?v=4.6.21',
  './js/app.js?v=4.6.21',
