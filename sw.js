const CACHE = 'showup-v4.6.25';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.25',
  './css/planner.css?v=4.6.25',
  './css/mascot.css?v=4.6.25',
  './js/mascot.js?v=4.6.25',
  './js/plates.js?v=4.6.25',
  './js/plate-canvas.js?v=4.6.25',
  './css/plates.css?v=4.6.25',
  ...
  './js/core.js?v=4.6.25',
  './js/derive.js?v=4.6.25',
  './js/util.js?v=4.6.25',
  './js/planlink.js?v=4.6.25',
  './js/realset.js?v=4.6.25',
  './js/reprange.js?v=4.6.25',
  './js/verdict.js?v=4.6.25',
  './js/header.js?v=4.6.25',
  './js/report.js?v=4.6.25',
  './js/today.js?v=4.6.25',
  './js/progression.js?v=4.6.25',
  './js/lift.js?v=4.6.25',
  './js/writer.js?v=4.6.25',
  './js/planner.js?v=4.6.25',
  './js/planner-flow.js?v=4.6.25',
  './css/planner-flow.css?v=4.6.25',
  './js/stats.js?v=4.6.25',
  './js/history.js?v=4.6.25',
  './js/settings.js?v=4.6.25',
  './js/stats-story.js?v=4.6.25',
  './js/app.js?v=4.6.25',
