const CACHE = 'showup-v3.3.402';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.402',
  './js/core.js?v=3.3.402',
  './js/derive.js?v=3.3.402',
  './js/util.js?v=3.3.402',
  './js/header.js?v=3.3.402',
  './js/report.js?v=3.3.402',
  './js/today.js?v=3.3.402',
  './js/lift.js?v=3.3.402',
  './js/writer.js?v=3.3.402',
  './js/stats.js?v=3.3.402',
  './js/history.js?v=3.3.402',
  './js/settings.js?v=3.3.402',
  './js/app.js?v=3.3.402',
