const CACHE = 'showup-v3.3.194';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.194',
  './js/core.js?v=3.3.194',
  './js/derive.js?v=3.3.194',
  './js/util.js?v=3.3.194',
  './js/header.js?v=3.3.194',
  './js/report.js?v=3.3.194',
  './js/today.js?v=3.3.194',
  './js/lift.js?v=3.3.194',
  './js/stats.js?v=3.3.194',
  './js/history.js?v=3.3.194',
  './js/settings.js?v=3.3.194',
  './js/app.js?v=3.3.194',
  './icon-192.png',
  './icon-512.png',
