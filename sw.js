const CACHE = 'showup-v3.3.56';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.56',
  './js/core.js?v=3.3.56',
  './js/derive.js?v=3.3.56',
  './js/util.js?v=3.3.56',
  './js/header.js?v=3.3.56',
  './js/report.js?v=3.3.56',
  './js/today.js?v=3.3.56',
  './js/lift.js?v=3.3.56',
  './js/stats.js?v=3.3.56',
  './js/history.js?v=3.3.56',
  './js/settings.js?v=3.3.56',
  './js/app.js?v=3.3.56',
  './icon-192.png',
  './icon-512.png',
