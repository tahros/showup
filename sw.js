const CACHE = 'showup-v3.3.538';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.538',
  './js/core.js?v=3.3.538',
  './js/derive.js?v=3.3.538',
  './js/util.js?v=3.3.538',
  './js/header.js?v=3.3.538',
  './js/report.js?v=3.3.538',
  './js/today.js?v=3.3.538',
  './js/progression.js?v=3.3.538',
  './js/lift.js?v=3.3.538',
  './js/writer.js?v=3.3.538',
  './js/stats.js?v=3.3.538',
  './js/history.js?v=3.3.538',
  './js/settings.js?v=3.3.538',
  './js/app.js?v=3.3.538',
