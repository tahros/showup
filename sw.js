const CACHE = 'showup-v3.3.132';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.132',
  './js/core.js?v=3.3.132',
  './js/derive.js?v=3.3.132',
  './js/util.js?v=3.3.132',
  './js/header.js?v=3.3.132',
  './js/report.js?v=3.3.132',
  './js/today.js?v=3.3.132',
  './js/lift.js?v=3.3.132',
  './js/stats.js?v=3.3.132',
  './js/history.js?v=3.3.132',
  './js/settings.js?v=3.3.132',
  './js/app.js?v=3.3.132',
  './icon-192.png',
  './icon-512.png',
