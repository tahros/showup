const CACHE = 'showup-v3.3.187';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.187',
  './js/core.js?v=3.3.187',
  './js/derive.js?v=3.3.187',
  './js/util.js?v=3.3.187',
  './js/header.js?v=3.3.187',
  './js/report.js?v=3.3.187',
  './js/today.js?v=3.3.187',
  './js/lift.js?v=3.3.187',
  './js/stats.js?v=3.3.187',
  './js/history.js?v=3.3.187',
  './js/settings.js?v=3.3.187',
  './js/app.js?v=3.3.187',
  './icon-192.png',
  './icon-512.png',
