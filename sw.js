const CACHE = 'showup-v4.6.17';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.17',
  './css/planner.css?v=4.6.17',
  './css/mascot.css?v=4.6.17',
  './js/mascot.js?v=4.6.17',
  './js/plates.js?v=4.6.17',
  './js/plate-canvas.js?v=4.6.17',
  './css/plates.css?v=4.6.17',
  ...
  './js/core.js?v=4.6.17',
  './js/derive.js?v=4.6.17',
  './js/util.js?v=4.6.17',
  './js/planlink.js?v=4.6.17',
  './js/realset.js?v=4.6.17',
  './js/reprange.js?v=4.6.17',
  './js/verdict.js?v=4.6.17',
  './js/header.js?v=4.6.17',
  './js/report.js?v=4.6.17',
  './js/today.js?v=4.6.17',
  './js/progression.js?v=4.6.17',
  './js/lift.js?v=4.6.17',
  './js/writer.js?v=4.6.17',
  './js/planner.js?v=4.6.17',
  './js/planner-flow.js?v=4.6.17',
  './css/planner-flow.css?v=4.6.17',
  './js/stats.js?v=4.6.17',
  './js/history.js?v=4.6.17',
  './js/settings.js?v=4.6.17',
  './js/stats-story.js?v=4.6.17',
  './js/app.js?v=4.6.17',
