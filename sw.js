const CACHE = 'showup-v3.3.224';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.224',
  './js/core.js?v=3.3.224',
  './js/derive.js?v=3.3.224',
  './js/util.js?v=3.3.224',
  './js/header.js?v=3.3.224',
  './js/report.js?v=3.3.224',
  './js/today.js?v=3.3.224',
  './js/lift.js?v=3.3.224',
  './js/stats.js?v=3.3.224',
  './js/history.js?v=3.3.224',
  './js/settings.js?v=3.3.224',
  './js/app.js?v=3.3.224',
