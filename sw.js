const CACHE = 'showup-v3.3.220';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.220',
  './js/core.js?v=3.3.220',
  './js/derive.js?v=3.3.220',
  './js/util.js?v=3.3.220',
  './js/header.js?v=3.3.220',
  './js/report.js?v=3.3.220',
  './js/today.js?v=3.3.220',
  './js/lift.js?v=3.3.220',
  './js/stats.js?v=3.3.220',
  './js/history.js?v=3.3.220',
  './js/settings.js?v=3.3.220',
  './js/app.js?v=3.3.220',
