const CACHE = 'showup-v3.3.140';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.140',
  './js/core.js?v=3.3.140',
  './js/derive.js?v=3.3.140',
  './js/util.js?v=3.3.140',
  './js/header.js?v=3.3.140',
  './js/report.js?v=3.3.140',
  './js/today.js?v=3.3.140',
  './js/lift.js?v=3.3.140',
  './js/stats.js?v=3.3.140',
  './js/history.js?v=3.3.140',
  './js/settings.js?v=3.3.140',
  './js/app.js?v=3.3.140',
  './icon-192.png',
  './icon-512.png',
