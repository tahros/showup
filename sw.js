const CACHE = 'showup-v3.3.389';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.389',
  './js/core.js?v=3.3.389',
  './js/derive.js?v=3.3.389',
  './js/util.js?v=3.3.389',
  './js/header.js?v=3.3.389',
  './js/report.js?v=3.3.389',
  './js/today.js?v=3.3.389',
  './js/lift.js?v=3.3.389',
  './js/stats.js?v=3.3.389',
  './js/history.js?v=3.3.389',
  './js/settings.js?v=3.3.389',
  './js/app.js?v=3.3.389',
