const CACHE = 'showup-v3.3.253';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.253',
  './js/core.js?v=3.3.253',
  './js/derive.js?v=3.3.253',
  './js/util.js?v=3.3.253',
  './js/header.js?v=3.3.253',
  './js/report.js?v=3.3.253',
  './js/today.js?v=3.3.253',
  './js/lift.js?v=3.3.253',
  './js/stats.js?v=3.3.253',
  './js/history.js?v=3.3.253',
  './js/settings.js?v=3.3.253',
  './js/app.js?v=3.3.253',
