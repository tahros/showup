const CACHE = 'showup-v4.6.96';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.96',
  './css/planner.css?v=4.6.96',
  './css/mascot.css?v=4.6.96',
  './js/retro.js?v=4.6.96',
  './css/retro.css?v=4.6.96',
  './js/mascot.js?v=4.6.96',
  './js/plates.js?v=4.6.96',
  './js/plate-canvas.js?v=4.6.96',
  './css/plates.css?v=4.6.96',
  ...
  './js/core.js?v=4.6.96',
  './js/derive.js?v=4.6.96',
  './js/util.js?v=4.6.96',
  './js/planlink.js?v=4.6.96',
  './js/realset.js?v=4.6.96',
  './js/reprange.js?v=4.6.96',
  './js/verdict.js?v=4.6.96',
  './js/header.js?v=4.6.96',
  './js/report.js?v=4.6.96',
  './js/today.js?v=4.6.96',
  './js/progression.js?v=4.6.96',
  './js/lift.js?v=4.6.96',
  './js/writer.js?v=4.6.96',
  './js/planner.js?v=4.6.96',
  './js/planner-flow.js?v=4.6.96',
  './css/planner-flow.css?v=4.6.96',
  './js/stats.js?v=4.6.96',
  './js/history.js?v=4.6.96',
  './js/settings.js?v=4.6.96',
  './js/stats-story.js?v=4.6.96',
  './js/app.js?v=4.6.96',
