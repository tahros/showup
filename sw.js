const CACHE = 'showup-v4.6.65';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.65',
  './css/planner.css?v=4.6.65',
  './css/mascot.css?v=4.6.65',
  './js/mascot.js?v=4.6.65',
  './js/plates.js?v=4.6.65',
  './js/plate-canvas.js?v=4.6.65',
  './css/plates.css?v=4.6.65',
  ...
  './js/core.js?v=4.6.65',
  './js/derive.js?v=4.6.65',
  './js/util.js?v=4.6.65',
  './js/planlink.js?v=4.6.65',
  './js/realset.js?v=4.6.65',
  './js/reprange.js?v=4.6.65',
  './js/verdict.js?v=4.6.65',
  './js/header.js?v=4.6.65',
  './js/report.js?v=4.6.65',
  './js/today.js?v=4.6.65',
  './js/progression.js?v=4.6.65',
  './js/lift.js?v=4.6.65',
  './js/writer.js?v=4.6.65',
  './js/planner.js?v=4.6.65',
  './js/planner-flow.js?v=4.6.65',
  './css/planner-flow.css?v=4.6.65',
  './js/stats.js?v=4.6.65',
  './js/history.js?v=4.6.65',
  './js/settings.js?v=4.6.65',
  './js/stats-story.js?v=4.6.65',
  './js/app.js?v=4.6.65',
