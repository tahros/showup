const CACHE = 'showup-v3.3.44';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.44',
  './js/core.js?v=3.3.44',
  './js/derive.js?v=3.3.44',
  './js/util.js?v=3.3.44',
  './js/header.js?v=3.3.44',
  './js/report.js?v=3.3.44',
  './js/today.js?v=3.3.44',
  './js/lift.js?v=3.3.44',
  './js/stats.js?v=3.3.44',
  './js/history.js?v=3.3.44',
  './js/settings.js?v=3.3.44',
  './js/app.js?v=3.3.44',
  './icon-192.png',
  './icon-512.png',
