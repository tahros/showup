const CACHE = 'showup-v4.6.47';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.47',
  './css/planner.css?v=4.6.47',
  './css/mascot.css?v=4.6.47',
  './js/mascot.js?v=4.6.47',
  './js/plates.js?v=4.6.47',
  './js/plate-canvas.js?v=4.6.47',
  './css/plates.css?v=4.6.47',
  ...
  './js/core.js?v=4.6.47',
  './js/derive.js?v=4.6.47',
  './js/util.js?v=4.6.47',
  './js/planlink.js?v=4.6.47',
  './js/realset.js?v=4.6.47',
  './js/reprange.js?v=4.6.47',
  './js/verdict.js?v=4.6.47',
  './js/header.js?v=4.6.47',
  './js/report.js?v=4.6.47',
  './js/today.js?v=4.6.47',
  './js/progression.js?v=4.6.47',
  './js/lift.js?v=4.6.47',
  './js/writer.js?v=4.6.47',
  './js/planner.js?v=4.6.47',
  './js/planner-flow.js?v=4.6.47',
  './css/planner-flow.css?v=4.6.47',
  './js/stats.js?v=4.6.47',
  './js/history.js?v=4.6.47',
  './js/settings.js?v=4.6.47',
  './js/stats-story.js?v=4.6.47',
  './js/app.js?v=4.6.47',
