const CACHE = 'showup-v3.3.309';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.309',
  './js/core.js?v=3.3.309',
  './js/derive.js?v=3.3.309',
  './js/util.js?v=3.3.309',
  './js/header.js?v=3.3.309',
  './js/report.js?v=3.3.309',
  './js/today.js?v=3.3.309',
  './js/lift.js?v=3.3.309',
  './js/stats.js?v=3.3.309',
  './js/history.js?v=3.3.309',
  './js/settings.js?v=3.3.309',
  './js/app.js?v=3.3.309',
