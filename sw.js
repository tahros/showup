const CACHE = 'showup-v3.3.305';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.305',
  './js/core.js?v=3.3.305',
  './js/derive.js?v=3.3.305',
  './js/util.js?v=3.3.305',
  './js/header.js?v=3.3.305',
  './js/report.js?v=3.3.305',
  './js/today.js?v=3.3.305',
  './js/lift.js?v=3.3.305',
  './js/stats.js?v=3.3.305',
  './js/history.js?v=3.3.305',
  './js/settings.js?v=3.3.305',
  './js/app.js?v=3.3.305',
