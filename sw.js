const CACHE = 'showup-v4.5.33';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.5.33',
  './css/planner.css?v=4.5.33',
  './css/mascot.css?v=4.5.33',
  './js/mascot.js?v=4.5.33',
  './js/plates.js?v=4.5.33',
  './js/plate-canvas.js?v=4.5.33',
  './css/plates.css?v=4.5.33',
  ...
  './js/core.js?v=4.5.33',
  './js/derive.js?v=4.5.33',
  './js/util.js?v=4.5.33',
  './js/realset.js?v=4.5.33',
  './js/reprange.js?v=4.5.33',
  './js/verdict.js?v=4.5.33',
  './js/header.js?v=4.5.33',
  './js/report.js?v=4.5.33',
  './js/today.js?v=4.5.33',
  './js/progression.js?v=4.5.33',
  './js/lift.js?v=4.5.33',
  './js/writer.js?v=4.5.33',
  './js/planner.js?v=4.5.33',
  './js/stats.js?v=4.5.33',
  './js/history.js?v=4.5.33',
  './js/settings.js?v=4.5.33',
  './js/stats-story.js?v=4.5.33',
  './js/app.js?v=4.5.33',
