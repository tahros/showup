const CACHE = 'showup-v3.3.211';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.211',
  './js/core.js?v=3.3.211',
  './js/derive.js?v=3.3.211',
  './js/util.js?v=3.3.211',
  './js/header.js?v=3.3.211',
  './js/report.js?v=3.3.211',
  './js/today.js?v=3.3.211',
  './js/lift.js?v=3.3.211',
  './js/stats.js?v=3.3.211',
  './js/history.js?v=3.3.211',
  './js/settings.js?v=3.3.211',
  './js/app.js?v=3.3.211',
