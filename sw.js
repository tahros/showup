const CACHE = 'showup-v3.3.228';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.228',
  './js/core.js?v=3.3.228',
  './js/derive.js?v=3.3.228',
  './js/util.js?v=3.3.228',
  './js/header.js?v=3.3.228',
  './js/report.js?v=3.3.228',
  './js/today.js?v=3.3.228',
  './js/lift.js?v=3.3.228',
  './js/stats.js?v=3.3.228',
  './js/history.js?v=3.3.228',
  './js/settings.js?v=3.3.228',
  './js/app.js?v=3.3.228',
