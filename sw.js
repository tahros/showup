const CACHE = 'showup-v3.3.364';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.364',
  './js/core.js?v=3.3.364',
  './js/derive.js?v=3.3.364',
  './js/util.js?v=3.3.364',
  './js/header.js?v=3.3.364',
  './js/report.js?v=3.3.364',
  './js/today.js?v=3.3.364',
  './js/lift.js?v=3.3.364',
  './js/stats.js?v=3.3.364',
  './js/history.js?v=3.3.364',
  './js/settings.js?v=3.3.364',
  './js/app.js?v=3.3.364',
