const CACHE = 'showup-v3.3.382';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.382',
  './js/core.js?v=3.3.382',
  './js/derive.js?v=3.3.382',
  './js/util.js?v=3.3.382',
  './js/header.js?v=3.3.382',
  './js/report.js?v=3.3.382',
  './js/today.js?v=3.3.382',
  './js/lift.js?v=3.3.382',
  './js/stats.js?v=3.3.382',
  './js/history.js?v=3.3.382',
  './js/settings.js?v=3.3.382',
  './js/app.js?v=3.3.382',
