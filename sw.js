const CACHE = 'showup-v4.6.99';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.99',
  './css/planner.css?v=4.6.99',
  './css/mascot.css?v=4.6.99',
  './js/retro.js?v=4.6.99',
  './css/retro.css?v=4.6.99',
  './js/mascot.js?v=4.6.99',
  './js/plates.js?v=4.6.99',
  './js/plate-canvas.js?v=4.6.99',
  './css/plates.css?v=4.6.99',
  ...
  './js/core.js?v=4.6.99',
  './js/derive.js?v=4.6.99',
  './js/util.js?v=4.6.99',
  './js/planlink.js?v=4.6.99',
  './js/realset.js?v=4.6.99',
  './js/reprange.js?v=4.6.99',
  './js/verdict.js?v=4.6.99',
  './js/header.js?v=4.6.99',
  './js/report.js?v=4.6.99',
  './js/today.js?v=4.6.99',
  './js/progression.js?v=4.6.99',
  './js/lift.js?v=4.6.99',
  './js/writer.js?v=4.6.99',
  './js/planner.js?v=4.6.99',
  './js/planner-flow.js?v=4.6.99',
  './css/planner-flow.css?v=4.6.99',
  './js/stats.js?v=4.6.99',
  './js/history.js?v=4.6.99',
  './js/settings.js?v=4.6.99',
  './js/stats-story.js?v=4.6.99',
  './js/app.js?v=4.6.99',
