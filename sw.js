const CACHE = 'showup-v3.3.344';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.344',
  './js/core.js?v=3.3.344',
  './js/derive.js?v=3.3.344',
  './js/util.js?v=3.3.344',
  './js/header.js?v=3.3.344',
  './js/report.js?v=3.3.344',
  './js/today.js?v=3.3.344',
  './js/lift.js?v=3.3.344',
  './js/stats.js?v=3.3.344',
  './js/history.js?v=3.3.344',
  './js/settings.js?v=3.3.344',
  './js/app.js?v=3.3.344',
