const CACHE = 'showup-v3.3.407';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.407',
  './js/core.js?v=3.3.407',
  './js/derive.js?v=3.3.407',
  './js/util.js?v=3.3.407',
  './js/header.js?v=3.3.407',
  './js/report.js?v=3.3.407',
  './js/today.js?v=3.3.407',
  './js/lift.js?v=3.3.407',
  './js/writer.js?v=3.3.407',
  './js/stats.js?v=3.3.407',
  './js/history.js?v=3.3.407',
  './js/settings.js?v=3.3.407',
  './js/app.js?v=3.3.407',
