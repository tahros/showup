const CACHE = 'showup-v3.3.134';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.134',
  './js/core.js?v=3.3.134',
  './js/derive.js?v=3.3.134',
  './js/util.js?v=3.3.134',
  './js/header.js?v=3.3.134',
  './js/report.js?v=3.3.134',
  './js/today.js?v=3.3.134',
  './js/lift.js?v=3.3.134',
  './js/stats.js?v=3.3.134',
  './js/history.js?v=3.3.134',
  './js/settings.js?v=3.3.134',
  './js/app.js?v=3.3.134',
  './icon-192.png',
  './icon-512.png',
