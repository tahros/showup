const CACHE = 'showup-v4.6.78';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.78',
  './css/planner.css?v=4.6.78',
  './css/mascot.css?v=4.6.78',
  './js/mascot.js?v=4.6.78',
  './js/plates.js?v=4.6.78',
  './js/plate-canvas.js?v=4.6.78',
  './css/plates.css?v=4.6.78',
  ...
  './js/core.js?v=4.6.78',
  './js/derive.js?v=4.6.78',
  './js/util.js?v=4.6.78',
  './js/planlink.js?v=4.6.78',
  './js/realset.js?v=4.6.78',
  './js/reprange.js?v=4.6.78',
  './js/verdict.js?v=4.6.78',
  './js/header.js?v=4.6.78',
  './js/report.js?v=4.6.78',
  './js/today.js?v=4.6.78',
  './js/progression.js?v=4.6.78',
  './js/lift.js?v=4.6.78',
  './js/writer.js?v=4.6.78',
  './js/planner.js?v=4.6.78',
  './js/planner-flow.js?v=4.6.78',
  './css/planner-flow.css?v=4.6.78',
  './js/stats.js?v=4.6.78',
  './js/history.js?v=4.6.78',
  './js/settings.js?v=4.6.78',
  './js/stats-story.js?v=4.6.78',
  './js/app.js?v=4.6.78',
