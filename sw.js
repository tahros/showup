const CACHE = 'showup-v3.3.229';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.229',
  './js/core.js?v=3.3.229',
  './js/derive.js?v=3.3.229',
  './js/util.js?v=3.3.229',
  './js/header.js?v=3.3.229',
  './js/report.js?v=3.3.229',
  './js/today.js?v=3.3.229',
  './js/lift.js?v=3.3.229',
  './js/stats.js?v=3.3.229',
  './js/history.js?v=3.3.229',
  './js/settings.js?v=3.3.229',
  './js/app.js?v=3.3.229',
