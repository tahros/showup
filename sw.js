const CACHE = 'showup-v4.6.51';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.51',
  './css/planner.css?v=4.6.51',
  './css/mascot.css?v=4.6.51',
  './js/mascot.js?v=4.6.51',
  './js/plates.js?v=4.6.51',
  './js/plate-canvas.js?v=4.6.51',
  './css/plates.css?v=4.6.51',
  ...
  './js/core.js?v=4.6.51',
  './js/derive.js?v=4.6.51',
  './js/util.js?v=4.6.51',
  './js/planlink.js?v=4.6.51',
  './js/realset.js?v=4.6.51',
  './js/reprange.js?v=4.6.51',
  './js/verdict.js?v=4.6.51',
  './js/header.js?v=4.6.51',
  './js/report.js?v=4.6.51',
  './js/today.js?v=4.6.51',
  './js/progression.js?v=4.6.51',
  './js/lift.js?v=4.6.51',
  './js/writer.js?v=4.6.51',
  './js/planner.js?v=4.6.51',
  './js/planner-flow.js?v=4.6.51',
  './css/planner-flow.css?v=4.6.51',
  './js/stats.js?v=4.6.51',
  './js/history.js?v=4.6.51',
  './js/settings.js?v=4.6.51',
  './js/stats-story.js?v=4.6.51',
  './js/app.js?v=4.6.51',
