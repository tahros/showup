const CACHE = 'showup-v3.3.281';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.281',
  './js/core.js?v=3.3.281',
  './js/derive.js?v=3.3.281',
  './js/util.js?v=3.3.281',
  './js/header.js?v=3.3.281',
  './js/report.js?v=3.3.281',
  './js/today.js?v=3.3.281',
  './js/lift.js?v=3.3.281',
  './js/stats.js?v=3.3.281',
  './js/history.js?v=3.3.281',
  './js/settings.js?v=3.3.281',
  './js/app.js?v=3.3.281',
