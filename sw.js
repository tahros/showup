const CACHE = 'showup-v3.3.346';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.346',
  './js/core.js?v=3.3.346',
  './js/derive.js?v=3.3.346',
  './js/util.js?v=3.3.346',
  './js/header.js?v=3.3.346',
  './js/report.js?v=3.3.346',
  './js/today.js?v=3.3.346',
  './js/lift.js?v=3.3.346',
  './js/stats.js?v=3.3.346',
  './js/history.js?v=3.3.346',
  './js/settings.js?v=3.3.346',
  './js/app.js?v=3.3.346',
