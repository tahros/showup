const CACHE = 'showup-v3.3.512';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.512',
  './js/core.js?v=3.3.512',
  './js/derive.js?v=3.3.512',
  './js/util.js?v=3.3.512',
  './js/header.js?v=3.3.512',
  './js/report.js?v=3.3.512',
  './js/today.js?v=3.3.512',
  './js/lift.js?v=3.3.512',
  './js/writer.js?v=3.3.512',
  './js/stats.js?v=3.3.512',
  './js/history.js?v=3.3.512',
  './js/settings.js?v=3.3.512',
  './js/app.js?v=3.3.512',
