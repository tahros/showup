const CACHE = 'showup-v3.3.391';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.391',
  './js/core.js?v=3.3.391',
  './js/derive.js?v=3.3.391',
  './js/util.js?v=3.3.391',
  './js/header.js?v=3.3.391',
  './js/report.js?v=3.3.391',
  './js/today.js?v=3.3.391',
  './js/lift.js?v=3.3.391',
  './js/stats.js?v=3.3.391',
  './js/history.js?v=3.3.391',
  './js/settings.js?v=3.3.391',
  './js/app.js?v=3.3.391',
