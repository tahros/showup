const CACHE = 'showup-v4.6.57';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.57',
  './css/planner.css?v=4.6.57',
  './css/mascot.css?v=4.6.57',
  './js/mascot.js?v=4.6.57',
  './js/plates.js?v=4.6.57',
  './js/plate-canvas.js?v=4.6.57',
  './css/plates.css?v=4.6.57',
  ...
  './js/core.js?v=4.6.57',
  './js/derive.js?v=4.6.57',
  './js/util.js?v=4.6.57',
  './js/planlink.js?v=4.6.57',
  './js/realset.js?v=4.6.57',
  './js/reprange.js?v=4.6.57',
  './js/verdict.js?v=4.6.57',
  './js/header.js?v=4.6.57',
  './js/report.js?v=4.6.57',
  './js/today.js?v=4.6.57',
  './js/progression.js?v=4.6.57',
  './js/lift.js?v=4.6.57',
  './js/writer.js?v=4.6.57',
  './js/planner.js?v=4.6.57',
  './js/planner-flow.js?v=4.6.57',
  './css/planner-flow.css?v=4.6.57',
  './js/stats.js?v=4.6.57',
  './js/history.js?v=4.6.57',
  './js/settings.js?v=4.6.57',
  './js/stats-story.js?v=4.6.57',
  './js/app.js?v=4.6.57',
