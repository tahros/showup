const CACHE = 'showup-v3.3.120';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.120',
  './js/core.js?v=3.3.120',
  './js/derive.js?v=3.3.120',
  './js/util.js?v=3.3.120',
  './js/header.js?v=3.3.120',
  './js/report.js?v=3.3.120',
  './js/today.js?v=3.3.120',
  './js/lift.js?v=3.3.120',
  './js/stats.js?v=3.3.120',
  './js/history.js?v=3.3.120',
  './js/settings.js?v=3.3.120',
  './js/app.js?v=3.3.120',
  './icon-192.png',
  './icon-512.png',
