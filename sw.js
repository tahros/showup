const CACHE = 'showup-v4.6.77';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.77',
  './css/planner.css?v=4.6.77',
  './css/mascot.css?v=4.6.77',
  './js/mascot.js?v=4.6.77',
  './js/plates.js?v=4.6.77',
  './js/plate-canvas.js?v=4.6.77',
  './css/plates.css?v=4.6.77',
  ...
  './js/core.js?v=4.6.77',
  './js/derive.js?v=4.6.77',
  './js/util.js?v=4.6.77',
  './js/planlink.js?v=4.6.77',
  './js/realset.js?v=4.6.77',
  './js/reprange.js?v=4.6.77',
  './js/verdict.js?v=4.6.77',
  './js/header.js?v=4.6.77',
  './js/report.js?v=4.6.77',
  './js/today.js?v=4.6.77',
  './js/progression.js?v=4.6.77',
  './js/lift.js?v=4.6.77',
  './js/writer.js?v=4.6.77',
  './js/planner.js?v=4.6.77',
  './js/planner-flow.js?v=4.6.77',
  './css/planner-flow.css?v=4.6.77',
  './js/stats.js?v=4.6.77',
  './js/history.js?v=4.6.77',
  './js/settings.js?v=4.6.77',
  './js/stats-story.js?v=4.6.77',
  './js/app.js?v=4.6.77',
