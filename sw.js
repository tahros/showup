const CACHE = 'showup-v3.3.100';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.100',
  './js/core.js?v=3.3.100',
  './js/derive.js?v=3.3.100',
  './js/util.js?v=3.3.100',
  './js/header.js?v=3.3.100',
  './js/report.js?v=3.3.100',
  './js/today.js?v=3.3.100',
  './js/lift.js?v=3.3.100',
  './js/stats.js?v=3.3.100',
  './js/history.js?v=3.3.100',
  './js/settings.js?v=3.3.100',
  './js/app.js?v=3.3.100',
  './icon-192.png',
  './icon-512.png',
