const CACHE = 'showup-v3.3.231';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.231',
  './js/core.js?v=3.3.231',
  './js/derive.js?v=3.3.231',
  './js/util.js?v=3.3.231',
  './js/header.js?v=3.3.231',
  './js/report.js?v=3.3.231',
  './js/today.js?v=3.3.231',
  './js/lift.js?v=3.3.231',
  './js/stats.js?v=3.3.231',
  './js/history.js?v=3.3.231',
  './js/settings.js?v=3.3.231',
  './js/app.js?v=3.3.231',
