const CACHE = 'showup-v3.3.57';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.57',
  './js/core.js?v=3.3.57',
  './js/derive.js?v=3.3.57',
  './js/util.js?v=3.3.57',
  './js/header.js?v=3.3.57',
  './js/report.js?v=3.3.57',
  './js/today.js?v=3.3.57',
  './js/lift.js?v=3.3.57',
  './js/stats.js?v=3.3.57',
  './js/history.js?v=3.3.57',
  './js/settings.js?v=3.3.57',
  './js/app.js?v=3.3.57',
  './icon-192.png',
  './icon-512.png',
