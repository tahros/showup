const CACHE = 'showup-v3.3.35';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.35',
  './js/core.js?v=3.3.35',
  './js/derive.js?v=3.3.35',
  './js/util.js?v=3.3.35',
  './js/header.js?v=3.3.35',
  './js/report.js?v=3.3.35',
  './js/today.js?v=3.3.35',
  './js/lift.js?v=3.3.35',
  './js/stats.js?v=3.3.35',
  './js/history.js?v=3.3.35',
  './js/settings.js?v=3.3.35',
  './js/app.js?v=3.3.35',
  './icon-192.png',
  './icon-512.png',
