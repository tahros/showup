const CACHE = 'showup-v3.3.542';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.542',
  './js/core.js?v=3.3.542',
  './js/derive.js?v=3.3.542',
  './js/util.js?v=3.3.542',
  './js/header.js?v=3.3.542',
  './js/report.js?v=3.3.542',
  './js/today.js?v=3.3.542',
  './js/progression.js?v=3.3.542',
  './js/lift.js?v=3.3.542',
  './js/writer.js?v=3.3.542',
  './js/stats.js?v=3.3.542',
  './js/history.js?v=3.3.542',
  './js/settings.js?v=3.3.542',
  './js/app.js?v=3.3.542',
