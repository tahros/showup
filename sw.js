const CACHE = 'showup-v3.3.69';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.69',
  './js/core.js?v=3.3.69',
  './js/derive.js?v=3.3.69',
  './js/util.js?v=3.3.69',
  './js/header.js?v=3.3.69',
  './js/report.js?v=3.3.69',
  './js/today.js?v=3.3.69',
  './js/lift.js?v=3.3.69',
  './js/stats.js?v=3.3.69',
  './js/history.js?v=3.3.69',
  './js/settings.js?v=3.3.69',
  './js/app.js?v=3.3.69',
  './icon-192.png',
  './icon-512.png',
