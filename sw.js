const CACHE = 'showup-v3.3.104';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.104',
  './js/core.js?v=3.3.104',
  './js/derive.js?v=3.3.104',
  './js/util.js?v=3.3.104',
  './js/header.js?v=3.3.104',
  './js/report.js?v=3.3.104',
  './js/today.js?v=3.3.104',
  './js/lift.js?v=3.3.104',
  './js/stats.js?v=3.3.104',
  './js/history.js?v=3.3.104',
  './js/settings.js?v=3.3.104',
  './js/app.js?v=3.3.104',
  './icon-192.png',
  './icon-512.png',
