const CACHE = 'showup-v3.3.540';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.540',
  './js/core.js?v=3.3.540',
  './js/derive.js?v=3.3.540',
  './js/util.js?v=3.3.540',
  './js/header.js?v=3.3.540',
  './js/report.js?v=3.3.540',
  './js/today.js?v=3.3.540',
  './js/progression.js?v=3.3.540',
  './js/lift.js?v=3.3.540',
  './js/writer.js?v=3.3.540',
  './js/stats.js?v=3.3.540',
  './js/history.js?v=3.3.540',
  './js/settings.js?v=3.3.540',
  './js/app.js?v=3.3.540',
