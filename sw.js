const CACHE = 'showup-v3.3.328';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.328',
  './js/core.js?v=3.3.328',
  './js/derive.js?v=3.3.328',
  './js/util.js?v=3.3.328',
  './js/header.js?v=3.3.328',
  './js/report.js?v=3.3.328',
  './js/today.js?v=3.3.328',
  './js/lift.js?v=3.3.328',
  './js/stats.js?v=3.3.328',
  './js/history.js?v=3.3.328',
  './js/settings.js?v=3.3.328',
  './js/app.js?v=3.3.328',
