const CACHE = 'showup-v4.6.74';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.74',
  './css/planner.css?v=4.6.74',
  './css/mascot.css?v=4.6.74',
  './js/mascot.js?v=4.6.74',
  './js/plates.js?v=4.6.74',
  './js/plate-canvas.js?v=4.6.74',
  './css/plates.css?v=4.6.74',
  ...
  './js/core.js?v=4.6.74',
  './js/derive.js?v=4.6.74',
  './js/util.js?v=4.6.74',
  './js/planlink.js?v=4.6.74',
  './js/realset.js?v=4.6.74',
  './js/reprange.js?v=4.6.74',
  './js/verdict.js?v=4.6.74',
  './js/header.js?v=4.6.74',
  './js/report.js?v=4.6.74',
  './js/today.js?v=4.6.74',
  './js/progression.js?v=4.6.74',
  './js/lift.js?v=4.6.74',
  './js/writer.js?v=4.6.74',
  './js/planner.js?v=4.6.74',
  './js/planner-flow.js?v=4.6.74',
  './css/planner-flow.css?v=4.6.74',
  './js/stats.js?v=4.6.74',
  './js/history.js?v=4.6.74',
  './js/settings.js?v=4.6.74',
  './js/stats-story.js?v=4.6.74',
  './js/app.js?v=4.6.74',
