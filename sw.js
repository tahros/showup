const CACHE = 'showup-v3.3.106';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.106',
  './js/core.js?v=3.3.106',
  './js/derive.js?v=3.3.106',
  './js/util.js?v=3.3.106',
  './js/header.js?v=3.3.106',
  './js/report.js?v=3.3.106',
  './js/today.js?v=3.3.106',
  './js/lift.js?v=3.3.106',
  './js/stats.js?v=3.3.106',
  './js/history.js?v=3.3.106',
  './js/settings.js?v=3.3.106',
  './js/app.js?v=3.3.106',
  './icon-192.png',
  './icon-512.png',
