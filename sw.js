const CACHE = 'showup-v4.5.10';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.5.10',
  './css/planner.css?v=4.5.10',
  './css/mascot.css?v=4.5.10',
  './js/mascot.js?v=4.5.10',
  './js/plates.js?v=4.5.10',
  './js/plate-canvas.js?v=4.5.10',
  './css/plates.css?v=4.5.10',
  ...
  './js/core.js?v=4.5.10',
  './js/derive.js?v=4.5.10',
  './js/util.js?v=4.5.10',
  './js/realset.js?v=4.5.10',
  './js/reprange.js?v=4.5.10',
  './js/verdict.js?v=4.5.10',
  './js/header.js?v=4.5.10',
  './js/report.js?v=4.5.10',
  './js/today.js?v=4.5.10',
  './js/progression.js?v=4.5.10',
  './js/lift.js?v=4.5.10',
  './js/writer.js?v=4.5.10',
  './js/planner.js?v=4.5.10',
  './js/stats.js?v=4.5.10',
  './js/history.js?v=4.5.10',
  './js/settings.js?v=4.5.10',
  './js/stats-story.js?v=4.5.10',
  './js/app.js?v=4.5.10',
