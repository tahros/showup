const CACHE = 'showup-v4.4.1';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.4.1',
  './css/planner.css?v=4.4.1',
  './css/mascot.css?v=4.4.1',
  './js/mascot.js?v=4.4.1',
  './js/plates.js?v=4.4.1',
  './js/plate-canvas.js?v=4.4.1',
  './css/plates.css?v=4.4.1',
  ...
  './js/core.js?v=4.4.1',
  './js/derive.js?v=4.4.1',
  './js/util.js?v=4.4.1',
  './js/realset.js?v=4.4.1',
  './js/reprange.js?v=4.4.1',
  './js/verdict.js?v=4.4.1',
  './js/header.js?v=4.4.1',
  './js/report.js?v=4.4.1',
  './js/today.js?v=4.4.1',
  './js/progression.js?v=4.4.1',
  './js/lift.js?v=4.4.1',
  './js/writer.js?v=4.4.1',
  './js/planner.js?v=4.4.1',
  './js/stats.js?v=4.4.1',
  './js/history.js?v=4.4.1',
  './js/settings.js?v=4.4.1',
  './js/stats-story.js?v=4.4.1',
  './js/app.js?v=4.4.1',
