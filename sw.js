const CACHE = 'showup-v3.3.135';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.135',
  './js/core.js?v=3.3.135',
  './js/derive.js?v=3.3.135',
  './js/util.js?v=3.3.135',
  './js/header.js?v=3.3.135',
  './js/report.js?v=3.3.135',
  './js/today.js?v=3.3.135',
  './js/lift.js?v=3.3.135',
  './js/stats.js?v=3.3.135',
  './js/history.js?v=3.3.135',
  './js/settings.js?v=3.3.135',
  './js/app.js?v=3.3.135',
  './icon-192.png',
  './icon-512.png',
