const CACHE = 'showup-v3.3.338';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.338',
  './js/core.js?v=3.3.338',
  './js/derive.js?v=3.3.338',
  './js/util.js?v=3.3.338',
  './js/header.js?v=3.3.338',
  './js/report.js?v=3.3.338',
  './js/today.js?v=3.3.338',
  './js/lift.js?v=3.3.338',
  './js/stats.js?v=3.3.338',
  './js/history.js?v=3.3.338',
  './js/settings.js?v=3.3.338',
  './js/app.js?v=3.3.338',
