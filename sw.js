const CACHE = 'showup-v3.3.539';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.539',
  './js/core.js?v=3.3.539',
  './js/derive.js?v=3.3.539',
  './js/util.js?v=3.3.539',
  './js/header.js?v=3.3.539',
  './js/report.js?v=3.3.539',
  './js/today.js?v=3.3.539',
  './js/progression.js?v=3.3.539',
  './js/lift.js?v=3.3.539',
  './js/writer.js?v=3.3.539',
  './js/stats.js?v=3.3.539',
  './js/history.js?v=3.3.539',
  './js/settings.js?v=3.3.539',
  './js/app.js?v=3.3.539',
