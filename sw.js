const CACHE = 'showup-v3.3.221';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.221',
  './js/core.js?v=3.3.221',
  './js/derive.js?v=3.3.221',
  './js/util.js?v=3.3.221',
  './js/header.js?v=3.3.221',
  './js/report.js?v=3.3.221',
  './js/today.js?v=3.3.221',
  './js/lift.js?v=3.3.221',
  './js/stats.js?v=3.3.221',
  './js/history.js?v=3.3.221',
  './js/settings.js?v=3.3.221',
  './js/app.js?v=3.3.221',
