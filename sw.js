const CACHE = 'showup-v3.3.217';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.217',
  './js/core.js?v=3.3.217',
  './js/derive.js?v=3.3.217',
  './js/util.js?v=3.3.217',
  './js/header.js?v=3.3.217',
  './js/report.js?v=3.3.217',
  './js/today.js?v=3.3.217',
  './js/lift.js?v=3.3.217',
  './js/stats.js?v=3.3.217',
  './js/history.js?v=3.3.217',
  './js/settings.js?v=3.3.217',
  './js/app.js?v=3.3.217',
