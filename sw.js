const CACHE = 'showup-v3.3.339';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.339',
  './js/core.js?v=3.3.339',
  './js/derive.js?v=3.3.339',
  './js/util.js?v=3.3.339',
  './js/header.js?v=3.3.339',
  './js/report.js?v=3.3.339',
  './js/today.js?v=3.3.339',
  './js/lift.js?v=3.3.339',
  './js/stats.js?v=3.3.339',
  './js/history.js?v=3.3.339',
  './js/settings.js?v=3.3.339',
  './js/app.js?v=3.3.339',
