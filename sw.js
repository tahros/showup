const CACHE = 'showup-v3.3.191';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.191',
  './js/core.js?v=3.3.191',
  './js/derive.js?v=3.3.191',
  './js/util.js?v=3.3.191',
  './js/header.js?v=3.3.191',
  './js/report.js?v=3.3.191',
  './js/today.js?v=3.3.191',
  './js/lift.js?v=3.3.191',
  './js/stats.js?v=3.3.191',
  './js/history.js?v=3.3.191',
  './js/settings.js?v=3.3.191',
  './js/app.js?v=3.3.191',
  './icon-192.png',
  './icon-512.png',
