const CACHE = 'showup-v3.3.262';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.262',
  './js/core.js?v=3.3.262',
  './js/derive.js?v=3.3.262',
  './js/util.js?v=3.3.262',
  './js/header.js?v=3.3.262',
  './js/report.js?v=3.3.262',
  './js/today.js?v=3.3.262',
  './js/lift.js?v=3.3.262',
  './js/stats.js?v=3.3.262',
  './js/history.js?v=3.3.262',
  './js/settings.js?v=3.3.262',
  './js/app.js?v=3.3.262',
