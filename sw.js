const CACHE = 'showup-v3.3.375';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.375',
  './js/core.js?v=3.3.375',
  './js/derive.js?v=3.3.375',
  './js/util.js?v=3.3.375',
  './js/header.js?v=3.3.375',
  './js/report.js?v=3.3.375',
  './js/today.js?v=3.3.375',
  './js/lift.js?v=3.3.375',
  './js/stats.js?v=3.3.375',
  './js/history.js?v=3.3.375',
  './js/settings.js?v=3.3.375',
  './js/app.js?v=3.3.375',
