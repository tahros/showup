const CACHE = 'showup-v3.3.185';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.185',
  './js/core.js?v=3.3.185',
  './js/derive.js?v=3.3.185',
  './js/util.js?v=3.3.185',
  './js/header.js?v=3.3.185',
  './js/report.js?v=3.3.185',
  './js/today.js?v=3.3.185',
  './js/lift.js?v=3.3.185',
  './js/stats.js?v=3.3.185',
  './js/history.js?v=3.3.185',
  './js/settings.js?v=3.3.185',
  './js/app.js?v=3.3.185',
  './icon-192.png',
  './icon-512.png',
