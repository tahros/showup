const CACHE = 'showup-v3.3.387';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.387',
  './js/core.js?v=3.3.387',
  './js/derive.js?v=3.3.387',
  './js/util.js?v=3.3.387',
  './js/header.js?v=3.3.387',
  './js/report.js?v=3.3.387',
  './js/today.js?v=3.3.387',
  './js/lift.js?v=3.3.387',
  './js/stats.js?v=3.3.387',
  './js/history.js?v=3.3.387',
  './js/settings.js?v=3.3.387',
  './js/app.js?v=3.3.387',
