const CACHE = 'showup-v4.6.95';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.95',
  './css/planner.css?v=4.6.95',
  './css/mascot.css?v=4.6.95',
  './js/retro.js?v=4.6.95',
  './css/retro.css?v=4.6.95',
  './js/mascot.js?v=4.6.95',
  './js/plates.js?v=4.6.95',
  './js/plate-canvas.js?v=4.6.95',
  './css/plates.css?v=4.6.95',
  ...
  './js/core.js?v=4.6.95',
  './js/derive.js?v=4.6.95',
  './js/util.js?v=4.6.95',
  './js/planlink.js?v=4.6.95',
  './js/realset.js?v=4.6.95',
  './js/reprange.js?v=4.6.95',
  './js/verdict.js?v=4.6.95',
  './js/header.js?v=4.6.95',
  './js/report.js?v=4.6.95',
  './js/today.js?v=4.6.95',
  './js/progression.js?v=4.6.95',
  './js/lift.js?v=4.6.95',
  './js/writer.js?v=4.6.95',
  './js/planner.js?v=4.6.95',
  './js/planner-flow.js?v=4.6.95',
  './css/planner-flow.css?v=4.6.95',
  './js/stats.js?v=4.6.95',
  './js/history.js?v=4.6.95',
  './js/settings.js?v=4.6.95',
  './js/stats-story.js?v=4.6.95',
  './js/app.js?v=4.6.95',
