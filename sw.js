const CACHE = 'showup-v3.3.173';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.173',
  './js/core.js?v=3.3.173',
  './js/derive.js?v=3.3.173',
  './js/util.js?v=3.3.173',
  './js/header.js?v=3.3.173',
  './js/report.js?v=3.3.173',
  './js/today.js?v=3.3.173',
  './js/lift.js?v=3.3.173',
  './js/stats.js?v=3.3.173',
  './js/history.js?v=3.3.173',
  './js/settings.js?v=3.3.173',
  './js/app.js?v=3.3.173',
  './icon-192.png',
  './icon-512.png',
