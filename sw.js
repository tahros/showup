const CACHE = 'showup-v3.3.256';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.256',
  './js/core.js?v=3.3.256',
  './js/derive.js?v=3.3.256',
  './js/util.js?v=3.3.256',
  './js/header.js?v=3.3.256',
  './js/report.js?v=3.3.256',
  './js/today.js?v=3.3.256',
  './js/lift.js?v=3.3.256',
  './js/stats.js?v=3.3.256',
  './js/history.js?v=3.3.256',
  './js/settings.js?v=3.3.256',
  './js/app.js?v=3.3.256',
