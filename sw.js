const CACHE = 'showup-v3.3.105';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.105',
  './js/core.js?v=3.3.105',
  './js/derive.js?v=3.3.105',
  './js/util.js?v=3.3.105',
  './js/header.js?v=3.3.105',
  './js/report.js?v=3.3.105',
  './js/today.js?v=3.3.105',
  './js/lift.js?v=3.3.105',
  './js/stats.js?v=3.3.105',
  './js/history.js?v=3.3.105',
  './js/settings.js?v=3.3.105',
  './js/app.js?v=3.3.105',
  './icon-192.png',
  './icon-512.png',
