const CACHE = 'showup-v3.3.199';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.199',
  './js/core.js?v=3.3.199',
  './js/derive.js?v=3.3.199',
  './js/util.js?v=3.3.199',
  './js/header.js?v=3.3.199',
  './js/report.js?v=3.3.199',
  './js/today.js?v=3.3.199',
  './js/lift.js?v=3.3.199',
  './js/stats.js?v=3.3.199',
  './js/history.js?v=3.3.199',
  './js/settings.js?v=3.3.199',
  './js/app.js?v=3.3.199',
  './icon-192.png',
  './icon-512.png',
