const CACHE = 'showup-v3.3.252';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.252',
  './js/core.js?v=3.3.252',
  './js/derive.js?v=3.3.252',
  './js/util.js?v=3.3.252',
  './js/header.js?v=3.3.252',
  './js/report.js?v=3.3.252',
  './js/today.js?v=3.3.252',
  './js/lift.js?v=3.3.252',
  './js/stats.js?v=3.3.252',
  './js/history.js?v=3.3.252',
  './js/settings.js?v=3.3.252',
  './js/app.js?v=3.3.252',
