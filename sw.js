const CACHE = 'showup-v3.3.190';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.190',
  './js/core.js?v=3.3.190',
  './js/derive.js?v=3.3.190',
  './js/util.js?v=3.3.190',
  './js/header.js?v=3.3.190',
  './js/report.js?v=3.3.190',
  './js/today.js?v=3.3.190',
  './js/lift.js?v=3.3.190',
  './js/stats.js?v=3.3.190',
  './js/history.js?v=3.3.190',
  './js/settings.js?v=3.3.190',
  './js/app.js?v=3.3.190',
  './icon-192.png',
  './icon-512.png',
