const CACHE = 'showup-v3.3.383';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.383',
  './js/core.js?v=3.3.383',
  './js/derive.js?v=3.3.383',
  './js/util.js?v=3.3.383',
  './js/header.js?v=3.3.383',
  './js/report.js?v=3.3.383',
  './js/today.js?v=3.3.383',
  './js/lift.js?v=3.3.383',
  './js/stats.js?v=3.3.383',
  './js/history.js?v=3.3.383',
  './js/settings.js?v=3.3.383',
  './js/app.js?v=3.3.383',
