const CACHE = 'showup-v3.3.203';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.203',
  './js/core.js?v=3.3.203',
  './js/derive.js?v=3.3.203',
  './js/util.js?v=3.3.203',
  './js/header.js?v=3.3.203',
  './js/report.js?v=3.3.203',
  './js/today.js?v=3.3.203',
  './js/lift.js?v=3.3.203',
  './js/stats.js?v=3.3.203',
  './js/plan.js?v=3.3.203',
  './js/history.js?v=3.3.203',
  './js/settings.js?v=3.3.203',
  './js/app.js?v=3.3.203',
  './icon-192.png',
  './icon-512.png',
