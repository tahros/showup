const CACHE = 'showup-v3.3.311';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.311',
  './js/core.js?v=3.3.311',
  './js/derive.js?v=3.3.311',
  './js/util.js?v=3.3.311',
  './js/header.js?v=3.3.311',
  './js/report.js?v=3.3.311',
  './js/today.js?v=3.3.311',
  './js/lift.js?v=3.3.311',
  './js/stats.js?v=3.3.311',
  './js/history.js?v=3.3.311',
  './js/settings.js?v=3.3.311',
  './js/app.js?v=3.3.311',
