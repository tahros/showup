const CACHE = 'showup-v3.3.195';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.195',
  './js/core.js?v=3.3.195',
  './js/derive.js?v=3.3.195',
  './js/util.js?v=3.3.195',
  './js/header.js?v=3.3.195',
  './js/report.js?v=3.3.195',
  './js/today.js?v=3.3.195',
  './js/lift.js?v=3.3.195',
  './js/stats.js?v=3.3.195',
  './js/history.js?v=3.3.195',
  './js/settings.js?v=3.3.195',
  './js/app.js?v=3.3.195',
  './icon-192.png',
  './icon-512.png',
