const CACHE = 'showup-v3.3.31';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.31',
  './js/core.js?v=3.3.31',
  './js/derive.js?v=3.3.31',
  './js/util.js?v=3.3.31',
  './js/header.js?v=3.3.31',
  './js/report.js?v=3.3.31',
  './js/today.js?v=3.3.31',
  './js/lift.js?v=3.3.31',
  './js/stats.js?v=3.3.31',
  './js/history.js?v=3.3.31',
  './js/settings.js?v=3.3.31',
  './js/app.js?v=3.3.31',
  './icon-192.png',
  './icon-512.png',
