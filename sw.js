const CACHE = 'showup-v3.3.143';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.143',
  './js/core.js?v=3.3.143',
  './js/derive.js?v=3.3.143',
  './js/util.js?v=3.3.143',
  './js/header.js?v=3.3.143',
  './js/report.js?v=3.3.143',
  './js/today.js?v=3.3.143',
  './js/lift.js?v=3.3.143',
  './js/stats.js?v=3.3.143',
  './js/history.js?v=3.3.143',
  './js/settings.js?v=3.3.143',
  './js/app.js?v=3.3.143',
  './icon-192.png',
  './icon-512.png',
