const CACHE = 'showup-v3.3.522';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.522',
  './js/core.js?v=3.3.522',
  './js/derive.js?v=3.3.522',
  './js/util.js?v=3.3.522',
  './js/header.js?v=3.3.522',
  './js/report.js?v=3.3.522',
  './js/today.js?v=3.3.522',
  './js/lift.js?v=3.3.522',
  './js/writer.js?v=3.3.522',
  './js/stats.js?v=3.3.522',
  './js/history.js?v=3.3.522',
  './js/settings.js?v=3.3.522',
  './js/app.js?v=3.3.522',
