const CACHE = 'showup-v3.3.60';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.60',
  './js/core.js?v=3.3.60',
  './js/derive.js?v=3.3.60',
  './js/util.js?v=3.3.60',
  './js/header.js?v=3.3.60',
  './js/report.js?v=3.3.60',
  './js/today.js?v=3.3.60',
  './js/lift.js?v=3.3.60',
  './js/stats.js?v=3.3.60',
  './js/history.js?v=3.3.60',
  './js/settings.js?v=3.3.60',
  './js/app.js?v=3.3.60',
  './icon-192.png',
  './icon-512.png',
