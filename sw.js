const CACHE = 'showup-v3.3.265';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.265',
  './js/core.js?v=3.3.265',
  './js/derive.js?v=3.3.265',
  './js/util.js?v=3.3.265',
  './js/header.js?v=3.3.265',
  './js/report.js?v=3.3.265',
  './js/today.js?v=3.3.265',
  './js/lift.js?v=3.3.265',
  './js/stats.js?v=3.3.265',
  './js/history.js?v=3.3.265',
  './js/settings.js?v=3.3.265',
  './js/app.js?v=3.3.265',
