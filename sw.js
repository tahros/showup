const CACHE = 'showup-v4.5.30';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.5.30',
  './css/planner.css?v=4.5.30',
  './css/mascot.css?v=4.5.30',
  './js/mascot.js?v=4.5.30',
  './js/plates.js?v=4.5.30',
  './js/plate-canvas.js?v=4.5.30',
  './css/plates.css?v=4.5.30',
  ...
  './js/core.js?v=4.5.30',
  './js/derive.js?v=4.5.30',
  './js/util.js?v=4.5.30',
  './js/realset.js?v=4.5.30',
  './js/reprange.js?v=4.5.30',
  './js/verdict.js?v=4.5.30',
  './js/header.js?v=4.5.30',
  './js/report.js?v=4.5.30',
  './js/today.js?v=4.5.30',
  './js/progression.js?v=4.5.30',
  './js/lift.js?v=4.5.30',
  './js/writer.js?v=4.5.30',
  './js/planner.js?v=4.5.30',
  './js/stats.js?v=4.5.30',
  './js/history.js?v=4.5.30',
  './js/settings.js?v=4.5.30',
  './js/stats-story.js?v=4.5.30',
  './js/app.js?v=4.5.30',
