const CACHE = 'showup-v3.3.392';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.392',
  './js/core.js?v=3.3.392',
  './js/derive.js?v=3.3.392',
  './js/util.js?v=3.3.392',
  './js/header.js?v=3.3.392',
  './js/report.js?v=3.3.392',
  './js/today.js?v=3.3.392',
  './js/lift.js?v=3.3.392',
  './js/stats.js?v=3.3.392',
  './js/history.js?v=3.3.392',
  './js/settings.js?v=3.3.392',
  './js/app.js?v=3.3.392',
