const CACHE = 'showup-v3.3.148';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.148',
  './js/core.js?v=3.3.148',
  './js/derive.js?v=3.3.148',
  './js/util.js?v=3.3.148',
  './js/header.js?v=3.3.148',
  './js/report.js?v=3.3.148',
  './js/today.js?v=3.3.148',
  './js/lift.js?v=3.3.148',
  './js/stats.js?v=3.3.148',
  './js/history.js?v=3.3.148',
  './js/settings.js?v=3.3.148',
  './js/app.js?v=3.3.148',
  './icon-192.png',
  './icon-512.png',
