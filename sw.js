const CACHE = 'showup-v3.3.193';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.193',
  './js/core.js?v=3.3.193',
  './js/derive.js?v=3.3.193',
  './js/util.js?v=3.3.193',
  './js/header.js?v=3.3.193',
  './js/report.js?v=3.3.193',
  './js/today.js?v=3.3.193',
  './js/lift.js?v=3.3.193',
  './js/stats.js?v=3.3.193',
  './js/history.js?v=3.3.193',
  './js/settings.js?v=3.3.193',
  './js/app.js?v=3.3.193',
  './icon-192.png',
  './icon-512.png',
