const CACHE = 'showup-v3.3.58';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.58',
  './js/core.js?v=3.3.58',
  './js/derive.js?v=3.3.58',
  './js/util.js?v=3.3.58',
  './js/header.js?v=3.3.58',
  './js/report.js?v=3.3.58',
  './js/today.js?v=3.3.58',
  './js/lift.js?v=3.3.58',
  './js/stats.js?v=3.3.58',
  './js/history.js?v=3.3.58',
  './js/settings.js?v=3.3.58',
  './js/app.js?v=3.3.58',
  './icon-192.png',
  './icon-512.png',
