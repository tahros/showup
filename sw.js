const CACHE = 'showup-v3.3.14';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.14',
  './js/core.js?v=3.3.14',
  './js/derive.js?v=3.3.14',
  './js/util.js?v=3.3.14',
  './js/header.js?v=3.3.14',
  './js/report.js?v=3.3.14',
  './js/today.js?v=3.3.14',
  './js/lift.js?v=3.3.14',
  './js/stats.js?v=3.3.14',
  './js/history.js?v=3.3.14',
  './js/settings.js?v=3.3.14',
  './js/app.js?v=3.3.14',
  './icon-192.png',
  './icon-512.png',
