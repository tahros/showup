const CACHE = 'showup-v3.3.27';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.27',
  './js/core.js?v=3.3.27',
  './js/derive.js?v=3.3.27',
  './js/util.js?v=3.3.27',
  './js/header.js?v=3.3.27',
  './js/report.js?v=3.3.27',
  './js/today.js?v=3.3.27',
  './js/lift.js?v=3.3.27',
  './js/stats.js?v=3.3.27',
  './js/history.js?v=3.3.27',
  './js/settings.js?v=3.3.27',
  './js/app.js?v=3.3.27',
  './icon-192.png',
  './icon-512.png',
