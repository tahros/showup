const CACHE = 'showup-v4.6.87';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.87',
  './css/planner.css?v=4.6.87',
  './css/mascot.css?v=4.6.87',
  './js/mascot.js?v=4.6.87',
  './js/plates.js?v=4.6.87',
  './js/plate-canvas.js?v=4.6.87',
  './css/plates.css?v=4.6.87',
  ...
  './js/core.js?v=4.6.87',
  './js/derive.js?v=4.6.87',
  './js/util.js?v=4.6.87',
  './js/planlink.js?v=4.6.87',
  './js/realset.js?v=4.6.87',
  './js/reprange.js?v=4.6.87',
  './js/verdict.js?v=4.6.87',
  './js/header.js?v=4.6.87',
  './js/report.js?v=4.6.87',
  './js/today.js?v=4.6.87',
  './js/progression.js?v=4.6.87',
  './js/lift.js?v=4.6.87',
  './js/writer.js?v=4.6.87',
  './js/planner.js?v=4.6.87',
  './js/planner-flow.js?v=4.6.87',
  './css/planner-flow.css?v=4.6.87',
  './js/stats.js?v=4.6.87',
  './js/history.js?v=4.6.87',
  './js/settings.js?v=4.6.87',
  './js/stats-story.js?v=4.6.87',
  './js/app.js?v=4.6.87',
