const CACHE = 'showup-v3.3.260';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.260',
  './js/core.js?v=3.3.260',
  './js/derive.js?v=3.3.260',
  './js/util.js?v=3.3.260',
  './js/header.js?v=3.3.260',
  './js/report.js?v=3.3.260',
  './js/today.js?v=3.3.260',
  './js/lift.js?v=3.3.260',
  './js/stats.js?v=3.3.260',
  './js/history.js?v=3.3.260',
  './js/settings.js?v=3.3.260',
  './js/app.js?v=3.3.260',
