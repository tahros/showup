const CACHE = 'showup-v3.3.212';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.212',
  './js/core.js?v=3.3.212',
  './js/derive.js?v=3.3.212',
  './js/util.js?v=3.3.212',
  './js/header.js?v=3.3.212',
  './js/report.js?v=3.3.212',
  './js/today.js?v=3.3.212',
  './js/lift.js?v=3.3.212',
  './js/stats.js?v=3.3.212',
  './js/history.js?v=3.3.212',
  './js/settings.js?v=3.3.212',
  './js/app.js?v=3.3.212',
