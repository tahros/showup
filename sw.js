const CACHE = 'showup-v3.3.381';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.381',
  './js/core.js?v=3.3.381',
  './js/derive.js?v=3.3.381',
  './js/util.js?v=3.3.381',
  './js/header.js?v=3.3.381',
  './js/report.js?v=3.3.381',
  './js/today.js?v=3.3.381',
  './js/lift.js?v=3.3.381',
  './js/stats.js?v=3.3.381',
  './js/history.js?v=3.3.381',
  './js/settings.js?v=3.3.381',
  './js/app.js?v=3.3.381',
