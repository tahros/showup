...
const SHELL = [
  ...
  './js/core.js?v=3.3.68',
  './js/derive.js?v=3.3.68',
  './js/util.js?v=3.3.68',
  './js/header.js?v=3.3.68',
  './js/report.js?v=3.3.68',
  './js/today.js?v=3.3.68',
  './js/lift.js?v=3.3.68',
  './js/stats.js?v=3.3.68',
  './js/history.js?v=3.3.68',
  './js/settings.js?v=3.3.68',
  './js/app.js?v=3.3.68',
  './icon-192.png',
  './icon-512.png',
