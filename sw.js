const CACHE = 'showup-v3.3.45';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.45',
  './js/core.js?v=3.3.45',
  './js/derive.js?v=3.3.45',
  './js/util.js?v=3.3.45',
  './js/header.js?v=3.3.45',
  './js/report.js?v=3.3.45',
  './js/today.js?v=3.3.45',
  './js/lift.js?v=3.3.45',
  './js/stats.js?v=3.3.45',
  './js/history.js?v=3.3.45',
  './js/settings.js?v=3.3.45',
  './js/app.js?v=3.3.45',
  './icon-192.png',
  './icon-512.png',
