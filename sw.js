const CACHE = 'showup-v4.6.37';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.37',
  './css/planner.css?v=4.6.37',
  './css/mascot.css?v=4.6.37',
  './js/mascot.js?v=4.6.37',
  './js/plates.js?v=4.6.37',
  './js/plate-canvas.js?v=4.6.37',
  './css/plates.css?v=4.6.37',
  ...
  './js/core.js?v=4.6.37',
  './js/derive.js?v=4.6.37',
  './js/util.js?v=4.6.37',
  './js/planlink.js?v=4.6.37',
  './js/realset.js?v=4.6.37',
  './js/reprange.js?v=4.6.37',
  './js/verdict.js?v=4.6.37',
  './js/header.js?v=4.6.37',
  './js/report.js?v=4.6.37',
  './js/today.js?v=4.6.37',
  './js/progression.js?v=4.6.37',
  './js/lift.js?v=4.6.37',
  './js/writer.js?v=4.6.37',
  './js/planner.js?v=4.6.37',
  './js/planner-flow.js?v=4.6.37',
  './css/planner-flow.css?v=4.6.37',
  './js/stats.js?v=4.6.37',
  './js/history.js?v=4.6.37',
  './js/settings.js?v=4.6.37',
  './js/stats-story.js?v=4.6.37',
  './js/app.js?v=4.6.37',
