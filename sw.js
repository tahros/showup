const CACHE = 'showup-v3.3.166';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.166',
  './js/core.js?v=3.3.166',
  './js/derive.js?v=3.3.166',
  './js/util.js?v=3.3.166',
  './js/header.js?v=3.3.166',
  './js/report.js?v=3.3.166',
  './js/today.js?v=3.3.166',
  './js/lift.js?v=3.3.166',
  './js/stats.js?v=3.3.166',
  './js/history.js?v=3.3.166',
  './js/settings.js?v=3.3.166',
  './js/app.js?v=3.3.166',
  './icon-192.png',
  './icon-512.png',
