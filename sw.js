const CACHE = 'showup-v4.6.64';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.64',
  './css/planner.css?v=4.6.64',
  './css/mascot.css?v=4.6.64',
  './js/mascot.js?v=4.6.64',
  './js/plates.js?v=4.6.64',
  './js/plate-canvas.js?v=4.6.64',
  './css/plates.css?v=4.6.64',
  ...
  './js/core.js?v=4.6.64',
  './js/derive.js?v=4.6.64',
  './js/util.js?v=4.6.64',
  './js/planlink.js?v=4.6.64',
  './js/realset.js?v=4.6.64',
  './js/reprange.js?v=4.6.64',
  './js/verdict.js?v=4.6.64',
  './js/header.js?v=4.6.64',
  './js/report.js?v=4.6.64',
  './js/today.js?v=4.6.64',
  './js/progression.js?v=4.6.64',
  './js/lift.js?v=4.6.64',
  './js/writer.js?v=4.6.64',
  './js/planner.js?v=4.6.64',
  './js/planner-flow.js?v=4.6.64',
  './css/planner-flow.css?v=4.6.64',
  './js/stats.js?v=4.6.64',
  './js/history.js?v=4.6.64',
  './js/settings.js?v=4.6.64',
  './js/stats-story.js?v=4.6.64',
  './js/app.js?v=4.6.64',
