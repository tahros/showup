const CACHE = 'showup-v3.3.365';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.365',
  './js/core.js?v=3.3.365',
  './js/derive.js?v=3.3.365',
  './js/util.js?v=3.3.365',
  './js/header.js?v=3.3.365',
  './js/report.js?v=3.3.365',
  './js/today.js?v=3.3.365',
  './js/lift.js?v=3.3.365',
  './js/stats.js?v=3.3.365',
  './js/history.js?v=3.3.365',
  './js/settings.js?v=3.3.365',
  './js/app.js?v=3.3.365',
