const CACHE = 'showup-v3.3.351';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.351',
  './js/core.js?v=3.3.351',
  './js/derive.js?v=3.3.351',
  './js/util.js?v=3.3.351',
  './js/header.js?v=3.3.351',
  './js/report.js?v=3.3.351',
  './js/today.js?v=3.3.351',
  './js/lift.js?v=3.3.351',
  './js/stats.js?v=3.3.351',
  './js/history.js?v=3.3.351',
  './js/settings.js?v=3.3.351',
  './js/app.js?v=3.3.351',
