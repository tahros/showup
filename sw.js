const CACHE = 'showup-v3.3.178';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.178',
  './js/core.js?v=3.3.178',
  './js/derive.js?v=3.3.178',
  './js/util.js?v=3.3.178',
  './js/header.js?v=3.3.178',
  './js/report.js?v=3.3.178',
  './js/today.js?v=3.3.178',
  './js/lift.js?v=3.3.178',
  './js/stats.js?v=3.3.178',
  './js/history.js?v=3.3.178',
  './js/settings.js?v=3.3.178',
  './js/app.js?v=3.3.178',
  './icon-192.png',
  './icon-512.png',
