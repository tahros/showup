const CACHE = 'showup-v4.6.38';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.38',
  './css/planner.css?v=4.6.38',
  './css/mascot.css?v=4.6.38',
  './js/mascot.js?v=4.6.38',
  './js/plates.js?v=4.6.38',
  './js/plate-canvas.js?v=4.6.38',
  './css/plates.css?v=4.6.38',
  ...
  './js/core.js?v=4.6.38',
  './js/derive.js?v=4.6.38',
  './js/util.js?v=4.6.38',
  './js/planlink.js?v=4.6.38',
  './js/realset.js?v=4.6.38',
  './js/reprange.js?v=4.6.38',
  './js/verdict.js?v=4.6.38',
  './js/header.js?v=4.6.38',
  './js/report.js?v=4.6.38',
  './js/today.js?v=4.6.38',
  './js/progression.js?v=4.6.38',
  './js/lift.js?v=4.6.38',
  './js/writer.js?v=4.6.38',
  './js/planner.js?v=4.6.38',
  './js/planner-flow.js?v=4.6.38',
  './css/planner-flow.css?v=4.6.38',
  './js/stats.js?v=4.6.38',
  './js/history.js?v=4.6.38',
  './js/settings.js?v=4.6.38',
  './js/stats-story.js?v=4.6.38',
  './js/app.js?v=4.6.38',
