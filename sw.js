const CACHE = 'showup-v4.6.63';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.63',
  './css/planner.css?v=4.6.63',
  './css/mascot.css?v=4.6.63',
  './js/mascot.js?v=4.6.63',
  './js/plates.js?v=4.6.63',
  './js/plate-canvas.js?v=4.6.63',
  './css/plates.css?v=4.6.63',
  ...
  './js/core.js?v=4.6.63',
  './js/derive.js?v=4.6.63',
  './js/util.js?v=4.6.63',
  './js/planlink.js?v=4.6.63',
  './js/realset.js?v=4.6.63',
  './js/reprange.js?v=4.6.63',
  './js/verdict.js?v=4.6.63',
  './js/header.js?v=4.6.63',
  './js/report.js?v=4.6.63',
  './js/today.js?v=4.6.63',
  './js/progression.js?v=4.6.63',
  './js/lift.js?v=4.6.63',
  './js/writer.js?v=4.6.63',
  './js/planner.js?v=4.6.63',
  './js/planner-flow.js?v=4.6.63',
  './css/planner-flow.css?v=4.6.63',
  './js/stats.js?v=4.6.63',
  './js/history.js?v=4.6.63',
  './js/settings.js?v=4.6.63',
  './js/stats-story.js?v=4.6.63',
  './js/app.js?v=4.6.63',
