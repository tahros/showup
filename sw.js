const CACHE = 'showup-v3.3.396';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.396',
  './js/core.js?v=3.3.396',
  './js/derive.js?v=3.3.396',
  './js/util.js?v=3.3.396',
  './js/header.js?v=3.3.396',
  './js/report.js?v=3.3.396',
  './js/today.js?v=3.3.396',
  './js/lift.js?v=3.3.396',
  './js/stats.js?v=3.3.396',
  './js/history.js?v=3.3.396',
  './js/settings.js?v=3.3.396',
  './js/app.js?v=3.3.396',
