const CACHE = 'showup-v3.3.77';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.77',
  './js/core.js?v=3.3.77',
  './js/derive.js?v=3.3.77',
  './js/util.js?v=3.3.77',
  './js/header.js?v=3.3.77',
  './js/report.js?v=3.3.77',
  './js/today.js?v=3.3.77',
  './js/lift.js?v=3.3.77',
  './js/stats.js?v=3.3.77',
  './js/history.js?v=3.3.77',
  './js/settings.js?v=3.3.77',
  './js/app.js?v=3.3.77',
  './icon-192.png',
  './icon-512.png',
