const CACHE = 'showup-v3.3.251';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.251',
  './js/core.js?v=3.3.251',
  './js/derive.js?v=3.3.251',
  './js/util.js?v=3.3.251',
  './js/header.js?v=3.3.251',
  './js/report.js?v=3.3.251',
  './js/today.js?v=3.3.251',
  './js/lift.js?v=3.3.251',
  './js/stats.js?v=3.3.251',
  './js/history.js?v=3.3.251',
  './js/settings.js?v=3.3.251',
  './js/app.js?v=3.3.251',
