const CACHE = 'showup-v3.3.89';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.89',
  './js/core.js?v=3.3.89',
  './js/derive.js?v=3.3.89',
  './js/util.js?v=3.3.89',
  './js/header.js?v=3.3.89',
  './js/report.js?v=3.3.89',
  './js/today.js?v=3.3.89',
  './js/lift.js?v=3.3.89',
  './js/stats.js?v=3.3.89',
  './js/history.js?v=3.3.89',
  './js/settings.js?v=3.3.89',
  './js/app.js?v=3.3.89',
  './icon-192.png',
  './icon-512.png',
