const CACHE = 'showup-v3.3.208';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.208',
  './js/core.js?v=3.3.208',
  './js/derive.js?v=3.3.208',
  './js/util.js?v=3.3.208',
  './js/header.js?v=3.3.208',
  './js/report.js?v=3.3.208',
  './js/today.js?v=3.3.208',
  './js/lift.js?v=3.3.208',
  './js/stats.js?v=3.3.208',
  './js/history.js?v=3.3.208',
  './js/settings.js?v=3.3.208',
  './js/app.js?v=3.3.208',
  './icon-192.png',
  './icon-512.png',
