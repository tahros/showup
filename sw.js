const CACHE = 'showup-v3.3.28';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.28',
  './js/core.js?v=3.3.28',
  './js/derive.js?v=3.3.28',
  './js/util.js?v=3.3.28',
  './js/header.js?v=3.3.28',
  './js/report.js?v=3.3.28',
  './js/today.js?v=3.3.28',
  './js/lift.js?v=3.3.28',
  './js/stats.js?v=3.3.28',
  './js/history.js?v=3.3.28',
  './js/settings.js?v=3.3.28',
  './js/app.js?v=3.3.28',
  './icon-192.png',
  './icon-512.png',
