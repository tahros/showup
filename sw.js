const CACHE = 'showup-v3.3.49';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.49',
  './js/core.js?v=3.3.49',
  './js/derive.js?v=3.3.49',
  './js/util.js?v=3.3.49',
  './js/header.js?v=3.3.49',
  './js/report.js?v=3.3.49',
  './js/today.js?v=3.3.49',
  './js/lift.js?v=3.3.49',
  './js/stats.js?v=3.3.49',
  './js/history.js?v=3.3.49',
  './js/settings.js?v=3.3.49',
  './js/app.js?v=3.3.49',
  './icon-192.png',
  './icon-512.png',
