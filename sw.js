const CACHE = 'showup-v4.6.93';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.93',
  './css/planner.css?v=4.6.93',
  './css/mascot.css?v=4.6.93',
  './js/retro.js?v=4.6.93',
  './css/retro.css?v=4.6.93',
  './js/mascot.js?v=4.6.93',
  './js/plates.js?v=4.6.93',
  './js/plate-canvas.js?v=4.6.93',
  './css/plates.css?v=4.6.93',
  ...
  './js/core.js?v=4.6.93',
  './js/derive.js?v=4.6.93',
  './js/util.js?v=4.6.93',
  './js/planlink.js?v=4.6.93',
  './js/realset.js?v=4.6.93',
  './js/reprange.js?v=4.6.93',
  './js/verdict.js?v=4.6.93',
  './js/header.js?v=4.6.93',
  './js/report.js?v=4.6.93',
  './js/today.js?v=4.6.93',
  './js/progression.js?v=4.6.93',
  './js/lift.js?v=4.6.93',
  './js/writer.js?v=4.6.93',
  './js/planner.js?v=4.6.93',
  './js/planner-flow.js?v=4.6.93',
  './css/planner-flow.css?v=4.6.93',
  './js/stats.js?v=4.6.93',
  './js/history.js?v=4.6.93',
  './js/settings.js?v=4.6.93',
  './js/stats-story.js?v=4.6.93',
  './js/app.js?v=4.6.93',
