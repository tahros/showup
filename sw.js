const CACHE = 'showup-v4.6.66';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.66',
  './css/planner.css?v=4.6.66',
  './css/mascot.css?v=4.6.66',
  './js/mascot.js?v=4.6.66',
  './js/plates.js?v=4.6.66',
  './js/plate-canvas.js?v=4.6.66',
  './css/plates.css?v=4.6.66',
  ...
  './js/core.js?v=4.6.66',
  './js/derive.js?v=4.6.66',
  './js/util.js?v=4.6.66',
  './js/planlink.js?v=4.6.66',
  './js/realset.js?v=4.6.66',
  './js/reprange.js?v=4.6.66',
  './js/verdict.js?v=4.6.66',
  './js/header.js?v=4.6.66',
  './js/report.js?v=4.6.66',
  './js/today.js?v=4.6.66',
  './js/progression.js?v=4.6.66',
  './js/lift.js?v=4.6.66',
  './js/writer.js?v=4.6.66',
  './js/planner.js?v=4.6.66',
  './js/planner-flow.js?v=4.6.66',
  './css/planner-flow.css?v=4.6.66',
  './js/stats.js?v=4.6.66',
  './js/history.js?v=4.6.66',
  './js/settings.js?v=4.6.66',
  './js/stats-story.js?v=4.6.66',
  './js/app.js?v=4.6.66',
