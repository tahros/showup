const CACHE = 'showup-v3.3.130';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.130',
  './js/core.js?v=3.3.130',
  './js/derive.js?v=3.3.130',
  './js/util.js?v=3.3.130',
  './js/header.js?v=3.3.130',
  './js/report.js?v=3.3.130',
  './js/today.js?v=3.3.130',
  './js/lift.js?v=3.3.130',
  './js/stats.js?v=3.3.130',
  './js/history.js?v=3.3.130',
  './js/settings.js?v=3.3.130',
  './js/app.js?v=3.3.130',
  './icon-192.png',
  './icon-512.png',
