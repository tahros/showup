const CACHE = 'showup-v3.3.197';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.197',
  './js/core.js?v=3.3.197',
  './js/derive.js?v=3.3.197',
  './js/util.js?v=3.3.197',
  './js/header.js?v=3.3.197',
  './js/report.js?v=3.3.197',
  './js/today.js?v=3.3.197',
  './js/lift.js?v=3.3.197',
  './js/stats.js?v=3.3.197',
  './js/history.js?v=3.3.197',
  './js/settings.js?v=3.3.197',
  './js/app.js?v=3.3.197',
  './icon-192.png',
  './icon-512.png',
