const CACHE = 'showup-v4.6.68';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.68',
  './css/planner.css?v=4.6.68',
  './css/mascot.css?v=4.6.68',
  './js/mascot.js?v=4.6.68',
  './js/plates.js?v=4.6.68',
  './js/plate-canvas.js?v=4.6.68',
  './css/plates.css?v=4.6.68',
  ...
  './js/core.js?v=4.6.68',
  './js/derive.js?v=4.6.68',
  './js/util.js?v=4.6.68',
  './js/planlink.js?v=4.6.68',
  './js/realset.js?v=4.6.68',
  './js/reprange.js?v=4.6.68',
  './js/verdict.js?v=4.6.68',
  './js/header.js?v=4.6.68',
  './js/report.js?v=4.6.68',
  './js/today.js?v=4.6.68',
  './js/progression.js?v=4.6.68',
  './js/lift.js?v=4.6.68',
  './js/writer.js?v=4.6.68',
  './js/planner.js?v=4.6.68',
  './js/planner-flow.js?v=4.6.68',
  './css/planner-flow.css?v=4.6.68',
  './js/stats.js?v=4.6.68',
  './js/history.js?v=4.6.68',
  './js/settings.js?v=4.6.68',
  './js/stats-story.js?v=4.6.68',
  './js/app.js?v=4.6.68',
