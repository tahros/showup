const CACHE = 'showup-v3.3.200';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.200',
  './js/core.js?v=3.3.200',
  './js/derive.js?v=3.3.200',
  './js/util.js?v=3.3.200',
  './js/header.js?v=3.3.200',
  './js/report.js?v=3.3.200',
  './js/today.js?v=3.3.200',
  './js/lift.js?v=3.3.200',
  './js/stats.js?v=3.3.200',
  './js/history.js?v=3.3.200',
  './js/settings.js?v=3.3.200',
  './js/app.js?v=3.3.200',
  './icon-192.png',
  './icon-512.png',
