const CACHE = 'showup-v3.3.39';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.39',
  './js/core.js?v=3.3.39',
  './js/derive.js?v=3.3.39',
  './js/util.js?v=3.3.39',
  './js/header.js?v=3.3.39',
  './js/report.js?v=3.3.39',
  './js/today.js?v=3.3.39',
  './js/lift.js?v=3.3.39',
  './js/stats.js?v=3.3.39',
  './js/history.js?v=3.3.39',
  './js/settings.js?v=3.3.39',
  './js/app.js?v=3.3.39',
  './icon-192.png',
  './icon-512.png',
