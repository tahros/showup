const CACHE = 'showup-v3.3.161';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.161',
  './js/core.js?v=3.3.161',
  './js/derive.js?v=3.3.161',
  './js/util.js?v=3.3.161',
  './js/header.js?v=3.3.161',
  './js/report.js?v=3.3.161',
  './js/today.js?v=3.3.161',
  './js/lift.js?v=3.3.161',
  './js/stats.js?v=3.3.161',
  './js/history.js?v=3.3.161',
  './js/settings.js?v=3.3.161',
  './js/app.js?v=3.3.161',
  './icon-192.png',
  './icon-512.png',
