const CACHE = 'showup-v3.3.225';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.225',
  './js/core.js?v=3.3.225',
  './js/derive.js?v=3.3.225',
  './js/util.js?v=3.3.225',
  './js/header.js?v=3.3.225',
  './js/report.js?v=3.3.225',
  './js/today.js?v=3.3.225',
  './js/lift.js?v=3.3.225',
  './js/stats.js?v=3.3.225',
  './js/history.js?v=3.3.225',
  './js/settings.js?v=3.3.225',
  './js/app.js?v=3.3.225',
