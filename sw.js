const CACHE = 'showup-v4.6.81';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.81',
  './css/planner.css?v=4.6.81',
  './css/mascot.css?v=4.6.81',
  './js/mascot.js?v=4.6.81',
  './js/plates.js?v=4.6.81',
  './js/plate-canvas.js?v=4.6.81',
  './css/plates.css?v=4.6.81',
  ...
  './js/core.js?v=4.6.81',
  './js/derive.js?v=4.6.81',
  './js/util.js?v=4.6.81',
  './js/planlink.js?v=4.6.81',
  './js/realset.js?v=4.6.81',
  './js/reprange.js?v=4.6.81',
  './js/verdict.js?v=4.6.81',
  './js/header.js?v=4.6.81',
  './js/report.js?v=4.6.81',
  './js/today.js?v=4.6.81',
  './js/progression.js?v=4.6.81',
  './js/lift.js?v=4.6.81',
  './js/writer.js?v=4.6.81',
  './js/planner.js?v=4.6.81',
  './js/planner-flow.js?v=4.6.81',
  './css/planner-flow.css?v=4.6.81',
  './js/stats.js?v=4.6.81',
  './js/history.js?v=4.6.81',
  './js/settings.js?v=4.6.81',
  './js/stats-story.js?v=4.6.81',
  './js/app.js?v=4.6.81',
