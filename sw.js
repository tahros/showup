const CACHE = 'showup-v4.6.48';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.48',
  './css/planner.css?v=4.6.48',
  './css/mascot.css?v=4.6.48',
  './js/mascot.js?v=4.6.48',
  './js/plates.js?v=4.6.48',
  './js/plate-canvas.js?v=4.6.48',
  './css/plates.css?v=4.6.48',
  ...
  './js/core.js?v=4.6.48',
  './js/derive.js?v=4.6.48',
  './js/util.js?v=4.6.48',
  './js/planlink.js?v=4.6.48',
  './js/realset.js?v=4.6.48',
  './js/reprange.js?v=4.6.48',
  './js/verdict.js?v=4.6.48',
  './js/header.js?v=4.6.48',
  './js/report.js?v=4.6.48',
  './js/today.js?v=4.6.48',
  './js/progression.js?v=4.6.48',
  './js/lift.js?v=4.6.48',
  './js/writer.js?v=4.6.48',
  './js/planner.js?v=4.6.48',
  './js/planner-flow.js?v=4.6.48',
  './css/planner-flow.css?v=4.6.48',
  './js/stats.js?v=4.6.48',
  './js/history.js?v=4.6.48',
  './js/settings.js?v=4.6.48',
  './js/stats-story.js?v=4.6.48',
  './js/app.js?v=4.6.48',
