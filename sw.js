const CACHE = 'showup-v3.3.362';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.362',
  './js/core.js?v=3.3.362',
  './js/derive.js?v=3.3.362',
  './js/util.js?v=3.3.362',
  './js/header.js?v=3.3.362',
  './js/report.js?v=3.3.362',
  './js/today.js?v=3.3.362',
  './js/lift.js?v=3.3.362',
  './js/stats.js?v=3.3.362',
  './js/history.js?v=3.3.362',
  './js/settings.js?v=3.3.362',
  './js/app.js?v=3.3.362',
