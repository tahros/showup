const CACHE = 'showup-v3.3.219';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.219',
  './js/core.js?v=3.3.219',
  './js/derive.js?v=3.3.219',
  './js/util.js?v=3.3.219',
  './js/header.js?v=3.3.219',
  './js/report.js?v=3.3.219',
  './js/today.js?v=3.3.219',
  './js/lift.js?v=3.3.219',
  './js/stats.js?v=3.3.219',
  './js/history.js?v=3.3.219',
  './js/settings.js?v=3.3.219',
  './js/app.js?v=3.3.219',
