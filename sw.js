const CACHE = 'showup-v3.3.23';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.23',
  './js/core.js?v=3.3.23',
  './js/derive.js?v=3.3.23',
  './js/util.js?v=3.3.23',
  './js/header.js?v=3.3.23',
  './js/report.js?v=3.3.23',
  './js/today.js?v=3.3.23',
  './js/lift.js?v=3.3.23',
  './js/stats.js?v=3.3.23',
  './js/history.js?v=3.3.23',
  './js/settings.js?v=3.3.23',
  './js/app.js?v=3.3.23',
  './icon-192.png',
  './icon-512.png',
