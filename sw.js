const CACHE = 'showup-v3.3.118';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.118',
  './js/core.js?v=3.3.118',
  './js/derive.js?v=3.3.118',
  './js/util.js?v=3.3.118',
  './js/header.js?v=3.3.118',
  './js/report.js?v=3.3.118',
  './js/today.js?v=3.3.118',
  './js/lift.js?v=3.3.118',
  './js/stats.js?v=3.3.118',
  './js/history.js?v=3.3.118',
  './js/settings.js?v=3.3.118',
  './js/app.js?v=3.3.118',
  './icon-192.png',
  './icon-512.png',
