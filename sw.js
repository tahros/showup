const CACHE = 'showup-v3.3.153';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.153',
  './js/core.js?v=3.3.153',
  './js/derive.js?v=3.3.153',
  './js/util.js?v=3.3.153',
  './js/header.js?v=3.3.153',
  './js/report.js?v=3.3.153',
  './js/today.js?v=3.3.153',
  './js/lift.js?v=3.3.153',
  './js/stats.js?v=3.3.153',
  './js/history.js?v=3.3.153',
  './js/settings.js?v=3.3.153',
  './js/app.js?v=3.3.153',
  './icon-192.png',
  './icon-512.png',
