const CACHE = 'showup-v4.6.13';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.13',
  './css/planner.css?v=4.6.13',
  './css/mascot.css?v=4.6.13',
  './js/mascot.js?v=4.6.13',
  './js/plates.js?v=4.6.13',
  './js/plate-canvas.js?v=4.6.13',
  './css/plates.css?v=4.6.13',
  ...
  './js/core.js?v=4.6.13',
  './js/derive.js?v=4.6.13',
  './js/util.js?v=4.6.13',
  './js/planlink.js?v=4.6.13',
  './js/realset.js?v=4.6.13',
  './js/reprange.js?v=4.6.13',
  './js/verdict.js?v=4.6.13',
  './js/header.js?v=4.6.13',
  './js/report.js?v=4.6.13',
  './js/today.js?v=4.6.13',
  './js/progression.js?v=4.6.13',
  './js/lift.js?v=4.6.13',
  './js/writer.js?v=4.6.13',
  './js/planner.js?v=4.6.13',
  './js/planner-flow.js?v=4.6.13',
  './css/planner-flow.css?v=4.6.13',
  './js/stats.js?v=4.6.13',
  './js/history.js?v=4.6.13',
  './js/settings.js?v=4.6.13',
  './js/stats-story.js?v=4.6.13',
  './js/app.js?v=4.6.13',
