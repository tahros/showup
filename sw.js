const CACHE = 'showup-v3.3.156';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.156',
  './js/core.js?v=3.3.156',
  './js/derive.js?v=3.3.156',
  './js/util.js?v=3.3.156',
  './js/header.js?v=3.3.156',
  './js/report.js?v=3.3.156',
  './js/today.js?v=3.3.156',
  './js/lift.js?v=3.3.156',
  './js/stats.js?v=3.3.156',
  './js/history.js?v=3.3.156',
  './js/settings.js?v=3.3.156',
  './js/app.js?v=3.3.156',
  './icon-192.png',
  './icon-512.png',
