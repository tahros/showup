const CACHE = 'showup-v3.3.320';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.320',
  './js/core.js?v=3.3.320',
  './js/derive.js?v=3.3.320',
  './js/util.js?v=3.3.320',
  './js/header.js?v=3.3.320',
  './js/report.js?v=3.3.320',
  './js/today.js?v=3.3.320',
  './js/lift.js?v=3.3.320',
  './js/stats.js?v=3.3.320',
  './js/history.js?v=3.3.320',
  './js/settings.js?v=3.3.320',
  './js/app.js?v=3.3.320',
