const CACHE = 'showup-v3.3.206';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.206',
  './js/core.js?v=3.3.206',
  './js/derive.js?v=3.3.206',
  './js/util.js?v=3.3.206',
  './js/header.js?v=3.3.206',
  './js/report.js?v=3.3.206',
  './js/today.js?v=3.3.206',
  './js/lift.js?v=3.3.206',
  './js/stats.js?v=3.3.206',
  './js/history.js?v=3.3.206',
  './js/settings.js?v=3.3.206',
  './js/app.js?v=3.3.206',
  './icon-192.png',
  './icon-512.png',
