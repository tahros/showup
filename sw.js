const CACHE = 'showup-v3.3.85';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.85',
  './js/core.js?v=3.3.85',
  './js/derive.js?v=3.3.85',
  './js/util.js?v=3.3.85',
  './js/header.js?v=3.3.85',
  './js/report.js?v=3.3.85',
  './js/today.js?v=3.3.85',
  './js/lift.js?v=3.3.85',
  './js/stats.js?v=3.3.85',
  './js/history.js?v=3.3.85',
  './js/settings.js?v=3.3.85',
  './js/app.js?v=3.3.85',
  './icon-192.png',
  './icon-512.png',
