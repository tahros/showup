const CACHE = 'showup-v3.3.349';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.349',
  './js/core.js?v=3.3.349',
  './js/derive.js?v=3.3.349',
  './js/util.js?v=3.3.349',
  './js/header.js?v=3.3.349',
  './js/report.js?v=3.3.349',
  './js/today.js?v=3.3.349',
  './js/lift.js?v=3.3.349',
  './js/stats.js?v=3.3.349',
  './js/history.js?v=3.3.349',
  './js/settings.js?v=3.3.349',
  './js/app.js?v=3.3.349',
