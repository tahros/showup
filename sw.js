const CACHE = 'showup-v4.6.73';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.73',
  './css/planner.css?v=4.6.73',
  './css/mascot.css?v=4.6.73',
  './js/mascot.js?v=4.6.73',
  './js/plates.js?v=4.6.73',
  './js/plate-canvas.js?v=4.6.73',
  './css/plates.css?v=4.6.73',
  ...
  './js/core.js?v=4.6.73',
  './js/derive.js?v=4.6.73',
  './js/util.js?v=4.6.73',
  './js/planlink.js?v=4.6.73',
  './js/realset.js?v=4.6.73',
  './js/reprange.js?v=4.6.73',
  './js/verdict.js?v=4.6.73',
  './js/header.js?v=4.6.73',
  './js/report.js?v=4.6.73',
  './js/today.js?v=4.6.73',
  './js/progression.js?v=4.6.73',
  './js/lift.js?v=4.6.73',
  './js/writer.js?v=4.6.73',
  './js/planner.js?v=4.6.73',
  './js/planner-flow.js?v=4.6.73',
  './css/planner-flow.css?v=4.6.73',
  './js/stats.js?v=4.6.73',
  './js/history.js?v=4.6.73',
  './js/settings.js?v=4.6.73',
  './js/stats-story.js?v=4.6.73',
  './js/app.js?v=4.6.73',
