const CACHE = 'showup-v3.3.113';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.113',
  './js/core.js?v=3.3.113',
  './js/derive.js?v=3.3.113',
  './js/util.js?v=3.3.113',
  './js/header.js?v=3.3.113',
  './js/report.js?v=3.3.113',
  './js/today.js?v=3.3.113',
  './js/lift.js?v=3.3.113',
  './js/stats.js?v=3.3.113',
  './js/history.js?v=3.3.113',
  './js/settings.js?v=3.3.113',
  './js/app.js?v=3.3.113',
  './icon-192.png',
  './icon-512.png',
