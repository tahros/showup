const CACHE = 'showup-v3.3.154';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.154',
  './js/core.js?v=3.3.154',
  './js/derive.js?v=3.3.154',
  './js/util.js?v=3.3.154',
  './js/header.js?v=3.3.154',
  './js/report.js?v=3.3.154',
  './js/today.js?v=3.3.154',
  './js/lift.js?v=3.3.154',
  './js/stats.js?v=3.3.154',
  './js/history.js?v=3.3.154',
  './js/settings.js?v=3.3.154',
  './js/app.js?v=3.3.154',
  './icon-192.png',
  './icon-512.png',
