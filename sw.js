const CACHE = 'showup-v3.3.314';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.314',
  './js/core.js?v=3.3.314',
  './js/derive.js?v=3.3.314',
  './js/util.js?v=3.3.314',
  './js/header.js?v=3.3.314',
  './js/report.js?v=3.3.314',
  './js/today.js?v=3.3.314',
  './js/lift.js?v=3.3.314',
  './js/stats.js?v=3.3.314',
  './js/history.js?v=3.3.314',
  './js/settings.js?v=3.3.314',
  './js/app.js?v=3.3.314',
