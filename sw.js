const CACHE = 'showup-v4.6.45';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.45',
  './css/planner.css?v=4.6.45',
  './css/mascot.css?v=4.6.45',
  './js/mascot.js?v=4.6.45',
  './js/plates.js?v=4.6.45',
  './js/plate-canvas.js?v=4.6.45',
  './css/plates.css?v=4.6.45',
  ...
  './js/core.js?v=4.6.45',
  './js/derive.js?v=4.6.45',
  './js/util.js?v=4.6.45',
  './js/planlink.js?v=4.6.45',
  './js/realset.js?v=4.6.45',
  './js/reprange.js?v=4.6.45',
  './js/verdict.js?v=4.6.45',
  './js/header.js?v=4.6.45',
  './js/report.js?v=4.6.45',
  './js/today.js?v=4.6.45',
  './js/progression.js?v=4.6.45',
  './js/lift.js?v=4.6.45',
  './js/writer.js?v=4.6.45',
  './js/planner.js?v=4.6.45',
  './js/planner-flow.js?v=4.6.45',
  './css/planner-flow.css?v=4.6.45',
  './js/stats.js?v=4.6.45',
  './js/history.js?v=4.6.45',
  './js/settings.js?v=4.6.45',
  './js/stats-story.js?v=4.6.45',
  './js/app.js?v=4.6.45',
