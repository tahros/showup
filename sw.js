const CACHE = 'showup-v3.3.168';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.168',
  './js/core.js?v=3.3.168',
  './js/derive.js?v=3.3.168',
  './js/util.js?v=3.3.168',
  './js/header.js?v=3.3.168',
  './js/report.js?v=3.3.168',
  './js/today.js?v=3.3.168',
  './js/lift.js?v=3.3.168',
  './js/stats.js?v=3.3.168',
  './js/history.js?v=3.3.168',
  './js/settings.js?v=3.3.168',
  './js/app.js?v=3.3.168',
  './icon-192.png',
  './icon-512.png',
