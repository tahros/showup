const CACHE = 'showup-v3.3.255';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.255',
  './js/core.js?v=3.3.255',
  './js/derive.js?v=3.3.255',
  './js/util.js?v=3.3.255',
  './js/header.js?v=3.3.255',
  './js/report.js?v=3.3.255',
  './js/today.js?v=3.3.255',
  './js/lift.js?v=3.3.255',
  './js/stats.js?v=3.3.255',
  './js/history.js?v=3.3.255',
  './js/settings.js?v=3.3.255',
  './js/app.js?v=3.3.255',
