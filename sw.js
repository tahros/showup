const CACHE = 'showup-v4.5.11';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.5.11',
  './css/planner.css?v=4.5.11',
  './css/mascot.css?v=4.5.11',
  './js/mascot.js?v=4.5.11',
  './js/plates.js?v=4.5.11',
  './js/plate-canvas.js?v=4.5.11',
  './css/plates.css?v=4.5.11',
  ...
  './js/core.js?v=4.5.11',
  './js/derive.js?v=4.5.11',
  './js/util.js?v=4.5.11',
  './js/realset.js?v=4.5.11',
  './js/reprange.js?v=4.5.11',
  './js/verdict.js?v=4.5.11',
  './js/header.js?v=4.5.11',
  './js/report.js?v=4.5.11',
  './js/today.js?v=4.5.11',
  './js/progression.js?v=4.5.11',
  './js/lift.js?v=4.5.11',
  './js/writer.js?v=4.5.11',
  './js/planner.js?v=4.5.11',
  './js/stats.js?v=4.5.11',
  './js/history.js?v=4.5.11',
  './js/settings.js?v=4.5.11',
  './js/stats-story.js?v=4.5.11',
  './js/app.js?v=4.5.11',
