const CACHE = 'showup-v3.3.46';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.46',
  './js/core.js?v=3.3.46',
  './js/derive.js?v=3.3.46',
  './js/util.js?v=3.3.46',
  './js/header.js?v=3.3.46',
  './js/report.js?v=3.3.46',
  './js/today.js?v=3.3.46',
  './js/lift.js?v=3.3.46',
  './js/stats.js?v=3.3.46',
  './js/history.js?v=3.3.46',
  './js/settings.js?v=3.3.46',
  './js/app.js?v=3.3.46',
  './icon-192.png',
  './icon-512.png',
