const CACHE = 'showup-v3.3.115';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.115',
  './js/core.js?v=3.3.115',
  './js/derive.js?v=3.3.115',
  './js/util.js?v=3.3.115',
  './js/header.js?v=3.3.115',
  './js/report.js?v=3.3.115',
  './js/today.js?v=3.3.115',
  './js/lift.js?v=3.3.115',
  './js/stats.js?v=3.3.115',
  './js/history.js?v=3.3.115',
  './js/settings.js?v=3.3.115',
  './js/app.js?v=3.3.115',
  './icon-192.png',
  './icon-512.png',
