...
const SHELL = [
  ...
  './js/core.js?v=3.3.19',
  './js/derive.js?v=3.3.19',
  './js/util.js?v=3.3.19',
  './js/header.js?v=3.3.19',
  './js/report.js?v=3.3.19',
  './js/today.js?v=3.3.19',
  './js/lift.js?v=3.3.19',
  './js/stats.js?v=3.3.19',
  './js/history.js?v=3.3.19',
  './js/settings.js?v=3.3.19',
  './js/app.js?v=3.3.19',
  './icon-192.png',
  './icon-512.png',
