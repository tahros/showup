const CACHE = 'showup-v3.3.55';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.55',
  './js/core.js?v=3.3.55',
  './js/derive.js?v=3.3.55',
  './js/util.js?v=3.3.55',
  './js/header.js?v=3.3.55',
  './js/report.js?v=3.3.55',
  './js/today.js?v=3.3.55',
  './js/lift.js?v=3.3.55',
  './js/stats.js?v=3.3.55',
  './js/history.js?v=3.3.55',
  './js/settings.js?v=3.3.55',
  './js/app.js?v=3.3.55',
  './icon-192.png',
  './icon-512.png',
