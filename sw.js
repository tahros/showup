const CACHE = 'showup-v4.5.19';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.5.19',
  './css/planner.css?v=4.5.19',
  './css/mascot.css?v=4.5.19',
  './js/mascot.js?v=4.5.19',
  './js/plates.js?v=4.5.19',
  './js/plate-canvas.js?v=4.5.19',
  './css/plates.css?v=4.5.19',
  ...
  './js/core.js?v=4.5.19',
  './js/derive.js?v=4.5.19',
  './js/util.js?v=4.5.19',
  './js/realset.js?v=4.5.19',
  './js/reprange.js?v=4.5.19',
  './js/verdict.js?v=4.5.19',
  './js/header.js?v=4.5.19',
  './js/report.js?v=4.5.19',
  './js/today.js?v=4.5.19',
  './js/progression.js?v=4.5.19',
  './js/lift.js?v=4.5.19',
  './js/writer.js?v=4.5.19',
  './js/planner.js?v=4.5.19',
  './js/stats.js?v=4.5.19',
  './js/history.js?v=4.5.19',
  './js/settings.js?v=4.5.19',
  './js/stats-story.js?v=4.5.19',
  './js/app.js?v=4.5.19',
