const CACHE = 'showup-v4.6.58';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.58',
  './css/planner.css?v=4.6.58',
  './css/mascot.css?v=4.6.58',
  './js/mascot.js?v=4.6.58',
  './js/plates.js?v=4.6.58',
  './js/plate-canvas.js?v=4.6.58',
  './css/plates.css?v=4.6.58',
  ...
  './js/core.js?v=4.6.58',
  './js/derive.js?v=4.6.58',
  './js/util.js?v=4.6.58',
  './js/planlink.js?v=4.6.58',
  './js/realset.js?v=4.6.58',
  './js/reprange.js?v=4.6.58',
  './js/verdict.js?v=4.6.58',
  './js/header.js?v=4.6.58',
  './js/report.js?v=4.6.58',
  './js/today.js?v=4.6.58',
  './js/progression.js?v=4.6.58',
  './js/lift.js?v=4.6.58',
  './js/writer.js?v=4.6.58',
  './js/planner.js?v=4.6.58',
  './js/planner-flow.js?v=4.6.58',
  './css/planner-flow.css?v=4.6.58',
  './js/stats.js?v=4.6.58',
  './js/history.js?v=4.6.58',
  './js/settings.js?v=4.6.58',
  './js/stats-story.js?v=4.6.58',
  './js/app.js?v=4.6.58',
