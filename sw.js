const CACHE = 'showup-v3.3.26';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.26',
  './js/core.js?v=3.3.26',
  './js/derive.js?v=3.3.26',
  './js/util.js?v=3.3.26',
  './js/header.js?v=3.3.26',
  './js/report.js?v=3.3.26',
  './js/today.js?v=3.3.26',
  './js/lift.js?v=3.3.26',
  './js/stats.js?v=3.3.26',
  './js/history.js?v=3.3.26',
  './js/settings.js?v=3.3.26',
  './js/app.js?v=3.3.26',
  './icon-192.png',
  './icon-512.png',
