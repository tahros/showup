const CACHE = 'showup-v3.3.274';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.274',
  './js/core.js?v=3.3.274',
  './js/derive.js?v=3.3.274',
  './js/util.js?v=3.3.274',
  './js/header.js?v=3.3.274',
  './js/report.js?v=3.3.274',
  './js/today.js?v=3.3.274',
  './js/lift.js?v=3.3.274',
  './js/stats.js?v=3.3.274',
  './js/history.js?v=3.3.274',
  './js/settings.js?v=3.3.274',
  './js/app.js?v=3.3.274',
