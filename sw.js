const CACHE = 'showup-v3.3.141';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.141',
  './js/core.js?v=3.3.141',
  './js/derive.js?v=3.3.141',
  './js/util.js?v=3.3.141',
  './js/header.js?v=3.3.141',
  './js/report.js?v=3.3.141',
  './js/today.js?v=3.3.141',
  './js/lift.js?v=3.3.141',
  './js/stats.js?v=3.3.141',
  './js/history.js?v=3.3.141',
  './js/settings.js?v=3.3.141',
  './js/app.js?v=3.3.141',
  './icon-192.png',
  './icon-512.png',
