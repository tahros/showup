const CACHE = 'showup-v4.6.46';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.46',
  './css/planner.css?v=4.6.46',
  './css/mascot.css?v=4.6.46',
  './js/mascot.js?v=4.6.46',
  './js/plates.js?v=4.6.46',
  './js/plate-canvas.js?v=4.6.46',
  './css/plates.css?v=4.6.46',
  ...
  './js/core.js?v=4.6.46',
  './js/derive.js?v=4.6.46',
  './js/util.js?v=4.6.46',
  './js/planlink.js?v=4.6.46',
  './js/realset.js?v=4.6.46',
  './js/reprange.js?v=4.6.46',
  './js/verdict.js?v=4.6.46',
  './js/header.js?v=4.6.46',
  './js/report.js?v=4.6.46',
  './js/today.js?v=4.6.46',
  './js/progression.js?v=4.6.46',
  './js/lift.js?v=4.6.46',
  './js/writer.js?v=4.6.46',
  './js/planner.js?v=4.6.46',
  './js/planner-flow.js?v=4.6.46',
  './css/planner-flow.css?v=4.6.46',
  './js/stats.js?v=4.6.46',
  './js/history.js?v=4.6.46',
  './js/settings.js?v=4.6.46',
  './js/stats-story.js?v=4.6.46',
  './js/app.js?v=4.6.46',
