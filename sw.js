const CACHE = 'showup-v3.3.259';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.259',
  './js/core.js?v=3.3.259',
  './js/derive.js?v=3.3.259',
  './js/util.js?v=3.3.259',
  './js/header.js?v=3.3.259',
  './js/report.js?v=3.3.259',
  './js/today.js?v=3.3.259',
  './js/lift.js?v=3.3.259',
  './js/stats.js?v=3.3.259',
  './js/history.js?v=3.3.259',
  './js/settings.js?v=3.3.259',
  './js/app.js?v=3.3.259',
