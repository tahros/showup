const CACHE = 'showup-v3.3.207';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.207',
  './js/core.js?v=3.3.207',
  './js/derive.js?v=3.3.207',
  './js/util.js?v=3.3.207',
  './js/header.js?v=3.3.207',
  './js/report.js?v=3.3.207',
  './js/today.js?v=3.3.207',
  './js/lift.js?v=3.3.207',
  './js/stats.js?v=3.3.207',
  './js/history.js?v=3.3.207',
  './js/settings.js?v=3.3.207',
  './js/app.js?v=3.3.207',
  './icon-192.png',
  './icon-512.png',
