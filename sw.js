const CACHE = 'showup-v3.3.101';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.101',
  './js/core.js?v=3.3.101',
  './js/derive.js?v=3.3.101',
  './js/util.js?v=3.3.101',
  './js/header.js?v=3.3.101',
  './js/report.js?v=3.3.101',
  './js/today.js?v=3.3.101',
  './js/lift.js?v=3.3.101',
  './js/stats.js?v=3.3.101',
  './js/history.js?v=3.3.101',
  './js/settings.js?v=3.3.101',
  './js/app.js?v=3.3.101',
  './icon-192.png',
  './icon-512.png',
