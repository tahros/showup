const CACHE = 'showup-v3.3.53';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.53',
  './js/core.js?v=3.3.53',
  './js/derive.js?v=3.3.53',
  './js/util.js?v=3.3.53',
  './js/header.js?v=3.3.53',
  './js/report.js?v=3.3.53',
  './js/today.js?v=3.3.53',
  './js/lift.js?v=3.3.53',
  './js/stats.js?v=3.3.53',
  './js/history.js?v=3.3.53',
  './js/settings.js?v=3.3.53',
  './js/app.js?v=3.3.53',
  './icon-192.png',
  './icon-512.png',
