const CACHE = 'showup-v3.3.378';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.378',
  './js/core.js?v=3.3.378',
  './js/derive.js?v=3.3.378',
  './js/util.js?v=3.3.378',
  './js/header.js?v=3.3.378',
  './js/report.js?v=3.3.378',
  './js/today.js?v=3.3.378',
  './js/lift.js?v=3.3.378',
  './js/stats.js?v=3.3.378',
  './js/history.js?v=3.3.378',
  './js/settings.js?v=3.3.378',
  './js/app.js?v=3.3.378',
