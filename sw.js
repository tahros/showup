const CACHE = 'showup-v3.3.16';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.16',
  './js/core.js?v=3.3.16',
  './js/derive.js?v=3.3.16',
  './js/util.js?v=3.3.16',
  './js/header.js?v=3.3.16',
  './js/report.js?v=3.3.16',
  './js/today.js?v=3.3.16',
  './js/lift.js?v=3.3.16',
  './js/stats.js?v=3.3.16',
  './js/history.js?v=3.3.16',
  './js/settings.js?v=3.3.16',
  './js/app.js?v=3.3.16',
  './icon-192.png',
  './icon-512.png',
