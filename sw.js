const CACHE = 'showup-v4.6.53';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.53',
  './css/planner.css?v=4.6.53',
  './css/mascot.css?v=4.6.53',
  './js/mascot.js?v=4.6.53',
  './js/plates.js?v=4.6.53',
  './js/plate-canvas.js?v=4.6.53',
  './css/plates.css?v=4.6.53',
  ...
  './js/core.js?v=4.6.53',
  './js/derive.js?v=4.6.53',
  './js/util.js?v=4.6.53',
  './js/planlink.js?v=4.6.53',
  './js/realset.js?v=4.6.53',
  './js/reprange.js?v=4.6.53',
  './js/verdict.js?v=4.6.53',
  './js/header.js?v=4.6.53',
  './js/report.js?v=4.6.53',
  './js/today.js?v=4.6.53',
  './js/progression.js?v=4.6.53',
  './js/lift.js?v=4.6.53',
  './js/writer.js?v=4.6.53',
  './js/planner.js?v=4.6.53',
  './js/planner-flow.js?v=4.6.53',
  './css/planner-flow.css?v=4.6.53',
  './js/stats.js?v=4.6.53',
  './js/history.js?v=4.6.53',
  './js/settings.js?v=4.6.53',
  './js/stats-story.js?v=4.6.53',
  './js/app.js?v=4.6.53',
