const CACHE = 'showup-v3.3.102';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.102',
  './js/core.js?v=3.3.102',
  './js/derive.js?v=3.3.102',
  './js/util.js?v=3.3.102',
  './js/header.js?v=3.3.102',
  './js/report.js?v=3.3.102',
  './js/today.js?v=3.3.102',
  './js/lift.js?v=3.3.102',
  './js/stats.js?v=3.3.102',
  './js/history.js?v=3.3.102',
  './js/settings.js?v=3.3.102',
  './js/app.js?v=3.3.102',
  './icon-192.png',
  './icon-512.png',
