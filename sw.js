const CACHE = 'showup-v4.6.62';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.62',
  './css/planner.css?v=4.6.62',
  './css/mascot.css?v=4.6.62',
  './js/mascot.js?v=4.6.62',
  './js/plates.js?v=4.6.62',
  './js/plate-canvas.js?v=4.6.62',
  './css/plates.css?v=4.6.62',
  ...
  './js/core.js?v=4.6.62',
  './js/derive.js?v=4.6.62',
  './js/util.js?v=4.6.62',
  './js/planlink.js?v=4.6.62',
  './js/realset.js?v=4.6.62',
  './js/reprange.js?v=4.6.62',
  './js/verdict.js?v=4.6.62',
  './js/header.js?v=4.6.62',
  './js/report.js?v=4.6.62',
  './js/today.js?v=4.6.62',
  './js/progression.js?v=4.6.62',
  './js/lift.js?v=4.6.62',
  './js/writer.js?v=4.6.62',
  './js/planner.js?v=4.6.62',
  './js/planner-flow.js?v=4.6.62',
  './css/planner-flow.css?v=4.6.62',
  './js/stats.js?v=4.6.62',
  './js/history.js?v=4.6.62',
  './js/settings.js?v=4.6.62',
  './js/stats-story.js?v=4.6.62',
  './js/app.js?v=4.6.62',
