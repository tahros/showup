const CACHE = 'showup-v3.3.90';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.90',
  './js/core.js?v=3.3.90',
  './js/derive.js?v=3.3.90',
  './js/util.js?v=3.3.90',
  './js/header.js?v=3.3.90',
  './js/report.js?v=3.3.90',
  './js/today.js?v=3.3.90',
  './js/lift.js?v=3.3.90',
  './js/stats.js?v=3.3.90',
  './js/history.js?v=3.3.90',
  './js/settings.js?v=3.3.90',
  './js/app.js?v=3.3.90',
  './icon-192.png',
  './icon-512.png',
