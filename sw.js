const CACHE = 'showup-v3.3.122';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.122',
  './js/core.js?v=3.3.122',
  './js/derive.js?v=3.3.122',
  './js/util.js?v=3.3.122',
  './js/header.js?v=3.3.122',
  './js/report.js?v=3.3.122',
  './js/today.js?v=3.3.122',
  './js/lift.js?v=3.3.122',
  './js/stats.js?v=3.3.122',
  './js/history.js?v=3.3.122',
  './js/settings.js?v=3.3.122',
  './js/app.js?v=3.3.122',
  './icon-192.png',
  './icon-512.png',
