const CACHE = 'showup-v3.3.36';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.36',
  './js/core.js?v=3.3.36',
  './js/derive.js?v=3.3.36',
  './js/util.js?v=3.3.36',
  './js/header.js?v=3.3.36',
  './js/report.js?v=3.3.36',
  './js/today.js?v=3.3.36',
  './js/lift.js?v=3.3.36',
  './js/stats.js?v=3.3.36',
  './js/history.js?v=3.3.36',
  './js/settings.js?v=3.3.36',
  './js/app.js?v=3.3.36',
  './icon-192.png',
  './icon-512.png',
