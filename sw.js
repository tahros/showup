const CACHE = 'showup-v3.3.107';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.107',
  './js/core.js?v=3.3.107',
  './js/derive.js?v=3.3.107',
  './js/util.js?v=3.3.107',
  './js/header.js?v=3.3.107',
  './js/report.js?v=3.3.107',
  './js/today.js?v=3.3.107',
  './js/lift.js?v=3.3.107',
  './js/stats.js?v=3.3.107',
  './js/history.js?v=3.3.107',
  './js/settings.js?v=3.3.107',
  './js/app.js?v=3.3.107',
  './icon-192.png',
  './icon-512.png',
