const CACHE = 'showup-v4.6.60';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.60',
  './css/planner.css?v=4.6.60',
  './css/mascot.css?v=4.6.60',
  './js/mascot.js?v=4.6.60',
  './js/plates.js?v=4.6.60',
  './js/plate-canvas.js?v=4.6.60',
  './css/plates.css?v=4.6.60',
  ...
  './js/core.js?v=4.6.60',
  './js/derive.js?v=4.6.60',
  './js/util.js?v=4.6.60',
  './js/planlink.js?v=4.6.60',
  './js/realset.js?v=4.6.60',
  './js/reprange.js?v=4.6.60',
  './js/verdict.js?v=4.6.60',
  './js/header.js?v=4.6.60',
  './js/report.js?v=4.6.60',
  './js/today.js?v=4.6.60',
  './js/progression.js?v=4.6.60',
  './js/lift.js?v=4.6.60',
  './js/writer.js?v=4.6.60',
  './js/planner.js?v=4.6.60',
  './js/planner-flow.js?v=4.6.60',
  './css/planner-flow.css?v=4.6.60',
  './js/stats.js?v=4.6.60',
  './js/history.js?v=4.6.60',
  './js/settings.js?v=4.6.60',
  './js/stats-story.js?v=4.6.60',
  './js/app.js?v=4.6.60',
