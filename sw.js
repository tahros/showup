const CACHE = 'showup-v3.3.30';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.30',
  './js/core.js?v=3.3.30',
  './js/derive.js?v=3.3.30',
  './js/util.js?v=3.3.30',
  './js/header.js?v=3.3.30',
  './js/report.js?v=3.3.30',
  './js/today.js?v=3.3.30',
  './js/lift.js?v=3.3.30',
  './js/stats.js?v=3.3.30',
  './js/history.js?v=3.3.30',
  './js/settings.js?v=3.3.30',
  './js/app.js?v=3.3.30',
  './icon-192.png',
  './icon-512.png',
