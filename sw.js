const CACHE = 'showup-v3.3.37';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.37',
  './js/core.js?v=3.3.37',
  './js/derive.js?v=3.3.37',
  './js/util.js?v=3.3.37',
  './js/header.js?v=3.3.37',
  './js/report.js?v=3.3.37',
  './js/today.js?v=3.3.37',
  './js/lift.js?v=3.3.37',
  './js/stats.js?v=3.3.37',
  './js/history.js?v=3.3.37',
  './js/settings.js?v=3.3.37',
  './js/app.js?v=3.3.37',
  './icon-192.png',
  './icon-512.png',
