const CACHE = 'showup-v3.3.536';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.536',
  './js/core.js?v=3.3.536',
  './js/derive.js?v=3.3.536',
  './js/util.js?v=3.3.536',
  './js/header.js?v=3.3.536',
  './js/report.js?v=3.3.536',
  './js/today.js?v=3.3.536',
  './js/progression.js?v=3.3.536',
  './js/lift.js?v=3.3.536',
  './js/writer.js?v=3.3.536',
  './js/stats.js?v=3.3.536',
  './js/history.js?v=3.3.536',
  './js/settings.js?v=3.3.536',
  './js/app.js?v=3.3.536',
