const CACHE = 'showup-v4.6.92';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.92',
  './css/planner.css?v=4.6.92',
  './css/mascot.css?v=4.6.92',
  './js/mascot.js?v=4.6.92',
  './js/plates.js?v=4.6.92',
  './js/plate-canvas.js?v=4.6.92',
  './css/plates.css?v=4.6.92',
  ...
  './js/core.js?v=4.6.92',
  './js/derive.js?v=4.6.92',
  './js/util.js?v=4.6.92',
  './js/planlink.js?v=4.6.92',
  './js/realset.js?v=4.6.92',
  './js/reprange.js?v=4.6.92',
  './js/verdict.js?v=4.6.92',
  './js/header.js?v=4.6.92',
  './js/report.js?v=4.6.92',
  './js/today.js?v=4.6.92',
  './js/progression.js?v=4.6.92',
  './js/lift.js?v=4.6.92',
  './js/writer.js?v=4.6.92',
  './js/planner.js?v=4.6.92',
  './js/planner-flow.js?v=4.6.92',
  './css/planner-flow.css?v=4.6.92',
  './js/stats.js?v=4.6.92',
  './js/history.js?v=4.6.92',
  './js/settings.js?v=4.6.92',
  './js/stats-story.js?v=4.6.92',
  './js/app.js?v=4.6.92',
