const CACHE = 'showup-v4.6.44';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=4.6.44',
  './css/planner.css?v=4.6.44',
  './css/mascot.css?v=4.6.44',
  './js/mascot.js?v=4.6.44',
  './js/plates.js?v=4.6.44',
  './js/plate-canvas.js?v=4.6.44',
  './css/plates.css?v=4.6.44',
  ...
  './js/core.js?v=4.6.44',
  './js/derive.js?v=4.6.44',
  './js/util.js?v=4.6.44',
  './js/planlink.js?v=4.6.44',
  './js/realset.js?v=4.6.44',
  './js/reprange.js?v=4.6.44',
  './js/verdict.js?v=4.6.44',
  './js/header.js?v=4.6.44',
  './js/report.js?v=4.6.44',
  './js/today.js?v=4.6.44',
  './js/progression.js?v=4.6.44',
  './js/lift.js?v=4.6.44',
  './js/writer.js?v=4.6.44',
  './js/planner.js?v=4.6.44',
  './js/planner-flow.js?v=4.6.44',
  './css/planner-flow.css?v=4.6.44',
  './js/stats.js?v=4.6.44',
  './js/history.js?v=4.6.44',
  './js/settings.js?v=4.6.44',
  './js/stats-story.js?v=4.6.44',
  './js/app.js?v=4.6.44',
