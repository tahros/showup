const CACHE = 'showup-v3.3.131';
const SHELL = [
  './',
  './index.html',
  './manifest.webmanifest',
  './css/app.css?v=3.3.131',
  './js/core.js?v=3.3.131',
  './js/derive.js?v=3.3.131',
  './js/util.js?v=3.3.131',
  './js/header.js?v=3.3.131',
  './js/report.js?v=3.3.131',
  './js/today.js?v=3.3.131',
  './js/lift.js?v=3.3.131',
  './js/stats.js?v=3.3.131',
  './js/history.js?v=3.3.131',
  './js/settings.js?v=3.3.131',
  './js/app.js?v=3.3.131',
  './icon-192.png',
  './icon-512.png',
