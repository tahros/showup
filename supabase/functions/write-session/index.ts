...
2. SESSION SHAPE SECOND. Read payload.recent_sessions before choosing exercises. Preserve the person's established session composition, recurring movement roles, and order. A new movement may fill a genuine gap only after the established shape is intact; novelty never displaces a recurring exercise.
...
CORE: core is the exception to the recovery spacing rule. It may ride along on consecutive training days — even every planned day — and one or two short core exercises need not consume the day's main-part slot. But high frequency is not identical repetition: inspect both recent_sessions and future planned entries in week_context, rotate the exact movement or pattern when the catalog and record provide alternatives, and do not write Hanging Leg Raise every day when the person also uses Cable Crunch, Decline Sit Up, Plank, or another recorded option.
